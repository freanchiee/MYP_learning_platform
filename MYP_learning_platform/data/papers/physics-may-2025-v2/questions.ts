...
const P = '/images/papers/physics-may-2025-v2/'
...
export const questions: Question[] = [
  ...
  // V2: E=240J, V=800V, t=30ms → I=10.0A
  // ─────────────────────────────────────────────────────────────
  {
    id: 1,
    crit: 'A',
    ...
    tasks: [
      ...
      {
        label: 'b',
        text: 'A charged defibrillator with stored energy of **240 J** applies a voltage of **800 V** to an adult human. **Calculate** the current that would flow in **30 milliseconds**.',
        marks: 3,
  ...
  // V2: Orange light 620nm → f=4.8×10¹⁴ Hz; longer wavelength: red
  // ─────────────────────────────────────────────────────────────
  {
    id: 2,
    crit: 'A',
    ...
    stem: 'Refraction of light can help people to see more clearly but it can also cause optical illusions, as shown in the image of a ruler in a glass of water.',
    figImages: [`${P}q2-refraction.png`],
    tasks: [
      {
        label: 'a',
        text: '**Orange** light has a wavelength of **620 nm**. **Calculate** the frequency of orange light. Assume the speed of light = 3.0 × 10⁸ m s⁻¹. Give your answer to two significant figures.',
        marks: 3,
        ph: 'State formula, convert units, show substitution, give answer with unit...',
      },
      {
        label: 'b',
        text: '**State** one colour of visible light that has a longer wavelength than orange light.',
        marks: 1,
        ph: 'Colour: ...',
      },
      {
        label: 'c',
        text: 'Light travels as waves. Refraction of light changes some of the characteristics of light. The diagram shows a light ray passing from air into glass.\n\n**Select** one quantity that remains constant when light is refracted through transparent materials.\n\nOptions: Direction | Frequency | Speed | Wavelength',
        marks: 1,
      ...
      {
        label: 'd',
        text: 'Refraction can make us believe that objects are in a location different to reality. Using the diagram showing a person standing above a pond looking at a frog underwater, **explain** why the person believes the frog is in a different location to where it really is.',
        marks: 3,
        figImages: [`${P}q2d-frog-refraction.png`],
  ...
  // V2: ²³⁶U→¹⁴³Cs+⁹⁰Rb+3n; E=3.2×10⁻¹¹J; 8.0GJ; 30%→6.0×10⁹W
  // ─────────────────────────────────────────────────────────────
  {
    id: 3,
    crit: 'A',
    ...
    tasks: [
      ...
      {
        label: 'e',
        text: 'In a developed country, one family used **8.0 GJ** of energy in a year. **Calculate** the number of fission reactions required to meet the energy needs of this family.',
        marks: 2,
        ph: 'Convert GJ to J first, then divide by energy per fission...',
      },
      {
        label: 'f',
        text: 'A nuclear power station operates with an efficiency of **30 %**. If the station generates **1.8 × 10⁹ W** of electrical power, **calculate** the total power released through nuclear fission in the nuclear reactor.',
        marks: 2,
  ...
  // ─────────────────────────────────────────────────────────────
  // QUESTION 4 — Windup Spring Model Car / Motion (10 marks) Criterion C
  // V2: records every 0.040s → f=25Hz; read velocity at 0.25s; gradient≈75cm/s²
  // ─────────────────────────────────────────────────────────────
  {
    id: 4,
    crit: 'C',
    type: 'extended',
    topic: 'Motion — Windup Spring Model Car',
    marks: 10,
    ...
    stem: 'An MYP student investigates the motion of a simple windup spring model car. The car is powered by a coiled spring. The student uses video analysis to track the car\'s position at regular time intervals.',
    figImages: [`${P}q4-windup-car.png`],
    tasks: [
      {
        label: 'a',
        text: 'The video analysis records the position of the car every **0.040 s**. **Calculate** the frequency with which the position data is recorded. Include an appropriate unit.',
        marks: 2,
        ph: 'State formula, substitute values, give unit...',
      },
      {
        label: 'b',
        text: 'Using the data table shown, read the velocity of the windup car at t = **0.25 s**.',
        marks: 1,
        figImages: [`${P}q4b-data-table.png`],
        ph: 'Velocity at t = 0.25 s = ... cm s⁻¹',
      },
      {
        label: 'c',
        text: 'The student processed the data and drew a velocity-time graph (shown below). **Calculate** the gradient of the line of best fit between t = 0.04 s and t = 0.25 s. Give the unit and **state** the quantity that the gradient represents.',
        marks: 3,
      ...
      {
        label: 'd',
        text: 'The student repeated the experiment using twice as many turns of the windup spring. **Predict** how the line of best fit drawn in part (c) would change. **Justify** your answer.',
        marks: 2,
  ...
  // V2: Q6g: V=0.450V, I=0.120A → P=0.054W; Q6c: missing ΔT=25.0°C
  // ─────────────────────────────────────────────────────────────
  {
    id: 6,
    crit: 'B',
  ...
  // V2: same structure, same cannonball_paths and radio_select

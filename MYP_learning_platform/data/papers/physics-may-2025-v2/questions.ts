...
export const questions: Question[] = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    artefact: {
      component: 'GenericSVG',
      data: {
        svg: '<svg viewBox="0 0 600 320" xmlns="http://www.w3.org/2000/svg" font-family="Arial, Helvetica, sans-serif"><defs><linearGradient id="pool" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#bfe3f2"/><stop offset="1" stop-color="#5aa9cf"/></linearGradient><marker id="ah2" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L7,3 L0,6 Z" fill="#0b7285"/></marker></defs><rect width="600" height="320" fill="#ffffff"/><rect x="0" y="120" width="600" height="200" fill="url(#pool)"/><line x1="0" y1="120" x2="600" y2="120" stroke="#3f7e98" stroke-width="2"/><text x="20" y="142" font-size="12" fill="#2c5468">water surface</text><line x1="0" y1="312" x2="600" y2="312" stroke="#9aa7ad" stroke-width="6"/><text x="20" y="304" font-size="11" fill="#6b7780">pool floor</text><circle cx="237" cy="48" r="14" fill="#f1c27d" stroke="#c98a3c"/><path d="M237,62 q-22,18 0,40 q22,-22 0,-40 Z" fill="#3a6ea5"/><text x="170" y="50" font-size="11" fill="#1f2d3a">swimmer</text><ellipse cx="392" cy="296" rx="20" ry="7" fill="#e3a93c" stroke="#a8721a"/><text x="366" y="290" font-size="11" fill="#7a5310">real coin</text><ellipse cx="386" cy="228" rx="17" ry="6" fill="none" stroke="#a8721a" stroke-dasharray="4 3"/><text x="408" y="222" font-size="11" fill="#a8721a">apparent coin</text><path d="M392,296 L290,120" stroke="#0b7285" stroke-width="2"/><path d="M290,120 L237,62" stroke="#0b7285" stroke-width="2.5" marker-end="url(#ah2)"/><line x1="290" y1="92" x2="290" y2="155" stroke="#94a3ad" stroke-width="1" stroke-dasharray="3 3"/><text x="296" y="90" font-size="10" fill="#94a3ad">normal</text><path d="M290,120 L386,228" stroke="#a8721a" stroke-width="1.5" stroke-dasharray="5 4"/><path d="M290,136 A16,16 0 0 0 298,133.9" fill="none" stroke="#7a5310" stroke-width="1"/><text x="296" y="149" font-size="10" fill="#7a5310">i</text><path d="M290,100 A20,20 0 0 0 276.7,105.1" fill="none" stroke="#7a5310" stroke-width="1"/><text x="275" y="96" font-size="10" fill="#7a5310">r</text></svg>',
      },
    ...
    tasks: [
      ...
      },
      {
        ...
        artefact: {
          component: 'GenericSVG',
          data: {
            svg: '<svg viewBox="0 0 420 280" xmlns="http://www.w3.org/2000/svg" font-family="Arial, Helvetica, sans-serif"><defs><marker id="ah3" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L7,3 L0,6 Z" fill="#0b7285"/></marker></defs><rect width="420" height="280" fill="#ffffff"/><rect x="0" y="140" width="420" height="140" fill="#cfe9f6"/><line x1="0" y1="140" x2="420" y2="140" stroke="#3f7e98" stroke-width="2"/><text x="14" y="30" font-size="12" fill="#5b6b78">air</text><text x="14" y="166" font-size="12" fill="#2c5468">water</text><line x1="210" y1="40" x2="210" y2="240" stroke="#94a3ad" stroke-width="1" stroke-dasharray="3 3"/><text x="216" y="52" font-size="10" fill="#94a3ad">normal</text><path d="M103.9,33.9 L210,140" stroke="#0b7285" stroke-width="2.5" marker-end="url(#ah3)"/><path d="M210,140 L273.8,241.6" stroke="#0b7285" stroke-width="2.5" marker-end="url(#ah3)"/><path d="M210,85 A55,55 0 0 0 171.1,101.1" fill="none" stroke="#a8531a" stroke-width="1.2"/><text x="176" y="92" font-size="11" fill="#a8531a">i</text><path d="M210,190 A50,50 0 0 0 236.6,182.3" fill="none" stroke="#a8531a" stroke-width="1.2"/><text x="224" y="178" font-size="11" fill="#a8531a">r</text></svg>',
          },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    artefact: {
      component: 'GenericSVG',
      data: {
        svg: '<svg viewBox="0 0 420 360" xmlns="http://www.w3.org/2000/svg" font-family="Arial, Helvetica, sans-serif"><defs><radialGradient id="earth7" cx="0.4" cy="0.4"><stop offset="0" stop-color="#5b9bd5"/><stop offset="1" stop-color="#1f5c8a"/></radialGradient></defs><rect width="420" height="360" fill="#ffffff"/><circle cx="210" cy="200" r="110" fill="url(#earth7)" stroke="#13405f"/><circle cx="210" cy="200" r="150" fill="none" stroke="#e08a1e" stroke-width="2" stroke-dasharray="6 5"/><text x="210" y="42" font-size="11" fill="#e08a1e" text-anchor="middle" font-weight="700">B — circular orbit</text><polygon points="192,92 228,92 210,60" fill="#6b5232"/><text x="232" y="68" font-size="10" fill="#6b5232">cannon</text><path d="M210,66 L210,90" fill="none" stroke="#0b7285" stroke-width="2.5"/><text x="196" y="84" font-size="11" fill="#0b7285" font-weight="700">C</text><path d="M210,66 Q300,72 290,124" fill="none" stroke="#c0392b" stroke-width="2"/><text x="300" y="120" font-size="11" fill="#c0392b" font-weight="700">A</text><path d="M210,66 Q372,92 412,250" fill="none" stroke="#7a4fb5" stroke-width="2"/><text x="392" y="170" font-size="11" fill="#7a4fb5" font-weight="700">D</text></svg>',
      },

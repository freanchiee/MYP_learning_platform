...
export const MS: Record<string, MSRecord> = {
  ...
  'q1_b': {
    ...
    feedbackHit: 'Excellent — correct formula, unit conversion (30 ms → 0.030 s), and clean answer of 10.0 A.',
    feedbackMiss: 'Start with E = VIt and rearrange for I. Remember to convert 30 ms to 0.030 s before substituting.',
  },
  ...
  'q2_a': {
    marks: 3,
    exemplar: 'f = v / λ\nλ = 620 nm = 620 × 10⁻⁹ m = 6.20 × 10⁻⁷ m\nf = 3.0 × 10⁸ / 6.20 × 10⁻⁷\nf = 4.84 × 10¹⁴ Hz ≈ 4.8 × 10¹⁴ Hz',
    ...
    feedbackMiss: 'Use f = v/λ. Convert 620 nm to metres (× 10⁻⁹) first. Express answer in Hz to 2 s.f.',
  },

  'q2_b': {
    marks: 1,
    exemplar: 'Red (only colour with wavelength > 620 nm in the visible spectrum)',
    keyConcepts: ['visible spectrum', 'wavelength'],
    keywords: ['wavelength', 'red'],
    feedbackHit: 'Correct — red has the longest wavelength (~700 nm) in the visible spectrum, longer than orange (620 nm).',
    feedbackMiss: 'Orange light is near the long-wavelength end of the visible spectrum. Only red has a longer wavelength.',
  },
  ...
  'q2_d': {
    marks: 3,
    exemplar: 'Light from the frog travels from water into air at an angle to the normal. At the boundary, the light bends away from the normal (it speeds up). The person\'s brain assumes light travels in a straight line, so it traces the refracted ray back to an apparent position that is closer to the surface than the actual frog / the frog appears shallower than it really is.',
  ...
  'q3_c': {
    marks: 1,
    exemplar: '3 neutrons\n(Check: 143 + 90 + 3 = 236 ✓; protons 55 + 37 = 92 ✓)',
    ...
    feedbackHit: 'Correct — balancing both mass number (236) and atomic number (92) gives 3 neutrons.',
    feedbackMiss: 'Balance the equation: mass numbers 143 + 90 + ? = 236, so ? = 3. Also check proton numbers sum to 92.',
  },

  'q3_d': {
    marks: 2,
    exemplar: 'E = mc²\nm = E / c²\nm = 3.2 × 10⁻¹¹ / (3.0 × 10⁸)²\nm = 3.2 × 10⁻¹¹ / 9.0 × 10¹⁶\nm = 3.56 × 10⁻²⁸ kg ≈ 3.6 × 10⁻²⁸ kg',
    ...
    feedbackMiss: 'Rearrange E = mc² to give m = E/c². Substitute E = 3.2 × 10⁻¹¹ J and c = 3.0 × 10⁸ m s⁻¹.',
  },
  ...
  'q3_e': {
    ...
    feedbackHit: 'Well done — correct division with clean answer of 2.5 × 10²⁰.',
    feedbackMiss: 'Convert 8.0 GJ to 8.0 × 10⁹ J, then divide by 3.2 × 10⁻¹¹ J per fission.',
  },
  ...
  'q3_f': {
    ...
    feedbackHit: 'Correct — rearrangement and clean answer of 6.0 × 10⁹ W.',
    feedbackMiss: 'efficiency = P_useful / P_total, so P_total = P_useful / efficiency = 1.8 × 10⁹ / 0.30.',
  },
  ...
  'q4_a': {
    ...
    feedbackMiss: 'Use f = 1/T. T = 0.040 s (the time interval between measurements). f = 1/0.040 = 25 Hz.',
  },

  'q4_b': {
    marks: 1,
    exemplar: 'Approximately 3.0 cm s⁻¹ (accept 2.7–3.3 cm s⁻¹)',
    keyConcepts: ['reading data tables', 'velocity'],
    keywords: ['velocity', 'reading', 'data table'],
    feedbackHit: 'Correct reading from the data table at t = 0.25 s.',
    feedbackMiss: 'Read the velocity column at the row corresponding to t = 0.25 s.',
  },

  'q4_c': {
    marks: 3,
    exemplar: 'Gradient = Δv / Δt = (3.0 − 0) / (0.25 − 0.04) ≈ 3.0 / 0.21 ≈ 14.3 cm s⁻² → scaled to graph ≈ 75 cm s⁻²\nUnit: cm s⁻² (or m s⁻²)\nQuantity: acceleration',
  ...
  'q4_d': {
    marks: 2,
    exemplar: 'Prediction: The gradient (acceleration) would be steeper / greater.\nJustification: More turns store more elastic potential energy in the spring; the spring exerts a larger force on the car, resulting in a greater acceleration (F = ma).',
  ...
  'q6_g': {
    ...
    feedbackHit: 'Correct — P = VI = 0.054 W with unit.',
    feedbackMiss: 'Use P = VI. Substitute V = 0.450 V and I = 0.120 A.',
  },

...
export const MS: MSRecord = {
  ...
  q1_a: {
    marks: 2,
    exemplar: 'Mitochondria → Animal cells only; Cell wall → Bacteria cells only; Cell membrane → Both; Ribosomes → Both.',
    keyConcepts: ['cell structure organelles bacteria animal'],
    keywords: ['mitochondria', 'cell wall', 'cell membrane', 'ribosomes', 'animal cells', 'bacteria cells', 'both'],
    feedbackHit: 'Correct identification of organelle distribution between cell types.',
    feedbackMiss: 'Remember: bacteria have no membrane-bound organelles; mitochondria are only in eukaryotic (animal) cells. Cell membrane and ribosomes are in both.',
    blankAnswers: ['Animal cells', 'Bacteria cells', 'Both', 'Both'],
  },
  ...
  q1_d: {
    marks: 1,
    exemplar: 'rr (the mother cannot roll her tongue; tongue-rolling R is dominant, so non-roller = rr homozygous recessive).',
    keyConcepts: ['genotype phenotype dominant recessive alleles'],
    keywords: ['genotype', 'rr', 'homozygous', 'recessive', 'dominant', 'tongue rolling'],
    feedbackHit: 'Correct genotype using recessive alleles.',
    feedbackMiss: 'Not being able to roll the tongue is the recessive phenotype — both alleles must be r, giving genotype rr.',
  },

  q1_e: {
    marks: 2,
    exemplar: 'Punnett square: Rr, Rr, rr, rr. Probability of tongue-rolling = 2/4 = 50% (or 1/2 or 1:1 ratio). ECF from part (d).',
    keyConcepts: ['Punnett square inheritance probability dominant recessive'],
    keywords: ['Punnett square', 'Rr', 'rr', '50%', 'probability', '2/4', 'ECF'],
    feedbackHit: 'Correct Punnett square and probability calculation.',
    feedbackMiss: 'Cross father R,r with mother r,r → Rr, rr, Rr, rr. Tongue-rollers (Rr) = 2 out of 4 offspring = 50%.',
    blankAnswers: ['Rr', 'Rr', 'rr', 'rr'],
  },
  ...
  // Q2 — Grassland Food Web

  q2_a: {
    marks: 3,
    exemplar: 'Producer: prairie grasses (accept any plant in food web). Omnivore: coyote (eats animals and some berries). Primary consumer: pronghorn / grasshopper / prairie dog. Do not accept "plant" for producer.',
    keyConcepts: ['food web trophic levels producer consumer omnivore'],
    keywords: ['producer', 'omnivore', 'primary consumer', 'prairie grasses', 'coyote', 'pronghorn', 'prairie dog', 'grasshopper'],
  ...
  q2_b: {
    marks: 2,
    exemplar: 'The highway destroys coyote habitat, so coyotes lose territory and may have less prey available → coyote population decreases. OR: the highway provides alternative food sources (roadkill/rubbish) → coyote population increases. Note: only credit population increase OR decrease (not both); do not allow extinction.',
    keyConcepts: ['human impact habitat destruction population change coyote'],
    keywords: ['habitat', 'destroyed', 'food source', 'population', 'decrease', 'increase', 'alternative', 'roadkill'],
    feedbackHit: 'Clear reasoning linking the highway to coyote population change.',
    feedbackMiss: 'State the change (increase or decrease) AND give a clear reason. Do not say "extinct".',
  },

  q2_c: {
    marks: 3,
    exemplar: 'If coyote population decreases: coyotes eat fewer prairie dogs/grasshoppers → prairie dog population increases → more competition for grasses → pronghorn face more competition → pronghorn population may decrease. OR: coyotes prey on fewer pronghorn fawns → pronghorn population increases. Third mark awarded only if first two points are logically connected.',
    keyConcepts: ['food web cascade effect population change predator prey'],
    keywords: ['coyotes', 'prairie dogs', 'pronghorn', 'competition', 'predation', 'increase', 'decrease', 'cascade'],
    feedbackHit: 'Good chain-of-effect reasoning linking coyote change to pronghorn change.',
    feedbackMiss: 'Follow the food web chain step by step: coyote change → prey of coyote changes → effect on pronghorn through competition or predation.',
  },

  // Q3 — Hedgerow Density and Nesting Birds

  q3_a: {
    marks: 1,
    exemplar: 'Hawthorn / Hedge 2 (accept Blackthorn / Hedge 3).',
    keyConcepts: ['graph reading highest value native plants'],
    keywords: ['hawthorn', 'blackthorn', 'hedge 2', 'highest', 'survival rate'],
    feedbackHit: 'Correct identification of highest survival rate hedge.',
    feedbackMiss: 'Read the tallest bar from the graph.',
  },

  q3_b: {
    marks: 1,
    exemplar: 'Hawthorn is a native plant, providing denser thorny cover / more nesting sites / better camouflage and protection from predators than non-native hedges.',
    keyConcepts: ['native plant habitat hiding places prey survival'],
    keywords: ['native', 'thorny', 'cover', 'nesting sites', 'camouflage', 'protection', 'predators'],
    feedbackHit: 'Good suggestion linking native hedge features to nest survival.',
    feedbackMiss: 'Think about what a native hedge offers that non-native ones do not — dense thorny structure, camouflage, familiarity to birds.',
  },

  q3_c: {
    marks: 2,
    exemplar: 'Similarity: both native and non-native hedges provide better nest survival than no hedge (ORA). Difference: native hedges give higher survival rates than non-native hedges; there is a greater range of survival rates between the two native hedges than between the two non-native hedges.',
    keyConcepts: ['compare contrast native non-native plants survival data'],
    keywords: ['both', 'similarity', 'difference', 'native', 'non-native', 'higher survival', 'range', 'cover'],
  ...
  q3_d: {
    marks: 1,
    exemplar: 'To show the effect of the hedge on the results / it acts as a control (to compare with hedge conditions).',
    keyConcepts: ['control group experimental design investigation'],
    keywords: ['control', 'effect of hedge', 'compare', 'baseline', 'results'],
  ...
  q5_e: {
    marks: 4,
    exemplar: 'Averages: 10°C average = 5 (4+6+4+6=20÷4); 30°C average = 14 (13+11+19+13=56÷4) [2 marks, 1 per correct average with working shown]. Improvements to data presentation [any 2 from: need consistent significant figures for average data; provide a heading/units for the average column; provide a heading for the trial columns; plot results as a line graph or scatter graph] [2 marks].',
    keyConcepts: ['calculate mean average data presentation improvements significant figures graph'],
    keywords: ['average', 'mean', '5', '14', 'significant figures', 'heading', 'column', 'line graph', 'scatter graph', 'working'],
    feedbackHit: 'Correct calculation with working shown, plus valid presentation improvements.',
    feedbackMiss: 'Show working: sum all trials ÷ 4. 10°C → 20÷4 = 5; 30°C → 56÷4 = 14. Presentation improvements: consistent sig figs, column headings, consider plotting a graph.',
  },

  q5_f: {
    marks: 1,
    exemplar: 'The outlier is Trial 3 at 30°C (value of 19, which is much higher than the other 30°C values of 13, 11, and 13). Accept any specific data point identified with justification.',
    keyConcepts: ['outlier anomalous data point identification'],
    keywords: ['outlier', 'anomalous', '30°C', 'trial 3', '19', 'much higher'],
  ...
  q7_a: {
    marks: 2,
    exemplar: 'Shape 1 (large purple molecule) = Substrate; Shape 2 (enzyme) = Enzyme; Shape 3 (after arrow, enzyme) = Enzyme; Shape 4 (small) = Product. One enzyme labelled correctly = 1 mark. All four correct = 2 marks. Ignore any errors in the other enzyme label for first mark.',
  ...
  // Q9 — Criteria D: Evaluate Medication for Type-2 Diabetes

  q9_: {
    marks: 11,
    exemplar: 'Individual impacts (positive: medication effectively controls blood-sugar levels, reduces risk of complications such as nerve/kidney/eye damage; negative: side effects, dependency, cost to individual, diet/lifestyle not addressed). Society impacts (positive: reduces healthcare burden from diabetes complications, productivity maintained; negative: increased cost of prescriptions to the health service, over-reliance on medication). Concluding appraisal: medication is useful but should be combined with diet and lifestyle changes; both lines of argument considered with justification of preferred approach.',
    keyConcepts: ['Criteria D evaluate medication diabetes impacts individual society appraisal'],
    keywords: ['positive', 'negative', 'individual', 'society', 'medication', 'diabetes', 'blood sugar', 'lifestyle', 'appraisal', 'justification'],
  ...
  // Q10 — Insulin, Glucagon and Blood Sugar

  q10_a: {
    marks: 2,
    exemplar: 'The injection increases insulin levels [1 mark]. Insulin causes body cells (e.g. liver and muscle) to take up glucose from the blood and store it as glycogen, lowering the blood-sugar level to a safe range [1 mark]. Do not accept "insulin removes sugar" without a mechanism.',
    keyConcepts: ['insulin glucagon blood sugar hormone regulation'],
    keywords: ['insulin', 'increases', 'glucose', 'uptake', 'glycogen', 'liver', 'lower', 'blood sugar'],
    feedbackHit: 'Good understanding of how injected insulin lowers blood-sugar level.',
    feedbackMiss: 'Insulin tells cells (liver/muscle) to absorb glucose from the blood and store it as glycogen, which lowers blood-sugar level.',
  },

  q10_b: {
    marks: 6,
    exemplar: 'Benefit (1 max): mice are easy to keep; mice are mammals and similar to humans; easy to control external variables in a laboratory. Limitation (1 max): mice have different physiology to humans; side effects may not be measurable/translatable; mice exist in a controlled lab environment unlike humans. Ethical considerations (2 max): mice are given disease/injections (which causes them harm); side effects of the new insulin treatment are unknown; mice cannot give consent; mice are specifically bred for use in experiments (reference to welfare). Concluding appraisal: a justified conclusion stating whether using mice is appropriate, considering the benefit and ethical concerns.',
    keyConcepts: ['animal research ethics mice benefit limitation insulin evaluation'],
    keywords: ['mice', 'mammals', 'similar to humans', 'control variables', 'different physiology', 'injections', 'consent', 'welfare', 'ethical', 'side effects', 'appraisal'],
    feedbackHit: 'Comprehensive evaluation covering benefit, limitation, ethics, and a justified conclusion.',
    feedbackMiss: 'Include: 1 benefit, 1 limitation, 2 ethical issues, and a concluding appraisal with justification about whether using mice is appropriate.',
  },
}

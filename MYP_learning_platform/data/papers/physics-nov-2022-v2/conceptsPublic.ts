...
export const CONCEPTS_PUBLIC_NOV2022_V2: Record<string, ConceptEntry> = {

  // ── Q1: Nuclear Fission & Radioactive Decay (submarine; Ba-139) ─
  q1_a: {
  ...
  q1_c: {
    ...
    keywords: ['half-life', 'radioactive decay', 'activity', 'graph reading', 'barium-139', '83'],
  },
  q1_d: {
    keyConcepts: ['converting units between MJ and J', 'dividing energy requirement by energy per gram to find mass'],
    keywords: ['energy calculation', 'unit conversion', 'fission', 'mass of uranium', '9.4 × 10⁹ J', '0.12 g'],
  },
  q1_e: {
  ...
  q2_c: {
    keyConcepts: ['greater evaporation causes greater cooling effect', 'glycerol does not evaporate readily; acetone evaporates readily'],
    keywords: ['cooling effect', 'evaporation rate', 'acetone', 'glycerol', 'graph analysis'],
  },
  q2_d: {
    keyConcepts: ['a non-evaporating reference liquid maintains ambient (workshop) temperature'],
    keywords: ['workshop temperature', 'ambient', 'reference', 'glycerol', 'steady state', '23'],
  },
  q2_e: {
  ...
  q3_b: {
    ...
    keywords: ['geocentric', 'heliocentric', 'orbit', 'evidence', 'Saturn', 'Titan'],
  },
  q3_c: {
    keyConcepts: ['liquid water is a prerequisite for life as we know it', 'astrobiology searches for habitable conditions'],
    keywords: ['liquid water', 'life', 'habitability', 'astrobiology', 'Titan'],
  },
  q3_d: {
  ...
  // ── Q4: Lift Motor Investigation Planning ───────────────────
  q4_a: {
  ...
  q4_b: {
    ...
    keywords: ['research question', 'independent variable', 'dependent variable', 'efficiency', 'lift'],
  },
  q4_c: {
  ...
  // ── Q6: Data Processing (masses; q6a 0.040 kg → 0.31 J) ─────
  q6_a: {
    keyConcepts: ['gravitational potential energy ΔEp = mgh', 'convert height to metres before substituting'],
    keywords: ['ΔEp', 'mgh', '9.81', 'unit conversion', 'kg', 'metres', '0.040 kg', '0.31 J'],
  },
  q6_b: {
  ...
  q6_d: {
    ...
    keywords: ['VIt', 'total energy', 'efficiency', '50 g', '0.18 A', '5.21 s', '16.7%'],
  },
  ...
  q7_h: {
    ...
    keywords: ['time of flight', 'horizontal range', 'dependent variable', 'control variable', 'elastic band', 'mass'],
  },
  ...
  q8_a: {
    ...
    keywords: ['d = vt', 'echo', 'ultrasound', 'one-way distance', 'reflection', '1580 m/s', '7.11 cm'],
  },
  q8_b: {

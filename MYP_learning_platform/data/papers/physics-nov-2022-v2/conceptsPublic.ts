...
export const CONCEPTS_PUBLIC_NOV2022_V2: Record<string, ConceptEntry> = {
  ...
  // ── Q1: Nuclear Fission & Radioactive Decay (1945 nuclear power) ─
  q1_a: {
  ...
  q1_d: {
    ...
    keywords: ['energy calculation', 'unit conversion', 'fission', 'mass of uranium', '1.05 × 10¹⁰ J', '0.128 g'],
  },
  q1_e: {
  ...
  // ── Q3: Astrophysics (Triton / Voyager 2 1989) ──────────────────
  q3_a: {
  ...
  q3_c: {
    ...
    keywords: ['liquid water', 'life', 'habitability', 'astrobiology', 'Triton', 'Neptune'],
  },
  q3_d: {
  ...
  // ── Q4: Motor Investigation Planning (building site bucket) ─────
  q4_a: {
  ...
  // ── Q5: Investigation Design (bucket of sand hoist) ─────────────
  q5_a: {
  ...
  // ── Q6: Data Processing (masses 15/30/45/60/75 g; q6a: 45 g) ───
  q6_a: {
    keyConcepts: ['gravitational potential energy ΔEp = mgh', 'convert mass to kg and height to metres before substituting'],
    keywords: ['ΔEp', 'mgh', '9.81', 'unit conversion', 'kg', 'metres', '0.045 kg', '0.42 J'],
  },
  q6_b: {
  ...
  q6_d: {
    ...
    keywords: ['VIt', 'total energy', 'efficiency', 'calculation', '75 g', '0.22 A', '5.90 s', '26.9%'],
  },

  // ── Q7: Projectile Motion (spring-loaded marble launcher) ────────
  q7_a: {
  ...
  q7_d: {
    ...
    keywords: ['source of error', 'random error', 'height measurement', 'moving marble', 'ruler'],
  },
  q7_e: {
  ...
  q7_h: {
    ...
    keywords: ['time of flight', 'horizontal range', 'dependent variable', 'control variable', 'spring compression', 'marble'],
  },

  // ── Q8: Ultrasound (speed=1620 m/s, t=0.8×10⁻⁴ s → 6.5 cm) ───
  q8_a: {
    keyConcepts: ['distance = speed × time', 'ultrasound echo travels to the target and back, so halve the total distance'],
    keywords: ['d = vt', 'echo', 'ultrasound', 'one-way distance', 'reflection', '1620 m/s', '6.5 cm'],
  },
  q8_b: {

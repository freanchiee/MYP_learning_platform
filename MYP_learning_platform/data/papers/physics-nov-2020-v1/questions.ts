...
export const questions: Question[] = [
  ...
  // ─── Q6: Capillary action investigation (11 marks, Criterion C & A) ───
  {
    ...
    artefact: {
      component: 'GenericSVG',
      data: {
        svg: '<svg viewBox="0 0 560 280" xmlns="http://www.w3.org/2000/svg" font-family="Arial, Helvetica, sans-serif"><defs><linearGradient id="liq6" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#bfe3f2"/><stop offset="1" stop-color="#6cb6d6"/></linearGradient></defs><rect width="560" height="280" fill="#ffffff"/><text x="280" y="24" font-size="13" font-weight="700" text-anchor="middle" fill="#1f2d3a">Capillary tubes of different diameters</text><rect x="60" y="180" width="440" height="40" fill="url(#liq6)" stroke="#3f7e98"/><text x="500" y="205" font-size="11" fill="#2c5468">water</text><g><rect x="110" y="70" width="10" height="120" fill="none" stroke="#7d8a96"/><rect x="111" y="100" width="8" height="90" fill="url(#liq6)"/><text x="115" y="242" font-size="11" text-anchor="middle" fill="#5b6b78">A</text><text x="115" y="258" font-size="10" text-anchor="middle" fill="#5b6b78">1.0 mm</text></g><g><rect x="200" y="70" width="14" height="120" fill="none" stroke="#7d8a96"/><rect x="201" y="124" width="12" height="66" fill="url(#liq6)"/><text x="207" y="242" font-size="11" text-anchor="middle" fill="#5b6b78">B</text><text x="207" y="258" font-size="10" text-anchor="middle" fill="#5b6b78">1.5 mm</text></g><g><rect x="290" y="70" width="18" height="120" fill="none" stroke="#7d8a96"/><rect x="291" y="142" width="16" height="48" fill="url(#liq6)"/><text x="299" y="242" font-size="11" text-anchor="middle" fill="#5b6b78">C</text><text x="299" y="258" font-size="10" text-anchor="middle" fill="#5b6b78">2.0 mm</text></g><g><rect x="380" y="70" width="24" height="120" fill="none" stroke="#7d8a96"/><rect x="381" y="158" width="22" height="32" fill="url(#liq6)"/><text x="392" y="242" font-size="11" text-anchor="middle" fill="#5b6b78">D</text><text x="392" y="258" font-size="10" text-anchor="middle" fill="#5b6b78">2.5 mm</text></g><line x1="60" y1="100" x2="60" y2="190" stroke="#1f2d3a"/><g font-size="9" fill="#1f2d3a"><text x="40" y="103">30</text><text x="40" y="148">15</text><text x="48" y="190">0</text></g><text x="30" y="150" font-size="10" fill="#1f2d3a" transform="rotate(-90 30 150)">height / mm</text></svg>',
      },

...
export const questions: Question[] = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    artefact: {
      component: 'GenericSVG',
      data: {
        svg: '<svg viewBox="0 0 600 320" xmlns="http://www.w3.org/2000/svg" font-family="Arial, Helvetica, sans-serif"><defs><linearGradient id="watr" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#bfe3f2"/><stop offset="1" stop-color="#6cb6d6"/></linearGradient><marker id="ah2" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L7,3 L0,6 Z" fill="#0b7285"/></marker></defs><rect width="600" height="320" fill="#ffffff"/><rect x="0" y="150" width="600" height="170" fill="url(#watr)"/><line x1="0" y1="150" x2="600" y2="150" stroke="#3f7e98" stroke-width="2"/><text x="20" y="172" font-size="12" fill="#2c5468">water surface</text><circle cx="224" cy="56" r="13" fill="#f1c27d" stroke="#c98a3c"/><rect x="214" y="69" width="20" height="42" rx="6" fill="#3a6ea5"/><text x="168" y="60" font-size="11" fill="#1f2d3a">angler</text><ellipse cx="350" cy="237" rx="26" ry="13" fill="#e8772e" stroke="#a8531a"/><path d="M376,237 l18,-9 l0,18 Z" fill="#e8772e" stroke="#a8531a"/><text x="322" y="270" font-size="11" fill="#7a3d12">real fish</text><ellipse cx="366" cy="225" rx="22" ry="11" fill="none" stroke="#a8531a" stroke-dasharray="4 3"/><text x="406" y="216" font-size="11" fill="#a8531a">apparent fish</text><path d="M350,237 L300,150" stroke="#0b7285" stroke-width="2"/><path d="M300,150 L224,64" stroke="#0b7285" stroke-width="2.5" marker-end="url(#ah2)"/><line x1="300" y1="120" x2="300" y2="185" stroke="#94a3ad" stroke-width="1" stroke-dasharray="3 3"/><text x="306" y="118" font-size="10" fill="#94a3ad">normal</text><path d="M300,150 L366,225" stroke="#a8531a" stroke-width="1.5" stroke-dasharray="5 4"/><path d="M300,166 A16,16 0 0 0 308,163.9" fill="none" stroke="#7a3d12" stroke-width="1"/><text x="306" y="179" font-size="10" fill="#7a3d12">i</text><path d="M300,130 A20,20 0 0 0 286.7,135.1" fill="none" stroke="#7a3d12" stroke-width="1"/><text x="285" y="126" font-size="10" fill="#7a3d12">r</text></svg>',
      },

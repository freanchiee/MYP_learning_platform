...
export const MS: MSRecord = {
  ...
  q1_a: {
    marks: 1,
    exemplar: 'All correct: Does it have a cell wall? NO → Animal cell. YES → Does it have chloroplasts? NO → Bacterial cell. YES → Plant cell.',
    keyConcepts: ['cell classification dichotomous key cell wall chloroplast plant animal bacterial'],
    keywords: ['cell wall', 'chloroplast', 'plant cell', 'animal cell', 'bacterial cell', 'key'],
    feedbackHit: 'Correct use of the classification key.',
    feedbackMiss: 'Animal cells have no cell wall. Of the walled cells, plant cells have chloroplasts and bacterial cells do not.',
  },
  ...
  q1_d: {
    marks: 1,
    exemplar: 'Controls what enters or exits the cell. OR Separates the inside of the cell from the outside. (Do not accept references to protection or to the cell wall — this is a CON.)',
  ...
  q2_a: {
    marks: 2,
    exemplar: 'System 1: Circulatory system (accept cardiovascular system) [1]. System 2: Skeletal system [1].',
    keyConcepts: ['body systems circulatory skeletal identification'],
    keywords: ['circulatory system', 'cardiovascular', 'skeletal system', 'body system'],
    feedbackHit: 'Both body systems correctly identified.',
    feedbackMiss: 'System 1 shows the heart and blood vessels — that is the circulatory system. System 2 shows the bones — the skeletal system.',
  },
  ...
  q2_d: {
    ...
    keyConcepts: ['protein digestion product amino acids'],
    keywords: ['amino acids', 'amino acid', 'protein digestion'],
    feedbackHit: 'Correct — proteins are chemically digested to amino acids.',
    feedbackMiss: 'Proteins are broken down into their building blocks — amino acids — by enzyme action.',
  },
  ...
  // Q3 — Coastal Eutrophication

  q3_a: {
    marks: 1,
    exemplar: 'Accept any reasonable natural source, for example: decaying or dead plants or animals; animal waste; soil or sediment washed in by rivers. (WTTE — do not accept named nutrients.)',
    keyConcepts: ['eutrophication natural nutrient source decomposition'],
    keywords: ['decaying', 'dead plants', 'dead animals', 'animal waste', 'soil', 'sediment', 'natural'],
    feedbackHit: 'Correct natural source of nutrients identified.',
    feedbackMiss: 'Natural sources include dead/decaying organisms, animal waste, or soil/sediment erosion — not human activities.',
  },

  q3_b: {
    marks: 2,
    exemplar: 'Direct source [1]: fish farm; sewage treatment plant discharge; industrial outfall pipe. Indirect source [1]: runoff from farmland; runoff from residential areas; runoff from industrial sites. (WTTE)',
    keyConcepts: ['eutrophication human sources direct indirect runoff sewage'],
    keywords: ['fish farm', 'sewage', 'industrial', 'farmland runoff', 'residential runoff', 'direct', 'indirect'],
    feedbackHit: 'Correct direct and indirect human sources identified.',
    feedbackMiss: 'Direct = enters water directly (fish farms, sewage outfalls). Indirect = reaches water via runoff (farmland, residential areas, industrial sites).',
  },
  ...
  q3_c: {
    ...
    feedbackMiss: 'Nutrients from human sources enter the coastal water → algae receive more nutrients → algae reproduce more rapidly, causing a bloom.',
  },

  q3_d: {
    marks: 4,
    exemplar: 'Algal bloom blocks out sunlight [1]. Seaweed/aquatic plants die due to lack of (sunlight for) photosynthesis [1]. Organic material broken down by bacteria causes oxygen in the water to be depleted [1]. Oxygen depletion leads to death of aquatic organisms [1]. (Accept named organisms.)',
    keyConcepts: ['algal bloom sunlight photosynthesis oxygen depletion decomposition aquatic organisms death biomass'],
    keywords: ['blocks sunlight', 'photosynthesis', 'seaweed die', 'plants die', 'bacteria', 'oxygen depletion', 'death', 'biomass decrease'],
    feedbackHit: 'Excellent chain from algal bloom through to biomass decrease.',
    feedbackMiss: 'Algae block sunlight → seaweed/plants cannot photosynthesise and die → bacteria decompose organic matter using up oxygen → aquatic animals die from lack of oxygen.',
  },
  ...
  q4_a: {
    marks: 1,
    exemplar: 'The surface area of leaves (the amount of leaf surface exposed). Accept: number of leaves left on the shoot.',
    keyConcepts: ['independent variable transpiration leaf surface area investigation'],
    keywords: ['leaf surface area', 'number of leaves', 'leaf area', 'independent variable', 'IV'],
    feedbackHit: 'Correct — the leaf surface area exposed is the independent variable.',
    feedbackMiss: 'The IV is what the students changed between the shoots — the leaf surface area (amount of leaf) exposed for transpiration.',
  },
  ...
  q4_d: {
    marks: 4,
    exemplar: 'Improvements [max 2]: the plant stem/shoot was identified [1]; the species of plant was stated [1]; the leaf surface area was measured or specified [1]. Justifications [max 2]: different plants may transpire differently so this is now controlled [1]; enables repetition of the experiment [1]; gives information about how the IV is manipulated [1]. (Do not accept group 2 posed a question.)',
    keyConcepts: ['research question improvement justification investigation design variables'],
    keywords: ['stem identified', 'species', 'leaf area measured', 'controlled', 'repetition', 'IV manipulation'],
    feedbackHit: 'Good identification of improvements and matching justifications.',
    feedbackMiss: 'Group 2 identified the shoot, stated the species, and specified the leaf surface area — each improvement makes the method more controlled and repeatable.',
  },

  q4_e: {
    marks: 4,
    exemplar: 'Two significant figures used instead of one [1]; (so) smaller rounding errors or measurements are more precise [1]. (WTTE — ignore "accurate".) Inclusion of a control [1]; (control) enables a comparison to be made with a sealed beaker and no shoot [1]. (WTTE)',
    keyConcepts: ['validity significant figures precision control group comparison'],
    keywords: ['significant figures', 'precision', 'rounding errors', 'control', 'comparison', 'sealed', 'valid'],
    feedbackHit: 'Both reasons with justifications correctly stated.',
    feedbackMiss: 'Two sig. figs. → more precise data. A control (sealed beaker with no shoot) → comparison baseline to confirm the water loss is due to transpiration, not evaporation.',
  },
  ...
  q4_g: {
    marks: 2,
    exemplar: 'Water cannot evaporate directly from the beaker [1]. (So) the change in volume is due to transpiration [1] OR Evaporation does not affect the volume of water lost [1].',
  ...
  // Q5 — Criteria B: Potometer Design (humidity)

  q5_: {
    marks: 17,
    exemplar: 'Criteria B rubric (max 17): Variables (max 4): IV = humidity / water vapour in the air (e.g. enclosing the shoot in a bag with damp paper vs dry/silica gel); DV = volume of water taken up / distance the air bubble moves in the potometer per unit time; 2 CVs = temperature, light intensity, species of plant, size/leaf area of shoot. Hypothesis (max 4): testable, linked to DV, correct scientific direction (higher humidity → lower transpiration rate), scientific explanation using diffusion/concentration gradient of water vapour. Manipulation (max 4): how to change humidity (sealed bag with water/silica gel, or a humidity meter to set levels); how to measure DV (movement of the air bubble along the scale per minute); how to monitor CVs. Method (max 4): sufficient detail to follow and repeat; ≥3 trials; control condition. Justification (max 1): justify one calculation (e.g. rate = distance/time or volume/time). Safety (max 1): specific hazard linked to the investigation (e.g. care cutting the shoot with a sharp blade / handling glassware).',
    keyConcepts: ['transpiration investigation design humidity water vapour potometer variables hypothesis method safety Criteria B'],
    keywords: ['humidity', 'water vapour', 'IV', 'DV', 'potometer', 'transpiration rate', 'control variable', 'hypothesis', 'diffusion', 'safety', 'calculation'],
    ...
    feedbackMiss: 'Ensure you identify IV (humidity), DV (water uptake / bubble movement rate), 2 CVs, a testable hypothesis with scientific reasoning (water-vapour gradient), step-by-step method with repeats, one justified calculation, and a specific safety precaution.',
  },

  // Q6 — Stomata Investigation (oak / holly)
  ...
  q6_c: {
    marks: 1,
    exemplar: 'Sample 10 = 14 stomata.',
    keyConcepts: ['stomata count microscope field of view oak leaf sample'],
    keywords: ['stomata', 'count', 'sample 10', '14', 'field of view'],
    feedbackHit: 'Correct count for oak leaf sample 10.',
    feedbackMiss: 'Count each stomata visible in the 0.4 × 0.4 mm field of view for sample 10. The correct count is 14.',
    blankAnswers: ['14'],
  },

  q6_d: {
    marks: 3,
    exemplar: 'Any correctly calculated average e.g. 110/10 = 11 [1]. Stomatal density calculated: 11 ÷ 0.16 = 68.75 [1]. Correctly rounded to 69 (mm⁻²) [1]. ECF from part c. Award one mark max if average is not used and stomatal density is shown ECF from 1st marking point. Award three marks if only 69 is seen ECF from 1st marking point.',
    keyConcepts: ['stomatal density calculation average area formula rounding significant figures'],
    keywords: ['average', '110/10', '11', '68.75', '69', 'mm⁻²', 'stomatal density', 'calculation', '0.16'],
    feedbackHit: 'Correct calculation of average and stomatal density with appropriate rounding.',
    feedbackMiss: 'Step 1: average stomata count = 110 ÷ 10 = 11. Step 2: density = 11 ÷ 0.16 mm² = 68.75. Step 3: round to 69 mm⁻².',
  },
  ...
  q6_f: {
    marks: 1,
    exemplar: 'The lower surface is in contact with the water / underwater, so transpiration does not take place there and gases diffuse directly through the epidermis (not through stomata). (Do not accept "it is an aquatic plant" alone.)',
    keyConcepts: ['floating pondweed stomata water contact gas exchange transpiration aquatic'],
    ...
    feedbackMiss: 'The lower surface of floating pondweed touches the water, so transpiration does not occur and gases diffuse directly through the epidermis without stomata.',
  },

  q6_g: {
    marks: 5,
    exemplar: 'Oak leaves have stomata mainly on the lower surface [1]. Holly leaves also have stomata mainly on the lower surface (a similarity) but fewer stomata overall / a thicker waxy cuticle [1]. Further explanatory points [max 3]: stomata on the lower surface reduce water loss because the lower surface is cooler/shaded [1]; gas exchange still occurs between stomata and air [1]; holly has a lower stomatal density or waxy cuticle to limit water loss in exposed/dry conditions [1]; oak does not need to limit water loss as strongly as holly [1].',
    keyConcepts: ['stomata distribution oak holly adaptation transpiration gas exchange habitat comparison'],
    keywords: ['lower surface', 'fewer stomata', 'transpiration', 'stomatal density', 'waxy cuticle', 'gas exchange', 'water loss', 'comparison'],
    feedbackHit: 'Excellent comparison of stomata distribution with scientific explanation of adaptations.',
    feedbackMiss: 'Both oak and holly have stomata mainly on the lower (shaded) surface to reduce water loss. Holly has fewer stomata / a thicker waxy cuticle, limiting water loss in its more exposed habitat.',
  },
  ...
  q7_c: {
    marks: 2,
    exemplar: 'One of boxes 2, 3 or 4 correctly placed = 1 mark. Boxes 2, 3 and 4 all correctly placed = 2 marks. Correct order: Box 2 = "Bacteria in a population have different characteristics from one another." Box 3 = "Bacteria with enzymes that digest plastic survive and reproduce more." Box 4 = "The plastic-digesting characteristic becomes more common in the population."',
    keyConcepts: ['natural selection variation survival reproduction adaptation population'],
    keywords: ['variation', 'enzymes', 'survive', 'reproduce', 'more common', 'natural selection', 'population'],
    feedbackHit: 'Natural selection sequence correctly ordered.',
    feedbackMiss: 'Natural selection sequence: variation (Box 2) → survival and reproduction of bacteria with plastic-digesting enzymes (Box 3) → trait becomes more common in the population (Box 4).',
    blankAnswers: [

...
// Markscheme — Physics November 2018 · VARIANT 1 (isomorphic to physics-nov-2018)
...
export const MS: Record<string, MSRecord> = {
  // Q1 — Sound and Light (Fireworks)
  '1a': { type: 'mcq', correct: 0 },
  '1b': {
    marks: 3,
    exemplar: 'Measure the time between seeing the firework flash and hearing the bang [1]. Use speed = distance/time → distance = speed of sound × time [1]. Using speed of sound in air (330 ms⁻¹) [1].',
    keyConcepts: ['time between flash and bang', 'speed = distance/time', 'speed of sound = 330 ms⁻¹'],
    keywords: ['time', 'bang', 'flash', 'speed', 'distance', '330'],
    feedbackHit: 'Correct outline of measurement and calculation for the firework distance.',
    feedbackMiss: 'Measure the time between seeing the flash and hearing the bang. Then use: distance = speed of sound × time (speed of sound ≈ 330 ms⁻¹).',
  },
  '1c': {
    marks: 2,
    exemplar: 'Moving with constant/unchanging speed OR it is not accelerating [1]. Any additional point: moving toward AND then away from the student / it passes at about 1 km (closest approach) [1].',
    ...
    feedbackHit: 'Correct description of the barge journey from the graph.',
    feedbackMiss: 'The graph shows distance decreasing then increasing at a constant rate — so the barge moves at constant speed, first toward the student, then away. It passes at about 1 km distance.',
  },
  '1d': {
    marks: 2,
    exemplar: 'Values read from graph (6 km at 21:00, 3 km at 21:10) [1]. Answer = 18 km h⁻¹ [1]. (Ignore incorrect unit if present.)',
    keyConcepts: ['speed = distance/time', 'read graph values', '18 km h⁻¹'],
    keywords: ['18', 'km h⁻¹', 'speed', 'distance', '21:00', '21:10'],
    feedbackHit: 'Correct speed calculated from the graph.',
    feedbackMiss: 'Read distance at 21:00 (6 km) and 21:10 (3 km). Distance = 3 km in 10 min = 1/6 h. Speed = 3 ÷ (1/6) = 18 km h⁻¹.',
  },

  // Q2 — Arc Welding / Electricity
  '2a': { type: 'mcq', correct: 0 },
  '2b': {
    marks: 3,
    exemplar: 'R = V/I seen or implied [1]. R = 40/160 [1]. R = 0.25 Ω (correct unit) [1].',
    keyConcepts: ['R = V/I', '40 / 160 = 0.25', 'unit: Ω (ohms)'],
    keywords: ['R = V/I', '40', '160', '0.25', 'Ω', 'ohms'],
    feedbackHit: 'Correct resistance calculation using Ohm\'s law.',
    feedbackMiss: 'Use R = V/I = 40 V ÷ 160 A = 0.25 Ω.',
  },
  '2c': {
    marks: 2,
    exemplar: 'ΔQ = I × Δt seen or implied (from 160 × 5.0) [1]. ΔQ = 800 C [1].',
    keyConcepts: ['Q = IΔt', '160 × 5.0 = 800 C'],
    keywords: ['Q = IΔt', '160', '5.0', '800', 'C', 'coulombs'],
    feedbackHit: 'Correct charge calculation.',
    feedbackMiss: 'Use Q = I × t = 160 A × 5.0 s = 800 C.',
  },
  '2d': {
    marks: 3,
    exemplar: 'The metal earthing cable is a better conductor / has lower resistance than the welder\'s body [1]. If a fault occurs the current/charge flows through the earthing cable (path of least resistance) [1]. The current/charge passes safely to earth instead of through the welder, preventing a shock [1].',
    keyConcepts: ['earthing cable lower resistance', 'current flows through cable', 'charge passes to earth safely'],
    keywords: ['conductor', 'resistance', 'lower', 'current', 'charge', 'earth', 'ground', 'shock'],
    feedbackHit: 'Correct explanation of how the earthing cable protects the welder.',
    feedbackMiss: 'The thick metal cable conducts better (lower resistance) → fault current flows through it → charge goes safely to earth, bypassing the welder.',
  },

  // Q3 — Decay and Half-life (Tennessine)
  '3a': {
    marks: 1,
    exemplar: 'All three correct: Ra→Rn + ⁴α (alpha); Pb→Bi + ⁰β (beta); U→Th + ⁴α (alpha) [1 mark for all three correct].',
    keyConcepts: ['Ra→Rn: alpha decay', 'Pb→Bi: beta decay', 'U→Th: alpha decay'],
    keywords: ['alpha', 'beta', 'decay', 'Ra', 'Rn', 'Pb', 'Bi', 'U', 'Th'],
    feedbackHit: 'All three decay particles correctly identified.',
    feedbackMiss: 'Alpha (⁴₂α) reduces mass by 4 and atomic number by 2. Beta (⁰₋₁β) keeps mass the same and increases atomic number by 1. Ra(88)→Rn(86): alpha; Pb(82)→Bi(83): beta; U(92)→Th(90): alpha.',
  },
  '3b': {
    marks: 3,
    exemplar: 'Atomic number = 115 [1]. Mass number = 290 [1]. Moscovium or Mc [1]. (Award all marks independently.)',
    keyConcepts: ['new atomic number = 117 − 2 = 115', 'new mass number = 294 − 4 = 290', 'element = Moscovium (Mc)'],
    keywords: ['115', '290', 'moscovium', 'Mc', 'atomic number', 'mass number'],
    feedbackHit: 'Correct identification of Moscovium-290 from Tennessine-294 alpha decay.',
    feedbackMiss: 'Alpha particle (⁴₂α) removes 4 from the mass number and 2 from the atomic number. 294−4=290 (mass), 117−2=115 (atomic number). Element 115 = Moscovium (Mc).',
  },
  '3c': {
    marks: 2,
  ...
  '3d': {
    marks: 3,
    exemplar: 'Carbon-14 [1]. After 10 000 years the change in abundance will be noticeable OR the half-life is appropriate to the situation [1]. It exists in nature in organic materials (such as the wooden tool) [1].',
    keyConcepts: ['Carbon-14 most appropriate', 'half-life 5700y appropriate for 10000y tool', 'found naturally in organic materials'],
    keywords: ['carbon-14', 'half-life', '5700', 'organic', 'natural', 'noticeable', 'wood'],
    feedbackHit: 'Correct isotope selection with valid justification.',
    feedbackMiss: 'Carbon-14 (half-life 5 700 years) is best: (1) the half-life is similar in magnitude to 10 000 years so the change in abundance is detectable; (2) it is found naturally in all organic materials, including a wooden tool.',
  },
  ...
  '4d': {
    marks: 2,
    exemplar: '56 ± 0.5 kPa [1]. Correct unit: kPa [1]. (Accept any value 55–57 kPa.) Do not accept "kpa" for the unit mark.',
    keyConcepts: ['read pressure gauge: 56 kPa', 'correct unit: kPa'],
    keywords: ['56', 'kPa', 'pressure gauge', 'read'],
    feedbackHit: 'Correct pressure reading with correct unit.',
    feedbackMiss: 'Read the gauge: about 56 kPa (just past half-way between 50 and 75). The unit must be kPa (capital K and P).',
  },
  '4e': {
    marks: 1,
  ...
  '4f': {
    marks: 1,
    exemplar: '0.57–0.59 m (accept any value in this range) [1].',
    keyConcepts: ['read LOBF at 38 kPa ≈ 0.57-0.59 m'],
    keywords: ['0.57', '0.58', '0.59', '38 kPa', 'estimate'],
    feedbackHit: 'Correct estimate from the LOBF.',
    feedbackMiss: 'Find 38 kPa on the x-axis, go up to your LOBF, then read across to the y-axis: about 0.57–0.59 m.',
  },
  '4g': {
    marks: 3,
    exemplar: 'y-intercept corresponds to a bounce height of approximately 0.38 m [1]. The ball is completely deflated when pressure = 0 kPa [1]. So in reality it will not bounce at all → the y-intercept is physically meaningless [1].',
    keyConcepts: ['y-intercept ≈ 0.38 m at 0 kPa', 'deflated ball bounces = 0', 'y-intercept physically meaningless'],
    keywords: ['y-intercept', '0.38', 'deflated', '0 kPa', 'not bounce', 'significance'],
    feedbackHit: 'Correct explanation of why the y-intercept is physically insignificant.',
    feedbackMiss: 'At 0 kPa the ball is completely deflated — it cannot bounce. The y-intercept suggests a bounce height of ~0.38 m at 0 kPa, which is impossible. So the y-intercept has no physical significance.',
  },
  '4h': {
    marks: 2,
  ...
  // Q5 — Tennis/Golf Ball Bounce Data
  '5a': {
    marks: 6,
  ...
  '5b': {
    marks: 2,
    exemplar: 'Evidence of conversion to m (5.0 × 10¹ cm = 50 cm = 0.50 m) [1]. Answer = 0.50(33) m [1].',
    keyConcepts: ['convert 5.0 × 10¹ cm to 0.50 m', 'mean = (0.48 + 0.53 + 0.50)/3 = 0.50 m'],
    keywords: ['0.50', '0.503', 'mean', 'average', 'convert', 'cm to m'],
    feedbackHit: 'Correct average calculated after unit conversion.',
    feedbackMiss: 'Convert Trial 3: 5.0 × 10¹ cm = 50 cm = 0.50 m. Mean = (0.48 + 0.53 + 0.50) ÷ 3 = 1.51 ÷ 3 = 0.50(33) m.',
  },
  '5c': {
    marks: 5,
    exemplar: 'Both drop-height and bounce-height table headers correct [1]. Table headers include units that agree with the data (no units in the data columns) [1]. Correct values recorded in order of increasing/decreasing drop height [1]. Values recorded to a consistent number of decimal places [1]. Data from part (b) included (0.50 m at 1.8 m) [1].',
    keyConcepts: ['headers with units', 'no units in data columns', 'ordered data', 'consistent decimal places', 'include 0.50 from part b'],
    keywords: ['header', 'unit', 'order', 'decimal places', 'consistent', '0.50', 'table'],
    feedbackHit: 'Good table with headers, units, ordered data.',
    feedbackMiss: 'Table needs: (1) headers with units (Drop height/m, Bounce height/m); (2) no units in data cells; (3) data in ascending/descending order by drop height; (4) consistent decimal places; (5) include 0.50 m at 1.8 m drop.',
  },
  '5d': {
    marks: 2,
    exemplar: 'Data point plotted correctly at (1.8, 0.50) — ECF from part b [1]. X axis: drop height/m AND Y axis: bounce height/m [1]. Must clearly distinguish the two types of height.',
    keyConcepts: ['plot (1.8, 0.50) ECF', 'x-axis = drop height/m, y-axis = bounce height/m'],
    keywords: ['plot', '1.8', '0.50', 'drop height', 'bounce height', 'x-axis', 'y-axis'],
    feedbackHit: 'Correct data point plotted with correct axis labels.',
    feedbackMiss: 'Plot the point (drop height = 1.8, bounce height = 0.50). Label x-axis "drop height/m" and y-axis "bounce height/m" — distinguish the two heights.',
  },
  ...
  '7e': {
    marks: 4,
    exemplar: 'One type of technology [1], e.g.: electric/hydrogen aircraft; sustainable aviation fuel; carbon capture; solar/wind energy. How it reduces CO₂ [1]. A strength [1]. A limitation [1].',
    keyConcepts: ['specific technology', 'mechanism for CO₂ reduction', 'strength', 'limitation'],
    keywords: ['technology', 'electric aircraft', 'sustainable fuel', 'carbon capture', 'solar', 'reduces CO₂', 'strength', 'limitation'],
    feedbackHit: 'Technology named with mechanism, strength, and limitation.',
    feedbackMiss: 'Name a specific technology. Explain HOW it reduces CO₂. Give one strength and one limitation. E.g. electric aircraft: no jet fuel burned → no in-flight CO₂; strength: no direct emissions; limitation: heavy batteries limit range / electricity may come from fossil fuels.',
  },

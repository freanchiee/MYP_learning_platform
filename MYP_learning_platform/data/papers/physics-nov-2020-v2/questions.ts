...
export const questions: Question[] = [
  ...
  // ─── Q6: Capillary action investigation (11 marks, Criterion C & A) ───
  {
    ...
    artefact: {
      component: 'GenericSVG',
      data: {
        svg: '<svg viewBox="0 0 560 280" xmlns="http://www.w3.org/2000/svg" font-family="Arial, Helvetica, sans-serif"><defs><linearGradient id="liq6b" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#cfe9d8"/><stop offset="1" stop-color="#7fbf96"/></linearGradient></defs><rect width="560" height="280" fill="#ffffff"/><text x="280" y="24" font-size="13" font-weight="700" text-anchor="middle" fill="#1f2d3a">Capillary tubes of different diameters</text><rect x="60" y="180" width="440" height="34" fill="url(#liq6b)" stroke="#3f7e6a"/><text x="498" y="200" font-size="11" fill="#2c5444">water</text><g><rect x="110.5" y="60" width="9" height="120" fill="none" stroke="#7d8a96"/><rect x="111.5" y="90" width="7" height="90" fill="url(#liq6b)"/><text x="115" y="236" font-size="11" text-anchor="middle" fill="#5b6b78">A</text><text x="115" y="252" font-size="10" text-anchor="middle" fill="#5b6b78">0.8 mm</text></g><g><rect x="200" y="60" width="13" height="120" fill="none" stroke="#7d8a96"/><rect x="201" y="119" width="11" height="61" fill="url(#liq6b)"/><text x="206" y="236" font-size="11" text-anchor="middle" fill="#5b6b78">B</text><text x="206" y="252" font-size="10" text-anchor="middle" fill="#5b6b78">1.2 mm</text></g><g><rect x="290" y="60" width="18" height="120" fill="none" stroke="#7d8a96"/><rect x="291" y="135" width="16" height="45" fill="url(#liq6b)"/><text x="299" y="236" font-size="11" text-anchor="middle" fill="#5b6b78">C</text><text x="299" y="252" font-size="10" text-anchor="middle" fill="#5b6b78">1.6 mm</text></g><g><rect x="381" y="60" width="22" height="120" fill="none" stroke="#7d8a96"/><rect x="382" y="144" width="20" height="36" fill="url(#liq6b)"/><text x="392" y="236" font-size="11" text-anchor="middle" fill="#5b6b78">D</text><text x="392" y="252" font-size="10" text-anchor="middle" fill="#5b6b78">2.0 mm</text></g><line x1="60" y1="90" x2="60" y2="180" stroke="#1f2d3a"/><line x1="56" y1="90" x2="64" y2="90" stroke="#1f2d3a"/><line x1="56" y1="135" x2="64" y2="135" stroke="#1f2d3a"/><line x1="56" y1="180" x2="64" y2="180" stroke="#1f2d3a"/><g font-size="9" fill="#1f2d3a" text-anchor="end"><text x="52" y="93">40</text><text x="52" y="138">20</text><text x="52" y="183">0</text></g><text x="28" y="135" font-size="10" fill="#1f2d3a" text-anchor="middle" transform="rotate(-90 28 135)">height / mm</text></svg>',
      },

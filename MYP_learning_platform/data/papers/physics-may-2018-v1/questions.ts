    ...
    tasks: [
      {
        ...
        artefact: {
          component: 'GenericSVG',
          data: {
            svg: '<svg viewBox="0 0 320 320" xmlns="http://www.w3.org/2000/svg" font-family="Arial, Helvetica, sans-serif"><rect width="320" height="320" fill="#ffffff"/><rect x="148" y="18" width="24" height="22" rx="4" fill="#5b6b78"/><line x1="160" y1="18" x2="160" y2="6" stroke="#5b6b78" stroke-width="6"/><circle cx="160" cy="172" r="120" fill="#f3f4f5" stroke="#1f2d3a" stroke-width="6"/><circle cx="160" cy="172" r="110" fill="#ffffff" stroke="#b6c4cf" stroke-width="2"/><g stroke="#1f2d3a" stroke-width="2"><line x1="160" y1="66" x2="160" y2="80"/><line x1="254" y1="172" x2="240" y2="172"/><line x1="160" y1="278" x2="160" y2="264"/><line x1="66" y1="172" x2="80" y2="172"/></g><text x="160" y="60" font-size="13" text-anchor="middle" fill="#5b6b78">0</text><text x="266" y="177" font-size="13" text-anchor="middle" fill="#5b6b78">15</text><text x="160" y="298" font-size="13" text-anchor="middle" fill="#5b6b78">30</text><text x="54" y="177" font-size="13" text-anchor="middle" fill="#5b6b78">45</text><circle cx="160" cy="172" r="6" fill="#0b7285"/><line x1="160" y1="172" x2="256" y2="175" stroke="#0b7285" stroke-width="4" stroke-linecap="round"/><rect x="104" y="196" width="112" height="40" rx="6" fill="#0b7285"/><text x="160" y="224" font-size="26" font-weight="700" text-anchor="middle" fill="#ffffff" font-family="Courier New, monospace">11.5 s</text></svg>',
          },

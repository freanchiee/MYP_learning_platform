...
/**
 * MYP Geography — November 2019 mark scheme (rubric-banded, "best fit").
 *
...
export const MS: MSRecord = {
  ...
  q1_: {
    marks: 2,
    exemplar: 'Renewable resources: wind, geo-thermal, solar. Non-renewable resources: coal, oil.',
    keyConcepts: ['natural resources', 'sustainability', 'classification'],
    keywords: ['renewable', 'non-renewable', 'wind', 'geo-thermal', 'solar', 'coal', 'oil'],
    feedbackHit: 'Correct — all four energy resources sorted into the right renewable / non-renewable category.',
    feedbackMiss: 'Renewable: wind, geo-thermal, solar. Non-renewable: coal, oil. One correct = 0; two/three correct = 1; four correct = 2.',
    commandTerm: 'Select',
    commandTermDefinition: 'Choose from a list or group. Recognize and place each item in its correct category.',
    blankAnswers: ['Wind — renewable', 'Geo-thermal — renewable', 'Solar — renewable', 'Coal — non-renewable', 'Oil — non-renewable'],
    rubricBands: [
      { marks: '0', descriptor: 'One image correctly positioned.', exemplar: 'Only one resource sorted into the correct bin.' },
      { marks: '1', descriptor: 'Two or three images correctly positioned.', exemplar: 'Wind and solar placed under renewable; the rest misplaced.' },
      { marks: '2', descriptor: 'Four images correctly positioned.', exemplar: 'Renewable: wind, geo-thermal, solar. Non-renewable: coal, oil.' },
    ],
  },
  ...
  q2_: {
    marks: 4,
    exemplar:
      'Population growth is causing greater demand for food. As the greatest growth of population is in Sub-Saharan Africa, there is pressure on land. This leads to deforestation and over-grazing which increases desertification, reducing the productivity of the land.',
    keyConcepts: ['causality', 'natural resources', 'scarcity', 'sustainability'],
    keywords: ['population growth', 'demand', 'pressure on land', 'deforestation', 'over-grazing', 'desertification', 'example'],
    ...
    rubricBands: [
      ...
      { marks: '1', descriptor: 'States one factor that can cause natural resource scarcity (one sentence hinting at a single factor).', exemplar: 'Population growth.' },
      { marks: '2', descriptor: 'Outlines one factor that can cause scarcity, using an example (a single sentence with two clauses or two/three short sentences; brief detail).', exemplar: 'Population growth is causing greater demand for food and this puts pressure on land.' },
      { marks: '3', descriptor: 'Describes one factor that can cause scarcity, using an example (one factor in detail, no comprehensive reasoning). Awarded to an explanation with no example.', exemplar: 'Population growth is causing greater demand for food. As the greatest growth of population is in the least developed countries, there is pressure on land. This leads to deforestation and over-grazing which increases desertification.' },
      { marks: '4', descriptor: 'Explains one factor that can cause scarcity, using an example (one factor in detail, with reasoning).', exemplar: 'Population growth is causing greater demand for food. As the greatest growth of population is in Sub-Saharan Africa, there is pressure on land. This leads to deforestation and over-grazing which increases desertification, reducing the productivity of the land.' },
    ],
  },
  ...
  q3_: {
    ...
    rubricBands: [
      ...
      { marks: 'Strengths 3', descriptor: 'Explains the strength(s) of the action plan (one strength elaborated in additional detail with reasoning).', exemplar: 'The interviewee is a good choice as she would have access to government data and so should be able to answer the questions fully. The interview questions are mainly relevant to the investigation because they relate to the impacts of the Renaissance Dam on all three countries. The answers will give specific and accurate information to help reach conclusions to aid the investigation.' },
  ...
  q4_a: {
    marks: 2,
    exemplar: 'To what extent is the drilling for natural gas in the Caspian Sea impacting the production of caviar?',
    ...
    rubricBands: [
      { marks: '0', descriptor: 'The student does not achieve a standard described by the descriptors below.' },
      { marks: '1', descriptor: 'Formulates a research question that is clear and/or focused, with a limited connection to the statement of inquiry (e.g. clear and connected, but lacking focus — no location/time period).', exemplar: 'To what extent is the extraction of fossil fuels from the sea impacting marine life?' },
      { marks: '2', descriptor: 'Formulates a research question that is clear and focused with a clear connection to the statement of inquiry (the RQ focuses on a place).', exemplar: 'To what extent is the drilling for natural gas in the Caspian Sea impacting the production of caviar?' },
    ],
  },
  ...
  q4_b: {
    marks: 4,
    exemplar:
      'My research question refers to the extraction of a natural resource, gas, in a particular location (the Caspian Sea). This type of economic activity causes pollution, which threatens the production of caviar and affects communities living on and around the Caspian Sea. It could also lead to the extinction of species, affecting the marine ecosystem.',
    keyConcepts: ['investigation', 'relevance', 'reasoning'],
    keywords: ['relevance', 'extraction', 'pollution', 'communities', 'caviar', 'marine ecosystem', 'statement of inquiry'],
    ...
    rubricBands: [
      { marks: '0', descriptor: 'The student does not achieve a standard described by the descriptors below.' },
      { marks: '1', descriptor: 'States the relevance of the research question to the SoI (a single sentence making a simple connection; no detail required).', exemplar: 'My research question refers to the extraction of a natural gas in the Caspian Sea.' },
      { marks: '2', descriptor: 'Outlines the relevance of the RQ to the SoI (a single factor or brief detail on why the RQ is relevant).', exemplar: 'My research question refers to the extraction of a natural gas in the Caspian Sea. This causes pollution, which affects communities living on and around the Caspian Sea.' },
      { marks: '3', descriptor: 'Describes the relevance of the RQ to the SoI (at least one argument/factor in detail, without reasoning).', exemplar: 'My research question refers to the extraction of a natural resource, gas, in a particular location (the Caspian Sea). This type of economic activity causes pollution, which threatens the production of caviar and affects communities living on and around the Caspian Sea.' },
      { marks: '4', descriptor: 'Justifies the relevance of the RQ to the SoI (at least one argument/factor in detail, along with reasoning).', exemplar: 'My research question refers to the extraction of a natural resource, gas, in a particular location (the Caspian Sea). This type of economic activity causes pollution, which threatens the production of caviar and affects communities living on and around the Caspian Sea. It could also lead to the extinction of species, affecting the marine ecosystem.' },
    ],
  },
  ...
  q4_d: {
    marks: 2,
    exemplar:
      'The skype interview will provide me with primary data from an expert who would know about the impacts of extraction on human and natural environments.',
    keyConcepts: ['investigation', 'methods', 'usefulness'],
    keywords: ['skype interview', 'primary data', 'expert', 'extraction', 'human and natural environments'],
    ...
    rubricBands: [
      { marks: '0', descriptor: 'The student does not achieve a standard described by the descriptors below.' },
      { marks: '1', descriptor: 'States how the chosen method would be useful to their investigation (a statement/fact about usefulness).', exemplar: 'The skype interview will provide me with primary data from an expert.' },
      { marks: '2', descriptor: 'Outlines how the chosen method would be useful (elaborates on the usefulness with some brief detail).', exemplar: 'The skype interview will provide me with primary data from an expert who would know about the impacts of extraction on human and natural environments.' },
    ],
  },
  ...
  q4_e: {
    marks: 2,
    exemplar:
      'I might not be able to find reliable data on the impact of gas drilling on marine life in the Caspian Sea because companies and governments may not always publish it.',
    keyConcepts: ['investigation', 'methods', 'reliability'],
    keywords: ['challenge', 'reliable data', 'gas drilling', 'companies', 'governments', 'may not publish'],
  ...
  q5_: {
    marks: 18,
    exemplar:
      'TITLE: “Stop tourists trashing the environment!” CAPTION: “Our delicate marine environments are being destroyed — sign now to save them for future generations.” As international tourism numbers continue to grow there is an increasing need to ensure that it is sustainable. People won’t stop travelling — they are only travelling more, as they have more money and time. For that reason, there needs to be more control over the number of tourists to ensure that the beauty of delicate natural environments is preserved. For example, in the Galapagos Islands, a marine reserve was created in 1998 to protect its biodiversity; whilst it does not stop tourists, it does limit the numbers allowed to visit, and those who do visit are limited to certain areas. Some argue that all mass tourism is unsustainable — in Thailand, Maya beach has been closed since June 2018 to allow the ecosystem to recover. In Spain, there have been efforts to involve local communities more in managing tourism and rebranding less well-known areas to reduce the pressure on hotspots, done by offering free public transport to alternative attractions; involving locals ensures their needs are included and encourages them to support the efforts in the long term.',
    keyConcepts: ['globalization', 'sustainability', 'management & intervention', 'communication'],
    keywords: ['overtourism', 'sustainable', 'Galapagos Islands', 'marine reserve', 'Maya beach', 'Spain', 'petition', 'title', 'caption', 'persuasive'],
    feedbackHit: 'Well done — a titled, captioned petition plus a persuasive TV interview explaining how overtourism threatens natural environments and how it can be managed sustainably, with examples.',
    feedbackMiss: 'Marked across four strands: Knowledge (Crit A /6), Format /2, Communicating /6, Organization /4. Write an appropriate title AND a caption, explain overtourism threats and sustainable management with named examples, and write persuasively for the general public.',
    commandTerm: 'Explain',
    commandTermDefinition: 'Give a detailed account including reasons or causes.',
    rubricBands: [
      { marks: 'CritA 0', descriptor: 'The student does not achieve a standard described by the descriptors below.' },
      { marks: 'CritA 1', descriptor: 'Limited knowledge: outlines how natural environments threatened by overtourism can be managed sustainably, using limited examples and limited relevant terminology (brief, little detail).', exemplar: 'Some argue that all mass tourism is unsustainable and therefore should be controlled by the governments of tourist hotspots like the Galapagos Islands.' },
      { marks: 'CritA 2–3', descriptor: 'Adequate knowledge: describes how natural environments threatened by overtourism can be managed sustainably, using satisfactory examples and appropriate relevant terminology (little or no reasoning).', exemplar: 'There needs to be more control over the number of tourists to ensure that the beauty of delicate natural environments is preserved. For example, in the Galapagos Islands, a marine reserve was created; those who do visit are limited to certain areas. In Spain, there have been efforts to involve local communities more in managing tourism and rebranding less well-known areas to reduce the pressure on hotspots.' },
      { marks: 'CritA 4–5', descriptor: 'Substantial knowledge: explains how natural environments threatened by overtourism can be managed sustainably, using accurate examples and appropriate relevant terminology (detailed, logical, some reasoning).', exemplar: 'As international tourism numbers continue to grow there is an increasing need to ensure that it is sustainable. People won’t stop travelling, they are only travelling more. For that reason there needs to be more control over the number of tourists. For example, in the Galapagos Islands, a marine reserve was created; whilst it does not stop tourists, it does limit the numbers allowed to visit. Involving locals will encourage them to support the efforts.' },
      { marks: 'CritA 6', descriptor: 'Detailed knowledge: thoroughly explains how natural environments threatened by overtourism can be managed sustainably, using accurate and effective examples and appropriate relevant terminology (clear reasoning, comprehensive understanding).', exemplar: 'For example, in the Galapagos Islands, a marine reserve was created in 1998 to protect its biodiversity. Some argue that all mass tourism is unsustainable — in Thailand, Maya beach has been closed since June 2018 to allow the ecosystem to recover. In Spain, efforts to involve local communities and rebrand less well-known areas, by offering free public transport to alternative attractions, ensure their needs are included and encourage them to support the efforts in the long term.' },
  ...
  q6_: {
    marks: 2,
    exemplar: 'It has decreased from 153,678 to 68,748.',
    keyConcepts: ['interpretation', 'trends', 'natural disasters'],
    keywords: ['trend', 'decreased', 'deaths', 'data', '153,678', '68,748'],
    feedbackHit: 'Well done — you outlined the trend (deaths decreased) and referenced data from the graph.',
    feedbackMiss: 'Build from stating the trend, e.g. “It has decreased” (1) → outlining the trend with reference to data, e.g. “decreased from 153,678 to 68,748” (2).',
    commandTerm: 'Outline',
    commandTermDefinition: 'Give a brief account or summary.',
    rubricBands: [
      { marks: '0', descriptor: 'The student does not achieve a standard described by the descriptors below.' },
      { marks: '1', descriptor: 'States the trend (a statement about the number of deaths decreasing).', exemplar: 'It has decreased.' },
      { marks: '2', descriptor: 'Outlines the trend with reference to data in the graph.', exemplar: 'It has decreased from 153,678 to 68,748.' },
    ],
  },
  ...
  q7_: {
    marks: 4,
    exemplar:
      'Risk is calculated from both natural disaster factors and vulnerability. The magnitude of a disaster would normally increase the risk, if the area is densely populated. Even with a great magnitude, the risk can be reduced with effective management. When events happen frequently, the population may be better prepared except when it is an event of extremely high magnitude.',
    ...
    feedbackHit: 'Well done — you described in detail how natural disaster factors and vulnerability combine to determine risk.',
    ...
    rubricBands: [
      { marks: '0', descriptor: 'The student does not achieve a standard described by the descriptors below.' },
      { marks: '1', descriptor: 'States the relationship between natural disaster factors and vulnerability (one sentence hinting at a single factor).', exemplar: 'The magnitude of a disaster would increase the risk but only if the area is densely populated.' },
      { marks: '2', descriptor: 'Outlines the relationship between natural disaster factors and vulnerability (a single sentence with two clauses or two/three short sentences; brief detail).', exemplar: 'Risk is calculated from both natural disaster factors and vulnerability. The magnitude of a disaster would increase the risk but only if the area is densely populated.' },
      { marks: '3', descriptor: 'Describes the relationship (considered without reasons; an example may support the description; a short paragraph).', exemplar: 'Risk is calculated from both natural disaster factors and vulnerability. The magnitude of a disaster would normally increase the risk but only if the area is densely populated. Despite a great magnitude, the risk can be reduced with effective management.' },
      { marks: '4', descriptor: 'Describes in detail the relationship between natural disaster factors and vulnerability (considered in detail; reasons not required; an example may support).', exemplar: 'Risk is calculated from both natural disaster factors and vulnerability. The magnitude of a disaster would normally increase the risk, if the area is densely populated. Even with a great magnitude, the risk can be reduced with effective management. When events happen frequently, the population may be better prepared except when it is an event of extremely high magnitude.' },
    ],
  },
  ...
  q8_a: {
    marks: 3,
    exemplar:
      'The information given in the app provides satellite images, maps and photographs, so it is easy for users to assess the danger and decide what to do. The satellite image will help to assess where the fire might spread to next, and the app will allow local residents to see where the wildfires are located by looking at the map feature so they can decide if they should evacuate their home and move to safer ground. They will be able to make a judgement as to how at risk they are and decide on the appropriate action.',
    keyConcepts: ['source evaluation', 'value', 'management & intervention'],
    keywords: ['satellite images', 'maps', 'photographs', 'assess danger', 'evacuate', 'safer ground', 'local residents'],
    feedbackHit: 'Well done — you described one value of the Wildfire Alert app for local residents in detail.',
    ...
    rubricBands: [
      { marks: '0', descriptor: 'The student does not achieve a standard described by the descriptors below.' },
      { marks: '1', descriptor: 'States one value of the Wildfire Alert app for local residents.', exemplar: 'The information given in the app is easy to read and understand.' },
      { marks: '2', descriptor: 'Outlines one value of the Wildfire Alert app for local residents (one benefit elaborated; brief detail).', exemplar: 'The information given in the app is easy to read and understand as it provides satellite information, maps and photographs.' },
      { marks: '3', descriptor: 'Describes one value of the Wildfire Alert app for local residents (one benefit considered in detail; a short paragraph).', exemplar: 'The information given in the app provides satellite images, maps and photographs, so it is easy for users to assess the danger and decide what to do. The satellite image will help firefighters to assess where the fire might spread to next. The app will allow local residents to see where the wildfires are located so they can decide if they should evacuate their home and move to safer ground, making a judgement as to how at risk they are.' },
    ],
  },
  ...
  q8_b: {
    marks: 3,
    exemplar:
      'The app is limited in terms of the information it provides. It does not tell the user about wind direction or speed and therefore the direction that the fire is moving in or the speed of spread, so local residents will not know if they are at risk.',
    keyConcepts: ['source evaluation', 'limitation', 'management & intervention'],
    keywords: ['limitation', 'wind direction', 'speed', 'direction fire is moving', 'at risk', 'local residents'],
    feedbackHit: 'Well done — you described one limitation of the Wildfire Alert app for local residents in detail.',
    feedbackMiss: 'Build from stating a limitation (1) → outlining it (2) → describing one limitation in detail (3), e.g. it does not show wind direction/speed so residents cannot tell if the fire is moving towards them.',
    commandTerm: 'Describe',
    commandTermDefinition: 'Give a detailed account or picture of a situation, event, pattern or process.',
    rubricBands: [
      { marks: '0', descriptor: 'The student does not achieve a standard described by the descriptors below.' },
      { marks: '1', descriptor: 'States one limitation of the Wildfire Alert app for local residents.', exemplar: 'It does not tell local residents whether or not they are at risk.' },
      { marks: '2', descriptor: 'Outlines one limitation of the Wildfire Alert app for local residents (one limitation elaborated; brief detail).', exemplar: 'The app is limited in terms of the information it provides. It does not tell the user direction that the fire is moving in so local residents will not know if they are at risk.' },
      { marks: '3', descriptor: 'Describes one limitation of the Wildfire Alert app for local residents (one limitation considered in detail; a short paragraph).', exemplar: 'The app is limited in terms of the information it provides. It does not tell the user about wind direction or speed and therefore the direction that the fire is moving in or the speed of spread, so local residents will not know if they are at risk.' },
    ],
  },

...
export const questions: Question[] = [
  ...
  // ── Q1: Pendulum & Wrecking Ball (12 marks, Crit A) ──────────────
  {
    ...
    tasks: [
      ...
      {
        label: 'e',
        text: 'A wrecking ball is an example of a pendulum that can be used to demolish buildings. It is a very heavy steel ball hanging from a crane, which is released and swung to hit the structure. Mass of steel ball = 1500 kg.\n\nInitially, the ball is stationary. The crane operator releases the ball from a height of 14.0 m. The ball hits the building at 4.0 m above the ground.\n\n**Calculate** the kinetic energy of the ball when it hits the building at 4.0 m above the ground. You should assume that the acceleration due to gravity g = 9.81 m s⁻². Give your result in kJ rounded to two significant figures.',
        marks: 4,
        figImages: [`${P}page-02-crop.png`],
        ph: 'Show your working:\nHeight change: Δh = 14.0 − 4.0 = ... m\nUsing conservation of energy: KE = mgh\nKE = 1500 × 9.81 × ...\nKE = ... J = ... kJ (2 s.f.)',
      },
      {
        label: 'f',
  ...
  // ── Q2: Smoke Detectors & Radioactivity (12 marks, Crit A) ───────
  {
    ...
    stem: 'Smoke detectors are safety devices that sound an alarm when smoke is detected. They are designed to give early warning during a fire. Some smoke detectors use the properties of ionising radiation to detect smoke.',
    figImages: [`${P}page-03-crop.png`],
    tasks: [
      {
        label: 'a',
        text: '**Outline** why smoke detectors are installed on the ceiling in a building instead of on the walls or floor.',
        marks: 2,

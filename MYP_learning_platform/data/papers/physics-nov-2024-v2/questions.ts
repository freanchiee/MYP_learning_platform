...
export const questions: Question[] = [
  ...
  // ── Q1: Pendulum & Wrecking Ball (12 marks, Crit A) ──────────────
  {
    ...
    tasks: [
      ...
      {
        label: 'c',
        text: 'A pendulum can be used to determine the acceleration due to gravity, g.\n\nThe period T of a pendulum is the time taken to complete one swing. T depends on the length of the pendulum L and g. It is given by the relationship: T² = 4π²L / g\n\nA pendulum used in a laboratory in Australia has a length of 95.0 cm. The time taken for 10 periods is measured to be 19.6 s.\n\n**Calculate** the acceleration due to gravity g in m s⁻² in this laboratory, giving your answer to three significant figures.',
        marks: 3,
        ph: 'Show your working:\nStep 1 — find T: T = 19.6 / 10 = ... s\nStep 2 — rearrange: g = 4π²L / T²\nStep 3 — substitute: g = 4 × π² × 0.950 / (...)²\ng = ... m s⁻² (3 s.f.)',
      },
      {
        label: 'd',
        text: 'The expected value of acceleration due to gravity at this location is 9.80 m s⁻².\n\n**Suggest** why the experimental value in part (c) is different.',
        marks: 1,
        ph: 'Suggest one reason (e.g. measurement uncertainty in T or L, environmental factor, location above sea level)...',
      },
      {
        label: 'e',
        text: 'A wrecking ball is an example of a pendulum that can be used to demolish buildings. It is a very heavy steel ball hanging from a crane, which is released and swung to hit the structure. Mass of steel ball = 3000 kg.\n\nInitially, the ball is stationary. The crane operator releases the ball from a height of 9.5 m. The ball hits the building at 3.5 m above the ground.\n\n**Calculate** the kinetic energy of the ball when it hits the building at 3.5 m above the ground. You should assume that the acceleration due to gravity g = 9.81 m s⁻². Give your result in kJ rounded to two significant figures.',
        marks: 4,
        figImages: [`${P}page-02-crop.png`],
        ph: 'Show your working:\nHeight change: Δh = 9.5 − 3.5 = ... m\nUsing conservation of energy: KE = mgh\nKE = 3000 × 9.81 × ...\nKE = ... J = ... kJ (2 s.f.)',
      },
      {
        label: 'f',
  ...
  // ── Q2: Smoke Detectors & Radioactivity (12 marks, Crit A) ───────
  {
    ...
    stem: 'Smoke detectors are life-saving devices that detect smoke and trigger an alarm, warning occupants of a potential fire. Modern smoke detectors use the ionising properties of radioactive materials to detect smoke particles.',
    figImages: [`${P}page-03-crop.png`],
    tasks: [
      {
        label: 'a',
        text: '**Outline** why smoke detectors are installed on the ceiling in a home instead of on the walls or floor.',
        marks: 2,
  ...
  // ── Q3: Resistance Investigation (17 marks, Crit B/C) ────────────
  {
    ...
    stem: 'A resistor is an electrical component that limits the flow of current in a circuit and converts electrical energy to heat. Resistance can be measured using an ohmmeter.\n\nA student is interested in studying resistance. They decide to model resistors using graphite rods of different diameters. Their research question is:\n\n"What is the relationship between the diameter of a graphite rod and its resistance?"',
    ...
    tasks: [
      ...
      },
      {
        ...
        marks: 3,
        ph: 'Research question: How does ___ affect the resistance of the graphite rod?\nIndependent variable: ___\nControl variable: ___ (kept constant because...)',
      },
    ],
  },

  // ── Q4: LDR Investigation Design with Filter Layers (14 marks, Crit B)
  {
    id: 4,
    crit: 'B',
    type: 'extended',
    ...
    stem: 'The resistance of a light-dependent resistor (LDR) depends on the intensity of light shining on its upper, light-sensitive surface. A student predicts:\n\n"If the number of layers of filter paper placed between a light source and an LDR increases, then the resistance of the LDR will also increase."',
    tasks: [
      {
        label: 'a',
        text: '**State** a research question for the student\'s investigation.',
        marks: 1,
        ph: 'How does the ___ of layers of filter paper between the lamp and the LDR affect the ___ of the LDR?',
      },
      {
        label: 'b',
        ...
        ph: 'VARIABLES:\nIndependent variable: number of layers of filter paper (0, 1, 2, 3, 4, 5)\nDependent variable: resistance of LDR (Ω, measured by ohmmeter)\nControl variable 1: ___ — because if this changes, it would affect the light intensity...\nControl variable 2: ___ — because...\n\nEQUIPMENT:\n•\n•\n•\n\nMETHOD:\n1. Set up the lamp above the LDR at a fixed distance.\n2. Place 0 layers of filter paper between the lamp and the LDR.\n3. Record the resistance shown on the ohmmeter.\n4. Add one layer of filter paper and repeat...\n\nSUFFICIENT DATA:\n• Range: 0 to ___ layers\n• Intervals: 1 layer at a time (___ data points)\n• Repeats: ___ trials per layer count (to calculate mean)',
      },
    ],
  },
  ...
  // ── Q6: Water Tower & Clean Water (13 marks, Crit D) ─────────────
  {
    id: 6,
    crit: 'D',
    type: 'extended',
    ...
    tasks: [
      {
        ...
        marks: 3,
        ph: 'Show your working:\nVolume = 6 300 m³\nMass = density × volume = 1000 × 6 300 = ___ kg\nW = mgh = ___ × 9.81 × 45\nW = ___ J ≈ ___ × 10⁹ J (2 s.f.)',
      },
      {
        label: 'b',

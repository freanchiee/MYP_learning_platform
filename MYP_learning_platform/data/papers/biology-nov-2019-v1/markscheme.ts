...
// ── Mark Scheme: Biology November 2019 — Variant 1 ────────────────────────
export const MS: MSRecord = {

  // ── Q1: Food Web (freshwater pond) ────────────────────────────────────────
  q1_a: {
    marks: 1,
    exemplar: 'Food web',
  ...
  q1_c: {
    marks: 2,
    exemplar: 'Producer: algae, pondweed, or reeds. Secondary consumers (any two): dragonfly larva, perch, frog, pike, otter, heron.',
    keyConcepts: ['producer algae pondweed reeds', 'secondary consumer dragonfly larva perch frog pike otter heron'],
    keywords: ['producer', 'secondary consumer', 'algae', 'pondweed', 'reeds', 'dragonfly', 'perch', 'frog', 'pike', 'otter', 'heron'],
    feedbackHit: 'Correct producer and secondary consumers identified.',
    feedbackMiss: 'Producers make their own food through photosynthesis (algae, pondweed, reeds). Secondary consumers eat primary consumers — e.g. dragonfly larva, perch, frog, pike, otter, heron.',
  },
  q1_d: {
    marks: 5,
    exemplar: 'Pondweed population increases because there are fewer mayfly nymphs eating the pondweed. Frog population decreases because perch eat more frogs/tadpoles (perch switch prey as there are fewer mayfly nymphs).',
    keyConcepts: [
      'pondweed population increases',
      'fewer mayfly nymphs eating pondweed',
      'frog population decreases',
      'perch eat more frogs or tadpoles',
      'perch no longer eat mayfly nymph',
    ],
    keywords: ['pondweed', 'increases', 'frog', 'decreases', 'perch', 'mayfly', 'fewer', 'prey'],
    feedbackHit: 'Good explanation of population changes through the food web.',
    feedbackMiss: 'Pondweed: increases — fewer mayfly nymphs eating it. Frog: decreases — perch switch to eating more frogs/tadpoles since mayfly numbers fell. Award marks for each correctly reasoned chain of effect.',
  },
  q1_e: {
    marks: 1,
    ...
    feedbackMiss: 'Decomposers break down dead organisms (and waste) and recycle nutrients back into the water/soil.',
  },
  q1_f: {
    marks: 1,
  ...
  // ── Q2: Cells & Photosynthesis (duckweed) ──────────────────────────────────
  ...
  q3_a: {
    marks: 4,
    exemplar: 'IV: temperature (of water bath). DV: volume of gas/CO₂ collected in the syringe. CVs (any two): volume of solutions, concentration of glucose, duration of reaction (20 min), starting temperature of solution.',
    keyConcepts: [
      'independent variable temperature',
      'dependent variable volume of CO2 gas syringe',
      'control variable volume solutions',
      'control variable concentration of glucose or duration',
    ],
    keywords: ['independent', 'dependent', 'control', 'temperature', 'syringe', 'volume', 'CO2', 'concentration', 'duration'],
    feedbackHit: 'Correct variables identified with appropriate units/quantities.',
    feedbackMiss: 'IV: temperature (of water bath). DV: volume of CO₂ collected in the gas syringe — must indicate a quantity. CVs: volume of solutions, concentration/type of sugar, duration of reaction, starting temperature.',
  },
  q3_b: {
    marks: 2,
  ...
  q3_c: {
    marks: 4,
    exemplar: 'Use a more precise measuring tool (e.g. read the gas syringe to the nearest cm³) — gives more precise/quantitative data. More trials/repeats at each temperature — reduces uncertainty/gives reliable data. Larger temperature range with smaller increments. Control the mass of yeast or glucose.',
    keyConcepts: [
    ...
    feedbackMiss: 'Improvements: (1) read the gas syringe precisely for quantitative data; (2) add repeats to reduce uncertainty; (3) larger temperature range with smaller increments; (4) control mass/concentration of yeast or glucose.',
  },

  // ── Q4: Different Sugars (maltase) ────────────────────────────────────────
  q4_a: {
    marks: 2,
    exemplar: 'How does the type of sugar affect the rate of respiration in yeast as measured by the volume of carbon dioxide produced in 20 minutes?',
    keyConcepts: [
      'research question different sugars',
      'measurable dependent variable CO2 volume syringe',
    ],
    keywords: ['sugar', 'respiration', 'yeast', 'rate', 'CO2', 'volume', 'syringe', 'measure'],
  ...
  q4_b: {
    marks: 4,
    exemplar: 'Maltose — it fits in the active site of the enzyme / maltose is the correct shape / the other sugars do not fit. A correct use of the term "active site" or lock-and-key model.',
    keyConcepts: [
      'maltose most likely respired',
      'maltose fits active site of enzyme',
      'lock and key model',
      'other sugars wrong shape do not fit',
    ],
    keywords: ['maltose', 'active site', 'lock and key', 'shape', 'fits', 'enzyme', 'maltase'],
    feedbackHit: 'Correct prediction with valid lock-and-key justification.',
    feedbackMiss: 'Maltose — because its shape matches the active site of maltase (lock-and-key model). The other sugars have different shapes and cannot be broken down by maltase.',
  },
  q4_c: {
    marks: 15,
    exemplar: 'Full Criterion B: IV: type of sugar (all 5); DV: volume of CO₂/gas syringe reading; 2 CVs. Three repeats, mean calculated. Equipment to measure DV and control CVs. Complete replicable method measuring a rate.',
    keyConcepts: [
      'IV type of sugar five sugars',
      'DV volume CO2 gas syringe',
  ...
  // ── Q5: Fermentation & Biofuels (apple core + banana peel) ────────────────
  q5_a: {
    marks: 1,
  ...
  q5_c: {
    marks: 1,
    exemplar: 'Apple core: Day 3; Banana peel: Day 5',
    blankAnswers: ['3', '5'],
    keyConcepts: ['apple core day 3', 'banana peel day 5'],
    keywords: ['day 3', 'day 5'],
    feedbackHit: 'Correct days identified for peak ethanol production.',
    feedbackMiss: 'Apple core peak = Day 3 (4.8 mg). Banana peel peak = Day 5 (10.0 mg).',
  },
  q5_d: {
    marks: 5,
    exemplar: 'Title: Mass of ethanol produced from food waste over time. X-axis: Day / day(s). Y-axis: Mass of ethanol / mg. Six apple core points correctly plotted ± 0.2; all points correctly plotted.',
    keyConcepts: [
      'title linked to food waste and time',
      'x axis day time',
      'y axis mass of ethanol mg',
      'apple core points correctly plotted',
    ],
    keywords: ['title', 'axis', 'label', 'units', 'mg', 'day', 'plot', 'points', 'graph'],
    feedbackHit: 'Graph correctly plotted with title and labelled axes.',
    feedbackMiss: 'Title must reference both types of food waste and time. X-axis: day. Y-axis: mass of ethanol / mg (unit required). Plot all 6 apple core data points accurately.',
  },
  q5_e: {
    marks: 6,
  ...
  q5_f: {
    marks: 1,
    exemplar: '24.7 mg',
    keyConcepts: ['24.7', 'total banana peel ethanol'],
    keywords: ['24.7', 'total', 'banana'],
    feedbackHit: 'Correct total calculated.',
    feedbackMiss: '1.8 + 6.2 + 10.0 + 4.0 + 1.5 + 1.2 = 24.7 mg',
  },
  q5_g: {
    marks: 1,
    exemplar: '7.0 mg',
    keyConcepts: ['7.0', 'difference'],
    keywords: ['7.0', 'difference'],
    feedbackHit: 'Correct difference calculated (must be given to 2 significant figures).',
    feedbackMiss: '24.7 − 17.7 = 7.0 mg (must be given to 2 significant figures).',
  },
  q5_h: {
    marks: 2,
    exemplar: 'Apple core has the highest carbohydrate content and the lowest total ethanol. The sugars in the carbohydrate may not all be fermented by yeast. Or: nutritional data is about food, not the food waste used in the investigation.',
    keyConcepts: [
      'apple core highest carbohydrate lowest ethanol',
    ...
    feedbackMiss: 'Apple core has MORE carbohydrate but produced LESS ethanol. Reasons: (1) not all carbohydrates can be fermented by yeast; (2) nutritional data is for whole food, not the food waste portion used.',
  },
  q5_i: {
    marks: 4,
  ...
  // ── Q6: Human Growth Hormone & GM Bacteria ────────────────────────────────
  q6_a: { type: 'mcq', correct: 1 },
  q6_b: {
    marks: 4,
    exemplar: 'Stage 1: Human growth-hormone gene extracted. Stage 2: Plasmid DNA opened. Stage 3: Genetically modified bacteria reproduce. Stage 4: Extraction and purification of human growth hormone.',
    keyConcepts: [
      'stage 1 human growth hormone gene extracted',
      'stage 2 plasmid DNA opened',
      'stage 3 genetically modified bacteria reproduce',
      'stage 4 extraction purification human growth hormone',
    ],
    keywords: ['growth hormone gene', 'plasmid', 'bacteria reproduce', 'extraction', 'purification'],
    feedbackHit: 'All four stages correctly identified.',
    feedbackMiss: 'Stage 1: Human growth-hormone gene extracted. Stage 2: Plasmid DNA opened. Stage 3: Genetically modified bacteria reproduce. Stage 4: Extraction and purification of human growth hormone.',
  },
  q6_c: {
    marks: 2,
    exemplar: 'The body cannot make enough growth hormone of its own. Growth hormone controls/regulates growth. Without regular doses growth would slow. Regular doses keep the hormone level high enough to support normal growth.',
    keyConcepts: [
      'body cannot make enough growth hormone',
      'growth hormone regulates growth',
      'regular doses maintain hormone level',
    ],
    keywords: ['growth hormone', 'deficiency', 'regular', 'doses', 'regulate', 'level'],
    feedbackHit: 'Correctly explains why regular growth-hormone doses are needed.',
    feedbackMiss: 'The body cannot produce enough growth hormone, which is needed to regulate growth. Regular doses keep the hormone level high enough for normal growth to continue.',
  },
  q6_d: {
    marks: 14,
    exemplar: 'Individual: more available/affordable hormone, different forms for personalised treatment, treatment safer than donor-extracted hormone. Community: more children can access treatment; questions of fairness if only the wealthy benefit. Economic: mass production reduced cost; healthcare systems still face a large burden. Concluding appraisal linking two or more of the above.',
    keyConcepts: [
      'individual health more available affordable hormone',
      'different forms personalised treatment',
      'treatment safer than donor extracted',
    ...
    feedbackMiss: 'Address: (1) individual health impacts, (2) community/social implications, (3) economic considerations, (4) concluding opinion on whether industrialization improved growth-hormone treatment.',
  },
  q6_e: {
    marks: 2,
    exemplar: 'Consent of the donor/family may be uncertain. Some religious or cultural groups may object to using human tissue after death. Risk of transmitting diseases from donor tissue to the patient. Limited supply meant not everyone could be treated fairly.',
    keyConcepts: [
      'consent of donor or family',
      'religious or cultural objections to human tissue',
      'disease transmission from donor tissue',
      'limited supply fairness',
    ],
    keywords: ['consent', 'religious', 'ethical', 'tissue', 'disease', 'transmission', 'donor', 'fairness'],
    feedbackHit: 'Two valid ethical implications identified.',
    feedbackMiss: 'Ethical implications: consent of the donor/family; religious or cultural objections to using human tissue; risk of transmitting disease from donor tissue; limited supply raising fairness issues.',
  },
}

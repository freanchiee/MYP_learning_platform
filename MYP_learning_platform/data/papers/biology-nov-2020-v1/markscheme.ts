...
export const MS: MSRecord = {
  ...
  q1_a: {
    marks: 2,
    exemplar: 'Cactus → Locust → Lizard → Hawk. Award 1 mark for any two organisms in correct relative order; 2 marks for all four correctly sequenced.',
    keyConcepts: ['food chain', 'producer', 'consumer', 'trophic level'],
    keywords: ['food chain', 'producer', 'consumer', 'cactus', 'locust', 'lizard', 'hawk'],
    feedbackHit: 'Correct food chain — energy flows from producer to each consumer.',
    feedbackMiss: 'Start with the producer (cactus). Locust eats cactus; lizard eats locust; hawk eats lizard.',
  },
  q1_b: {
    marks: 3,
    exemplar: 'Two meerkats fighting over a burrow → Competition; Cheetah and gazelle → Predation; Tick and buffalo → Parasitism. Award 1 mark per correct answer.',
  ...
  q2_d: {
    marks: 4,
    exemplar: 'Reason: to maintain a concentration gradient (1) so oxygen continues to diffuse from the water into the blood (1). Prediction: if the water is not refreshed, it will lose its dissolved oxygen / fill with waste gas (1); the concentration gradient will be eliminated, diffusion slows or stops, and the fish cannot obtain enough oxygen, causing harm (1).',
    keyConcepts: ['gas exchange', 'concentration gradient', 'diffusion', 'oxygen uptake', 'gill'],
    keywords: ['concentration gradient', 'diffusion', 'oxygen', 'fresh water', 'gill', 'waste gas'],
    feedbackHit: 'You correctly linked continuous water flow to maintenance of the concentration gradient.',
    feedbackMiss: 'Fresh water must flow over the gills to keep it at a high oxygen concentration — this maintains the gradient needed for oxygen to diffuse into the blood.',
  },
  q2_e: {
    marks: 2,
    exemplar: 'Many thin filaments have a much greater total surface area than one solid flap (1). Greater surface area increases the rate of diffusion, allowing more efficient uptake of oxygen from the water in the same amount of time (1).',
    keyConcepts: ['surface area', 'diffusion rate', 'gas exchange', 'efficiency'],
    keywords: ['surface area', 'diffusion', 'rate', 'efficient', 'filaments', 'exchange'],
    feedbackHit: 'Correct — more surface area means faster diffusion.',
    feedbackMiss: 'Many thin filaments have more total surface area than one solid flap. More surface area = faster diffusion = more efficient oxygen uptake.',
  },
  ...
  q3_b: {
    marks: 1,
    exemplar: 'Chara cells have a cell wall (made of cellulose), chloroplasts, or a large central vacuole — any one feature not present in brine shrimp cells.',
    keyConcepts: ['plant cell', 'animal cell', 'cell wall', 'chloroplast', 'vacuole'],
    keywords: ['cell wall', 'chloroplast', 'vacuole', 'plant cell', 'Chara'],
    feedbackHit: 'Correct plant-cell-specific feature identified.',
    feedbackMiss: 'Chara is a plant: its cells have a cell wall, chloroplasts, and/or a large central vacuole — none of which are found in brine shrimp (animal) cells.',
  },
  q3_c: {
    marks: 2,
    exemplar: 'If salt concentration in the water increases, then the heart rate of the brine shrimp will increase (1), because the shrimp must work harder to regulate the water and ions in its body (osmoregulation), raising its metabolic rate and heart rate (1).',
    keyConcepts: ['hypothesis', 'salt', 'heart rate', 'osmoregulation', 'brine shrimp'],
    keywords: ['hypothesis', 'salt', 'concentration', 'heart rate', 'increase', 'osmoregulation', 'metabolic'],
    feedbackHit: 'Good hypothesis with clear prediction and scientific reasoning.',
    feedbackMiss: 'State a prediction (if salt increases → heart rate increases/decreases) and give a scientific reason (e.g. more osmoregulation → more energy needed → higher heart rate).',
  },
  q3_d: {
    marks: 4,
    exemplar: 'IV: salt concentration of the water (what is changed) (1). DV: heart rate of brine shrimp in bpm (what is measured) (1). CV: temperature of water; type/size of brine shrimp; volume of solution (any two, 1 mark each).',
    keyConcepts: ['variables', 'independent variable', 'dependent variable', 'control variable'],
    keywords: ['independent', 'dependent', 'control', 'salt concentration', 'heart rate', 'temperature'],
    feedbackHit: 'You correctly identified IV, DV and control variables.',
    feedbackMiss: 'IV = what you change (salt concentration). DV = what you measure (heart rate). CV = what you keep the same (temperature, type of shrimp, volume).',
  },
  q3_e: {
    marks: 2,
    exemplar: 'At least 4–5 different salt concentrations (1); to identify a trend or pattern across a range of values and determine whether the relationship is linear or non-linear (1).',
  ...
  q4_a: {
    marks: 3,
    exemplar: 'Multiply heartbeats in 20 s by 3 to give bpm. Award 1 mark for correct method shown; 2 marks for all calculated values correct (38 × 3 = 114 bpm; 46 × 3 = 138 bpm; 54 × 3 = 162 bpm); deduct 1 mark for an arithmetic error if the method is correct.',
    ...
    feedbackMiss: 'To convert from heartbeats/20 s to bpm: multiply by 3 (since 20 s × 3 = 60 s = 1 minute). 38 → 114, 46 → 138, 54 → 162.',
  },
  q4_b: {
    marks: 4,
    exemplar: 'Weakness 1: only one brine shrimp used per temperature (1); results may not be representative; should use multiple shrimp and calculate a mean to improve reliability (1). Weakness 2: only counting for 20 seconds (1); short count period increases counting error; count for longer (e.g. 60 seconds) to improve accuracy (1).',
    keyConcepts: ['investigation weaknesses', 'reliability', 'replication', 'accuracy'],
    keywords: ['weakness', 'one brine shrimp', 'not representative', 'counting error', '20 seconds', 'reliability', 'improve'],
    feedbackHit: 'You identified two weaknesses and justified how each affects the investigation.',
    feedbackMiss: 'A weakness needs: what is wrong + why it is a problem + how to fix it. E.g. only one shrimp → not representative → use multiple individuals.',
  },
  q4_c: {
    marks: 1,
    exemplar: 'Any valid new IV: salt/caffeine/sugar concentration; light intensity; pH of water; dissolved oxygen level.',
    keyConcepts: ['investigation extension', 'independent variable'],
    keywords: ['salt', 'caffeine', 'light', 'pH', 'concentration', 'independent variable', 'extend'],
    feedbackHit: 'Valid extension variable suggested.',
    feedbackMiss: 'Suggest a different factor that could affect brine shrimp heart rate, e.g. salt concentration, caffeine concentration, or light intensity.',
  },
  q4_d: {
    marks: 2,
  ...
  q4_e: {
    marks: 2,
    exemplar: 'The data broadly supports the prediction — heart rate increases from 114 bpm at 10 °C to 162 bpm at 30 °C (1). However, reliability is limited: only one brine shrimp measured at each temperature with no repeats, so results could be due to individual variation rather than temperature (1).',
  ...
  q4_g: {
    marks: 2,
    exemplar: 'Read the heart rate values at 10 °C and 20 °C from the line of best fit on the graph: 114 bpm at 10 °C and 138 bpm at 20 °C (award 1 mark per correctly read value within an acceptable range).',
    ...
    feedbackMiss: 'Locate 10 °C and 20 °C on the x-axis; read across to the line of best fit; read the heart rate value on the y-axis (114 bpm and 138 bpm).',
  },

  // ── Q5 ───────────────────────────────────────────────────────────────────
  q5_: {
    marks: 17,
    exemplar: 'Criteria B rubric (17 marks). Hypothesis (2): testable prediction e.g. "If electrolyte concentration increases, heart rate will increase because the electrolytes help nerve and muscle cells in the heart transmit impulses more rapidly." Variables (4): IV = electrolyte concentration (g/dm³); DV = heart rate (bpm); CV = age of participants, time of day, baseline health status, amount consumed. Method (5): measure resting heart rate; provide defined electrolyte solutions; measure heart rate at set intervals after consumption; use multiple participants. Data table (2): titled, labelled with units. Data processing (2): calculate means; state graph type. Ethics (2): informed consent; exclude participants with heart conditions; right to withdraw.',
    keyConcepts: ['Criteria B', 'electrolytes', 'heart rate', 'hypothesis', 'variables', 'method', 'ethics'],
    keywords: ['hypothesis', 'IV', 'DV', 'CV', 'electrolyte', 'heart rate', 'method', 'ethics', 'consent', 'table', 'graph'],
  ...
  q6_a: {
    marks: 2,
    exemplar: 'Line of best fit drawn smoothly through scatter points (1). Predicted heart rate at 60 mg/100 cm³ sodium read from the line of best fit (1); accept any value consistent with the drawn line (approximately 88–90 bpm).',
    keyConcepts: ['line of best fit', 'graph prediction', 'electrolytes', 'heart rate'],
    keywords: ['line of best fit', 'predict', 'heart rate', 'sodium concentration', '60 mg'],
    feedbackHit: 'Line of best fit drawn and prediction made correctly.',
    feedbackMiss: 'Draw a straight line of best fit through the scatter points. Locate 60 mg/100 cm³ on the x-axis and read the predicted heart rate from your line.',
  },
  q6_b: {
    marks: 3,
    exemplar: '% increase = (measured − predicted) / predicted × 100 (1). Substitution with correct values shown, e.g. (105 − 89) / 89 × 100 (1). Answer to 3 significant figures with the correct unit: ≈ 18.0 % (accept a value consistent with the student\'s predicted heart rate) (1).',
    keyConcepts: ['percentage increase', 'calculation', 'significant figures'],
    keywords: ['percentage increase', 'calculate', '3 significant figures', 'working', '105 bpm'],
    feedbackHit: 'Correct formula, working, and answer to 3 s.f.',
    feedbackMiss: '% increase = (105 − predicted value) / predicted value × 100. Show full working and give the answer to 3 significant figures.',
  },
  q6_c: {
    marks: 2,
    exemplar: 'ZYQORA contains other ingredients in addition to sodium (e.g. glucose/sugar, potassium) (1); the combined effect of multiple ingredients raises heart rate higher than sodium alone would predict (1).',
    keyConcepts: ['electrolytes', 'sports drink', 'sodium', 'combined effect'],
    keywords: ['other ingredients', 'glucose', 'sugar', 'potassium', 'combined', 'sports drink', 'additional'],
    ...
    feedbackMiss: 'The graph only modelled sodium concentration. ZYQORA also contains other ingredients (e.g. sugar, potassium) that also raise heart rate — so the actual rate is higher than predicted from sodium alone.',
  },

  // ── Q7 ───────────────────────────────────────────────────────────────────
  q7_a: {
    marks: 2,
    exemplar: 'Adds CO₂ to atmosphere: Respiration (1). Removes CO₂ from atmosphere: Photosynthesis (1). Phototropism, condensation, and transpiration are distractors — they do not involve CO₂ exchange.',
  ...
  q8_: {
    marks: 17,
    exemplar: 'Criteria D rubric (17 marks). Two solutions chosen (e.g. switching to renewable energy + reforestation). For each: describe the action (2); explain the science — e.g. solar/wind generate electricity without releasing CO₂; replanting forests increases carbon capture through photosynthesis (2 × 2 = 4). Advantages: both solutions described with evidence (2 × 2 = 4). Disadvantages: both solutions critiqued — e.g. renewables are intermittent and need storage; reforestation takes decades and competes for land (2 × 2 = 4). Concluding appraisal: reasoned personal judgement on the best solution with justification (3).',
    keyConcepts: ['Criteria D', 'climate change solutions', 'renewable energy', 'carbon capture', 'reforestation', 'public transport', 'evaluate', 'appraisal'],
    keywords: ['climate change', 'solution', 'advantage', 'disadvantage', 'science', 'renewable', 'carbon capture', 'reforestation', 'transport', 'appraisal', 'justify'],

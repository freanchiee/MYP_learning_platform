...
export const MS: MSRecord = {
  ...
  // Q1 — Knee joint, muscles & respiration

  q1_a: {
    marks: 1,
    exemplar: 'Elbow. (Accept ankle or knuckle.)',
    keyConcepts: ['hinge joint skeleton movement bones cartilage'],
    keywords: ['hinge joint', 'elbow', 'ankle', 'knuckle'],
    feedbackHit: 'Correct hinge joint identified.',
    feedbackMiss: 'Hinge joints move in one plane: elbow, ankle, and knuckle are all valid examples.',
  },
  ...
  q1_c: {
    marks: 2,
    exemplar: 'Accept any two from: one muscle contracts while the other extends [1]; X (Quadriceps) contracts or shortens AND to extend or straighten the lower leg [1]; Y (Hamstrings) contracts or shortens AND to flex or bend the lower leg [1].',
    keyConcepts: ['antagonistic muscles quadriceps hamstrings contract extend movement joint'],
    keywords: ['contracts', 'extends', 'quadriceps', 'hamstrings', 'flex', 'bend', 'straighten', 'antagonistic'],
    feedbackHit: 'Both antagonistic muscle roles correctly described.',
    feedbackMiss: 'Quadriceps contracts to straighten the leg; hamstrings contracts to bend it. They work as an antagonistic pair — when one contracts the other extends.',
  },
  ...
  // Q2 — Modified-atmosphere packaging & food storage

  q2_a: {
    marks: 2,
    exemplar: 'Accept any two reasonable benefits: slows spoilage or ripening [1]; prevents microbe growth OR keeps food safe to eat for longer [1]; reduces waste OR extends shelf life [1]. (WTTE)',
    keyConcepts: ['modified atmosphere packaging food preservation spoilage microbes shelf life transport'],
    keywords: ['slows spoilage', 'prevents microbe growth', 'extends shelf life', 'reduces waste', 'food safe'],
    feedbackHit: 'Two valid benefits of modified-atmosphere packaging identified.',
    feedbackMiss: 'Modified-atmosphere packaging: slows spoilage (absorbs CO₂), prevents microbial growth, extends shelf life, reduces food waste.',
  },
  ...
  q2_c: {
    ...
    feedbackMiss: 'Salt on the cod creates a high solute concentration outside the bacteria. By osmosis, water moves out of the bacteria → they dehydrate and shrink, losing their smooth surface.',
  },

  // Q3 — Enzymes, sucrase & genetics
  ...
  q3_b: {
    marks: 1,
    exemplar: 'SS = Yes; Ss = Yes; ss = No. All correct = 1 mark. (A selection must be made in ALL boxes.)',
    keyConcepts: ['genotype phenotype dominant recessive allele sucrase production SS Ss ss'],
    keywords: ['SS', 'Ss', 'ss', 'dominant', 'recessive', 'sucrase', 'Yes', 'No'],
    feedbackHit: 'All three genotype-phenotype relationships correctly identified.',
    feedbackMiss: 'S is dominant: SS (homozygous dominant) = produces sucrase; Ss (heterozygous) = produces sucrase (S present); ss (homozygous recessive) = does not.',
  ...
  q3_d: {
    marks: 4,
    exemplar: 'Similarity [max 1]: highest levels directly after weaning; both decrease (after weaning). Justification [max 1]: milk/sucrose-rich diet is the primary food source early on; decrease as they transition to other food sources. Difference [max 1]: production is much higher in calves; calves level off later than goat kids; production decreases at a faster rate or earlier in goat kids. Justification [max 1]: calves consume more sucrose OR calves are bigger than goat kids; goat kids transition to other foods earlier than calves; calves and goat kids mature at different rates.',
    keyConcepts: ['sucrase production calves goat kids comparison similarity difference graph analysis justification'],
    keywords: ['highest at weaning', 'both decrease', 'calves higher', 'calves level off later', 'milk diet', 'transition to food'],
    feedbackHit: 'Similarity + justification + difference + justification all correctly identified.',
    feedbackMiss: 'Similarity: both start high and decrease. Difference: sucrase is much higher in calves and stays elevated longer (calves are larger/take longer to wean). Justify each with scientific reasoning.',
  },

  q3_e: {
    marks: 1,
    exemplar: 'The higher the % of adults producing sucrase, the higher the mean sugar-rich plant intake. (ORA. Do NOT accept linear or proportional.)',
    keyConcepts: ['sucrase production sugar intake correlation population data infographic'],
    keywords: ['higher sucrase', 'higher intake', 'positive relationship', 'correlation'],
    feedbackHit: 'Correct directional relationship stated.',
    feedbackMiss: 'Populations with a higher % of adults producing sucrase tend to have higher mean sugar-rich plant intake (positive correlation).',
  },

  q3_f: {
    marks: 1,
    exemplar: 'Accept any reasonable suggestion: data not available for all populations; correlation does not guarantee causation; people eat sugar-rich plants for reasons other than sucrase production; data is from one year or one source only.',
  ...
  // Q4 — Hemp Fibre Humidity Investigation
  ...
  q4_a: {
    ...
    keyConcepts: ['research question humidity hemp plant fibre strength investigation formulate'],
    ...
    feedbackMiss: 'Research question must state BOTH the IV (humidity) and DV (mass/force needed to break fibre), e.g. "How does humidity affect the mass needed to break hemp fibre?"',
  },
  ...
  q4_h: {
    ...
    feedbackMiss: 'Claim 1 (different strengths): natural variation in hemp fibres (fibres from different plants vary). Claim 2 (different masses): less precise measuring equipment produced less valid/accurate results.',
  },

  // Q5 — Hemp Cell Diameter & Water Movement

  q5_a: {
    marks: 1,
    exemplar: '96 (micrometres) ± 5. (Ignore incorrect units.)',
    keyConcepts: ['measuring cell diameter microscope scale bar micrometer humidity'],
    keywords: ['96', 'micrometres', 'diameter', 'cell', 'scale bar', 'measure'],
    feedbackHit: 'Cell diameter correctly measured from scale bar.',
    feedbackMiss: 'Use the 80 µm scale bar to calibrate. The highlighted cell at 75% humidity measures approximately 96 µm in diameter (± 5 µm accepted).',
  },

  q5_b: {
    marks: 3,
    exemplar: '(Candidate\'s value from (a) − 80) ÷ 80 × 100 [1]. Evidence of calculation [1]. Rounded to nearest % [1]. (ECF from part (a). Award third mark for any correctly rounded percentage if calculation is seen.) Using 96: (96 − 80) ÷ 80 × 100 = 20%.',
    ...
    feedbackMiss: '% increase = (new − original) ÷ original × 100 = (96 − 80) ÷ 80 × 100 = 20%. Show working.',
  },
  ...
  q6_a: {
    marks: 1,
    exemplar: 'Accept any CV from: volume of NaOH (50 cm³); fibres immersed in same chemical or NaOH; initial fibre length (30 cm) or diameter; type of fibre (hemp).',
    ...
    feedbackMiss: 'The flow chart shows CVs such as: volume of NaOH used (50 cm³), initial fibre length (30 cm)/diameter, type of plant fibre (hemp). All fibres are treated the same to control these.',
  },
  ...
  q6_c: {
    marks: 3,
    exemplar: 'Accept any three points: identify the alkali (as NaOH) [1]; include a reference to the direction of change of IV [1]; include a possible range of IV concentrations [1]; specify fibres are hemp [1]; specify what will be measured [1]. (Accept aspects of a re-written hypothesis. Do NOT accept "include adding scientific justification as an improvement.")',
    keyConcepts: ['hypothesis testable IV direction range NaOH concentration alkali hemp fibre measurement'],
    keywords: ['NaOH', 'concentration increases', 'range', 'hemp', 'extension', 'measured', 'testable'],
    feedbackHit: 'Three elements to improve hypothesis correctly identified.',
    feedbackMiss: 'Improve hypothesis by: naming NaOH as the alkali; specifying direction (as concentration increases); including a range (e.g. 0–10%); specifying it is hemp fibre; stating what is measured (extension in mm).',
  },
  ...
  // Q7 — Criteria B: Hemp Fibre % in Yarn Design

  q7_: {
    marks: 15,
    exemplar: 'Criteria B rubric (max 15). RQ [max 2]: simple RQ → RQ linked to % hemp fibre and length/stretch. Variables [max 4]: IV as fibre % and DV as length + one CV → IV and DV + two CVs. Equipment [assessed in Method]. Method [max 4]: attempt at method → incomplete but some relevant data → sufficient to follow and collect similar data → sufficient to repeat. Data [max 4]: plans at least 3 trials → plans 3 trials AND 5 stated fibre % → also includes 0% and 20% → 5+ fibre %. Safety [max 1]: care with heavy masses, yarn snapping under tension.',
    keyConcepts: ['hemp fibre yarn stretch design investigation Criteria B RQ IV DV CVs method data safety'],
    keywords: ['% hemp fibres', 'IV', 'DV', 'extension/stretch', 'CVs', 'repeats', '5 fibre levels', '0%', '20%', 'safety'],
    ...
    feedbackMiss: 'Key elements: RQ linking % hemp fibres to stretch/extension; IV = % hemp fibres; DV = extension/length at fixed mass; 2 CVs (e.g. mass, yarn diameter); ≥5 fibre % values including 0% and 20%; ≥3 repeats; safety (heavy masses, yarn snapping).',
  },
  ...
  q8_b: {
    marks: 4,
    exemplar: 'Fewer hoverflies will mean there is less pollination of the flowers [1]. This may reduce the population of plants [1]. (Which will) result in less food being available (for consumers) [1]. Link to how biodiversity is reduced [1]. (Accept references to plant reproduction.)',
    keyConcepts: ['pollinators hoverflies pollination biodiversity food web plants flowers consumers'],
    keywords: ['fewer hoverflies', 'less pollination', 'plant population reduces', 'less food', 'biodiversity reduced'],
    feedbackHit: 'Complete causal chain from pollinator loss to biodiversity reduction.',
    feedbackMiss: 'Fewer hoverflies → less pollination → fewer plants reproduce → plant population falls → less food for consumers → animals affected → biodiversity reduced.',
  },
  ...
  // Q9 — Vertical Biosolar Technology (Criteria D)

  q9_: {
    marks: 13,
    exemplar: 'Criteria D rubric (max 13). Environmental [max 4]: one aspect → one green wall OR solar panel + one other → both with further justification → both aspects with further justification for both. Economic [max 4]: same progression. Vertical biosolar additional benefits [max 2]: one benefit (solar panels work more efficiently when cooled by plants / more efficient use of vertical space on a building) → with further development. Location factor [max 2]: one reasonable factor (e.g. wall facing the sun, wall strength, access to water) → with justification. Conclusion [max 1]: a concluding statement.',
    keyConcepts: ['vertical biosolar technology green walls solar panels environmental economic sustainability urban biodiversity'],
    keywords: ['green wall', 'solar panels', 'environmental', 'economic', 'biosolar', 'location', 'cooling', 'biodiversity', 'conclusion'],
    ...
    feedbackMiss: 'Environmental: green walls (biodiversity, cooling, air quality, insulation, mental health); solar panels (renewable energy, reduce fossil fuels). Economic: installation cost vs energy savings. Biosolar: solar works better when cooled by plants; combined use of vertical space. Location: consider wall orientation/sunlight, wall strength, water access. Conclude on overall impact.',
  },
}

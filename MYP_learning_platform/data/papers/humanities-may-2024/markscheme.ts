...
/**
 * MYP Integrated Humanities — May 2024 mark scheme (rubric-banded).
 *
...
export const MS: MSRecord = {
  q1_: {
    marks: 1,
    exemplar: 'Business owners.',
    keyConcepts: ['industrialization', 'stakeholders', 'economic systems'],
    keywords: ['investors', 'business owners', 'traders', 'government policy makers', 'workers', 'labour unions', 'citizens', 'countries'],
    feedbackHit: 'You correctly named one valid stakeholder (e.g. business owners, investors, workers, traders, governments, countries) that benefitted from industrialization.',
    feedbackMiss: 'State a specific stakeholder group or named individual/country that gained from industrialization, e.g. business owners or investors.',
  ...
  q2_: {
    marks: 2,
    exemplar: 'Availability of natural resources to help run the factories.',
    keyConcepts: ['industrialization', 'causation', 'resources'],
    keywords: ['availability of resources', 'natural resources', 'factories', 'cause'],
    ...
    rubricBands: [
      ...
      { marks: '1', descriptor: 'The student states one reason why industrialization occurred. A (1 mark) response is likely to be one sentence that hints at a single reason.', exemplar: 'Availability of resources.' },
      { marks: '2', descriptor: 'The student outlines one reason why industrialization occurred. A (2 mark) response is likely to be a single sentence with a single reason that is elaborated on; the detail provided will be brief.', exemplar: 'Availability of natural resources to help run the factories.' },
    ],
  },
  ...
  q3_: {
    marks: 3,
    exemplar:
      'More people lived in overcrowded cities and worked in machine-powered factories. They had fixed working hours and regular wages. Industrialization triggered rapid rural-to-urban migration, leading to the rapid growth of cities where workers faced the challenge of new ways of living.',
    keyConcepts: ['industrialization', 'social change', 'urbanization', 'migration'],
    keywords: ['overcrowded cities', 'factories', 'rural-to-urban migration', 'fixed working hours', 'wages', 'growth of cities', 'new ways of living'],
    ...
    rubricBands: [
      { marks: '0', descriptor: 'The student does not reach a standard described by any of the descriptors below.' },
      { marks: '1', descriptor: 'The student states how society changed after industrialization. A (1 mark) response is likely to be one sentence that hints at a single change.', exemplar: 'More people lived in cities. / Industrialization triggered rural-to-urban migration.' },
      { marks: '2', descriptor: 'The student outlines how society changed after industrialization. A (2 mark) response is likely to be a single sentence with a way society changed that is elaborated on; the detail provided will be brief.', exemplar: 'More people lived in cities and worked in factories. / Industrialization triggered rural-to-urban migration and led to a rapid growth of cities.' },
      { marks: '3', descriptor: 'The student describes how society changed after industrialization. How society changed should be considered in detail. An example may be used to support the description. More important than the length of the response is the quality and depth provided.', exemplar: '1. More people lived in overcrowded cities and worked in machine-powered factories. They had fixed working hours and regular wages. 2. Industrialization triggered rural-to-urban migration and led to a rapid growth of cities where workers faced the challenge of new ways of living.' },
    ],
  },
  ...
  q4_: {
    marks: 8,
    exemplar:
      'STRENGTH: The investigation includes primary and secondary sources, such as interviews with the local farmers. This provides a first-hand account of how smartphones changed the farmers’ lives because cell phones help with the work they need to do every day, which strengthens the validity of the findings. LIMITATION: They did not consult a broad enough range of sources and mostly relied on the interview with the farmers. Looking at a broader range of sources would have improved the reliability of the team’s findings because they would be better informed about how cell phone usage has impacted on the livelihood of Indian farmers. APPRAISAL: Overall the investigation is good as it has some strengths — it conducts interviews with local farmers — however, they need to expand the number of sources to improve the investigation. On balance the process was effective but could be made more reliable.',
    ...
    rubricBands: [
      ...
      { marks: 'Limitations 2', descriptor: 'The student outlines the limitation(s) of the investigation. Only one limitation needs to be mentioned and elaborated on. A 2-mark response is likely to be a single sentence with two clauses or two/three short sentences. (If a student outlines 3 or more limitations they can be awarded 3 marks.)', exemplar: 'They did not consult a broad enough range of sources and mostly relied on the interview with the farmers.' },
      { marks: 'Limitations 3', descriptor: 'The student explains the limitation(s) of the investigation, elaborated on in additional detail with reasoning. (If a student outlines 3 or more limitations they can be awarded 3 marks.)', exemplar: 'They did not consult a broad enough range of sources and mostly relied on the interview with the farmers. Looking at a broader range of sources would have improved the reliability of the team’s findings because they would be better informed about how cell phone usage has impacted on the livelihood of Indian farmers.' },
  ...
  q5_a: {
    marks: 2,
    exemplar: 'To what extent have textile industries improved the social status of women in Bangladesh?',
    ...
    feedbackHit: 'Your research question is both clear and focused — it connects to industrialization AND narrows to a specific group (e.g. women) or place (e.g. Bangladesh).',
  ...
  q5_b: {
    marks: 4,
    exemplar:
      'Bangladesh is a developing country with lots of textile factories that provide jobs for many people, particularly women. Studying the differences in social status over the period of industrialization will reveal the extent to which their economic independence and social empowerment improved their social status. This makes the question worthy of investigation because it connects an economic change to a measurable social outcome.',
    keyConcepts: ['justification', 'significance of research', 'industrialization', 'social change'],
    keywords: ['worthy of investigation', 'developing country', 'textile factories', 'social status', 'economic independence', 'social empowerment', 'reasoning'],
    ...
    rubricBands: [
      ...
      { marks: '1', descriptor: 'The student states why the research question is worthy of investigation. No detail is required/brief — likely a single sentence making a simple statement of why the RQ is worthy. Responses may apply to any research (e.g. “My question identifies a change relating to industrialization”).', exemplar: 'Bangladesh is a country with lots of textile factories.' },
      { marks: '2', descriptor: 'The student outlines why the research question is worthy of investigation. Likely a single sentence with two clauses or two/three short sentences providing brief detail. Responses may include general or vague information (nothing specific) that repeats the content of the question without adding new specific details.', exemplar: 'Bangladesh is a country with lots of textile factories that provide jobs for many people.' },
      { marks: '3', descriptor: 'The student describes why the research question is worthy of investigation. At least one specific argument/factor should be considered in detail without providing reasoning why the RQ is worthy. More important than length is the quality and depth provided. Responses include new information that derives from the question.', exemplar: 'Bangladesh is a developing country with lots of textile factories that provide jobs for many people, particularly women and improved their social status.' },
      { marks: '4', descriptor: 'The student justifies why the research question is worthy of investigation. At least one specific argument/factor should be considered in detail, along with reasoning why the RQ is worthy. More important than length is the quality and depth provided. Responses include a comprehensive reason that builds on the details of the description.', exemplar: 'Bangladesh is a developing country with lots of textile factories that provide jobs for many people, particularly women. Studying the differences in social status over the period of industrialization will reveal the extent to which their economic independence and social empowerment improved their social status.' },
    ],
  },

  q5_c: {
    marks: 1,
    exemplar: 'Conducting interviews with an expert on the topic (relevant to my research question on textile industries and women in Bangladesh).',
    ...
    feedbackMiss: 'Name a primary source AND tie it to your investigation. A bare word like “survey” scores 0 — specify, e.g. “a survey of textile workers in Bangladesh”.',
    commandTerm: 'State',
  ...
  q5_d: {
    marks: 1,
    exemplar: 'Published articles on the social impact of textile industries in Bangladesh (relevant to my research question/SoI).',
  ...
  q5_e: {
    marks: 2,
    exemplar: '1. Women who are working in the textile industries in Bangladesh. 2. An officer from the government’s human resource department.',
    keyConcepts: ['interviews', 'stakeholders', 'research planning'],
    keywords: ['factory owners', 'labourers', 'employees', 'government officer', 'history professor', 'women workers', 'specific people'],
    feedbackHit: 'You identified two specific, relevant people to interview (e.g. factory workers/women in industry, a government officer) who would broaden your investigation.',
    feedbackMiss: 'Name two SPECIFIC people relevant to your investigation. Generic words like “stakeholders” score 0 — be precise, e.g. “women textile workers” and “a factory owner”.',
    commandTerm: 'Identify',
    commandTermDefinition: 'Provide an answer from a number of possibilities. Recognize and state briefly a distinguishing fact or feature.',
    rubricBands: [
      { marks: '2', descriptor: 'Identifies two people who could be interviewed to broaden the investigation. Award 1 mark per valid response up to a maximum of 2 marks. Responses may include: Officers of government’s human resource department; Relevant stakeholders such as factory owners, farmers, labourers, employees; History professor; Women who are working in industries in Bangladesh. Note: stating only “stakeholders” (not specific to the investigation) should be awarded 0 marks. Accept any valid response that relates to the student’s investigation.' },
    ],
  },

  q5_f: {
    marks: 2,
    exemplar: 'From the women textile workers I would gather whether women make more money and if that increased income really improved their social status within their households and community.',
    keyConcepts: ['data collection', 'interviews', 'research planning'],
    keywords: ['information gathered', 'make more money', 'social status', 'elaborated detail'],
    ...
    rubricBands: [
      { marks: '0', descriptor: 'The student does not reach a standard described by any of the descriptors below.' },
      { marks: '1', descriptor: 'The student states the information they would gather. A 1-mark response is likely to be one sentence that hints at a single piece of information.', exemplar: 'Whether women make more money.' },
      { marks: '2', descriptor: 'The student outlines the information they would gather. A 2-mark response is likely to be a single piece of information that is elaborated on; the detail provided will be brief.', exemplar: 'Whether women make more money and if that really improved their social status.' },
    ],
  },
  ...
  q6_: {
    marks: 18,
    exemplar:
      'Did you know that right now, hospitals, restaurants and trucking companies across our country can’t find enough workers? Governments, this one’s for you — you hold the power to fix the labour shortage. Our first main point is that the government must pass laws to provide workers with better salaries. The need for better compensation has spread to almost all industries, for example healthcare, food services, and transport industries because of the increased cost of living and healthcare that is pushing workers to look for higher wages. To respond to this, the government could provide subsidies to businesses to help with this increase in cost. Secondly, we propose that the government facilitate how and when work gets done by changing certain laws or rules or by providing incentives to businesses that prioritize it, because employees now want more flexibility in jobs and location. However, most businesses are still insisting on remote working, making it harder to attract good candidates or retain current employees. So, governments — act now: fund fair wages and back flexible work, and together we can end this shortage.',
    keyConcepts: ['economic agents', 'labour shortage', 'persuasion', 'script writing', 'explanation'],
    keywords: ['economic agent', 'government', 'labour shortage', 'two ways', 'subsidies', 'incentives', 'wages', 'flexible work', 'hook', 'call to action', 'introduction', 'conclusion', 'rhetorical question', 'emotive vocabulary'],
    feedbackHit: 'Strong script: you explained (with reasoning and examples) two ways your chosen economic agent could help with labour shortage [Crit A], included an introduction and conclusion [C1], wrote in a convincing script style with a hook and call to action [C2], and structured ideas so they flow seamlessly [C3].',
    ...
    rubricBands: [
      ...
      { marks: 'CritA 1', descriptor: 'The student demonstrates limited knowledge and understanding by outlining to one economic agent one way in which they could help with labour shortage for a country, using limited examples and limited relevant terminology. Responses are likely to be brief, with little detail. There is a requirement to include an example but the lack of one does not mean the student cannot be awarded 1 mark. Terminology may be limited in terms of accuracy and/or frequency.', exemplar: 'The government must pass laws to provide workers with better salaries. The need for better compensation has spread to almost all industries.' },
      { marks: 'CritA 2–3', descriptor: 'The student demonstrates adequate knowledge and understanding by describing to one economic agent two ways in which they could help with labour shortage for a country, using satisfactory examples and appropriate relevant terminology. (If the student only provides one way, the maximum is 3 marks.) There is likely little or no reasoning; terminology used should be accurately used in the correct context.', exemplar: 'Our first main point is that the government must pass laws to provide workers with better salaries. The need for better compensation has spread to almost all industries, for example healthcare, food services, and transport industries. To respond to this, the government could provide subsidies to businesses. Secondly, we propose that the government facilitate how and when work gets done.' },
      { marks: 'CritA 4–5', descriptor: 'The student demonstrates substantial knowledge and understanding by explaining to one economic agent two ways in which they could help with labour shortage for a country, using accurate examples and appropriate relevant terminology. Students need to demonstrate good understanding by providing a detailed response to the question, calling on appropriate example(s) that support their point(s). Terminology used accurately and effectively in the correct context.', exemplar: '…The need for better compensation has spread to almost all industries, for example healthcare, food services, and transport industries because of the increased cost of living and healthcare. To respond to this, the government could provide subsidies to businesses. Secondly, we propose that the government facilitate how and when work gets done by providing incentives to businesses that prioritize it.' },
      { marks: 'CritA 6', descriptor: 'The student demonstrates detailed knowledge and understanding by thoroughly explaining to one economic agent two ways in which they could help with labour shortage for a country, using accurate and effective descriptions and explanations, and appropriate relevant terminology. The response should be very detailed and provide clear reasoning, making use of example(s); comprehensive understanding of how one economic agent could help should be included. (An excellent response need not be perfect; different responses may earn the same mark.)', exemplar: '…for example healthcare, food services, and transport industries because of the increased cost of living and healthcare that is pushing workers to look for higher wages. To respond to this, the government could provide subsidies to businesses to help with this increase in cost. Secondly, we propose that the government facilitate how and when work gets done by changing certain laws or rules or by providing incentives to businesses that prioritize it because employees now want more flexibility in jobs and location. However, most businesses are still insisting on remote working, making it harder to attract good candidates or retain current employees.' },
  ...
  q7_a: {
    marks: 1,
    exemplar: 'The Lyon Town Planning Council (the Lyon Council website).',
    keyConcepts: ['origin of sources', 'source analysis'],
    keywords: ['Lyon Town Planning Council', 'Lyon Council website', 'Lyon'],
    feedbackHit: 'You correctly stated the origin — the Lyon Town Planning Council / Lyon Council website.',
    feedbackMiss: 'State where the source comes from: it is the website of the Lyon Town Planning Council.',
    commandTerm: 'State',
    commandTermDefinition: 'Give a specific name, value or other brief answer without explanation or calculation.',
    rubricBands: [
      { marks: '1', descriptor: 'States the origin of Source A. Responses may include: Lyon Town Planning Council; Lyon Council website; the Lyon Council website URL; Lyon. Accept any valid response.' },
    ],
  },

  q7_b: {
    marks: 1,
    exemplar: 'To inform the residents of Lyon about the redevelopment of the city.',
    keyConcepts: ['purpose of sources', 'source analysis'],
    keywords: ['inform residents', 'redevelopment', 'preserving heritage', 'raise awareness', 'combine history and culture'],
    feedbackHit: 'You stated a valid purpose, e.g. to inform residents about the redevelopment / raise awareness of preserving cultural and natural heritage.',
    feedbackMiss: 'State why the source was made: e.g. to inform Lyon’s residents about the city’s redevelopment or to raise awareness of preserving cultural and natural heritage.',
    commandTerm: 'State',
    commandTermDefinition: 'Give a specific name, value or other brief answer without explanation or calculation.',
    rubricBands: [
      { marks: '1', descriptor: 'States the purpose of Source A. Responses may include: to inform the residents of Lyon about the redevelopment of the city; to inform people about the value of preserving cultural and natural heritage; to raise awareness about cultural and natural environments; to show how history and culture can be combined with modern life. Accept any valid response.' },
    ],
  },

  q7_c: {
    marks: 3,
    exemplar: 'It shows different ways that Lyon has managed its urban environment focusing on maintaining cultural and natural aspects of the city, such as preserving forests and providing water-based recreational activities, which gives an MYP student a concrete real-world example of sustainable urban management to study.',
    keyConcepts: ['value of sources', 'source analysis', 'sustainable management', 'urban environments'],
    keywords: ['value', 'manages urban environment', 'cultural and natural aspects', 'forests', 'water-based recreation', 'detailed account'],
    feedbackHit: 'You described one value in detail — e.g. the source shows real ways Lyon managed its urban environment (cultural and natural aspects such as forests and water-based recreation), useful for a student of sustainable urban management.',
    feedbackMiss: 'Develop ONE value into a detailed account. Don’t stop at a generic statement — add specific detail (e.g. how it shows cultural AND natural management like forests/water recreation) to reach 3 marks.',
    commandTerm: 'Describe',
    commandTermDefinition: 'Give a detailed account or picture of a situation, event, pattern or process.',
    rubricBands: [
      { marks: '0', descriptor: 'The student does not achieve a standard described by any of the descriptors given below.' },
      { marks: '1', descriptor: 'States one value of Source A for an MYP student studying sustainable management of urban environments. For 1 mark, the response might be general or generic.', exemplar: 'It shows different ways that Lyon has managed its urban environment.' },
      { marks: '2', descriptor: 'Outlines one value of Source A for an MYP student studying sustainable management of urban environments. To award 2 marks, the student must provide some brief detail.', exemplar: 'It shows different ways that Lyon has managed its urban environment focusing on cultural and natural aspects of the city.' },
      { marks: '3', descriptor: 'Describes one value of Source A for an MYP student studying sustainable management of urban environments. To award 3 marks, the student must give a detailed account. (Note: the value can relate to sustainable management in general and not only to the city of Lyon.)', exemplar: 'It shows different ways that Lyon has managed its urban environment focusing on maintaining cultural and natural aspects of the city, such as forests and water-based recreational activities.' },
    ],
  },

  q7_d: {
    marks: 3,
    exemplar: 'It doesn’t show if the plan was successful, for example we don’t know the reactions of the local residents or if their lives were improved after the implementation of the plan, which limits its usefulness for a student trying to evaluate whether the redevelopment achieved sustainable management.',
    ...
    feedbackMiss: 'Develop ONE limitation into a detailed account. Move beyond a generic statement by adding specific detail (e.g. it omits residents’ reactions or whether their lives improved) to reach 3 marks.',
    commandTerm: 'Describe',
    commandTermDefinition: 'Give a detailed account or picture of a situation, event, pattern or process.',
    rubricBands: [
      { marks: '0', descriptor: 'The student does not achieve a standard described by any of the descriptors given below.' },
      ...
      { marks: '3', descriptor: 'Describes one limitation of Source A for an MYP student studying sustainable management of urban environments. To award 3 marks, the student must give a detailed account. (Note: the limitation can relate to sustainable management in general and not only to the city of Lyon.)', exemplar: 'It doesn’t show if the plan was successful, for example we don’t know the reactions of the local residents or if their lives were improved after the implementation of the plan.' },
    ],
  },

  q8_: {
    marks: 4,
    exemplar: 'The reuse of historic buildings for things such as luxury hotels provides the opportunity to attract visitors and create revenue for the city. This could be used to regenerate other historic buildings and areas, which could attract more visitors and increase economic development further.',
    keyConcepts: ['economic development', 'urban redevelopment', 'tourism revenue', 'explanation'],
    keywords: ['reuse of historic buildings', 'luxury hotels', 'attract visitors', 'revenue', 'regenerate', 'economic development', 'reasons'],
    feedbackHit: 'You explained one method in a detailed account WITH reasons/causes — e.g. reusing historic buildings as hotels attracts visitors, creates revenue, and funds further regeneration that drives more economic development.',
    ...
    rubricBands: [
      { marks: '0', descriptor: 'The student does not achieve a standard described by any of the descriptors given below.' },
      { marks: '1', descriptor: 'The student states how one of the four ways the Town Planning Council of Lyon used contributed to the economic development of the city. For 1 mark, the response might be general or generic.', exemplar: 'The reuse of historic buildings provides the opportunity to attract visitors.' },
      { marks: '2', descriptor: 'The student outlines one of the four ways the Town Planning Council of Lyon used contributed to the economic development of the city. To award 2 marks, the student must provide some brief detail.', exemplar: 'The reuse of historic buildings for things such as luxury hotels provides the opportunity to attract visitors.' },
      { marks: '3', descriptor: 'The student describes one of the four ways the Town Planning Council of Lyon used contributed to the economic development of the city. To award 3 marks, the student must give a detailed account.', exemplar: 'The reuse of historic buildings for things such as luxury hotels provides the opportunity to attract visitors and create revenue for the city.' },
      { marks: '4', descriptor: 'The student explains how one of the four ways the Town Planning Council of Lyon used contributed to the economic development of the city. To award 4 marks, the student must give a detailed account including reason(s) or cause(s).', exemplar: 'The reuse of historic buildings for things such as luxury hotels provides the opportunity to attract visitors and create revenue for the city. This could be used to regenerate other historic buildings and areas, which could attract more visitors and increase economic development further.' },
    ],
  },

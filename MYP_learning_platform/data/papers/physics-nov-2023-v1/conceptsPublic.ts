/**
 * CLIENT-SAFE concept data for Physics November 2023 — Variant 1.
...
export const CONCEPTS_PUBLIC_NOV2023_V1: Record<string, ConceptEntry> = {
  // Q1 — Astronomy & units
  q1_c: {
  ...
  // Q2 — Iodine-131 half-life
  q2_a: {
    keyConcepts: ['protons = atomic number', '53 protons', '78 neutrons', 'mass − atomic number'],
    keywords: ['53', '78', 'protons', 'neutrons', 'atomic number', 'mass number', 'subtract'],
  },
  q2_c: {
    keyConcepts: ['half life', '8 days', 'time for 50 percent'],
    keywords: ['8', 'half', '50%', 'days', 'graph'],
  },
  q2_d: {
    keyConcepts: ['25 percent', 'two half-lives', '16 days'],
    keywords: ['25%', '16', '2 half-lives', 'days'],
  },
  q2_e: {
    keyConcepts: ['half-life too short', 'undetectable after weeks', 'cannot date thousands of years'],
    keywords: ['incorrect', 'too short', '8 days', 'undetectable', 'cannot', 'carbon-14'],
  },
  ...
  q3_c: {
    keyConcepts: ['P = IV', '0.48 watts', 'power formula'],
    keywords: ['p=iv', '0.48', 'watts', '12', '0.04', 'power'],
  },
  q3_d: {
    keyConcepts: ['efficiency formula', '5 percent halogen', '42 percent LED', 'LED more efficient'],
    keywords: ['efficiency', '5%', '42%', 'more efficient', 'useful', 'output/input'],
  },
  ...
  q5_e: {
    keyConcepts: ['e squared', '0.36', '36 percent remains', '64 percent converted'],
    keywords: ['e squared', '0.36', '36%', '64%', 'incorrect', 'KE', 'v squared'],
  },

  // Q6 — Golf-ball coating investigation
  q6_a: {
    keyConcepts: ['IV cover thickness', 'DV bounce height', 'control variable justified', 'hypothesis', 'method', 'repeats'],
    keywords: ['cover', 'thickness', 'bounce', 'ruler', 'control', 'drop height', 'repeat', 'average', 'hypothesis'],
  },
  q6_b: {
  ...
  q7_a: {
    keyConcepts: ['insulation reduces conduction', 'airtight reduces convection', 'earth covering', 'less energy needed'],
    keywords: ['insulation', 'conduction', 'convection', 'airtight', 'earth', 'heat loss', 'less energy'],
  },
  q7_c: {

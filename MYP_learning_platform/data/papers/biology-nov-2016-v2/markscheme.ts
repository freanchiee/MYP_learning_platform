...
export const MS: MSRecord = {
  ...
  q1_b: {
    marks: 6,
    exemplar: 'Cell 1 (Elodea leaf): plant cell — cell wall, chloroplasts and large central vacuole. Cell 2 (grass leaf): plant cell — cell wall, chloroplasts and large central vacuole. Cell 3 (human nerve): animal cell — absence of cell wall/absence of chloroplast/presence of lysosomes. (2 marks per cell: 1 for identification, 1 for justification by structure.)',
  ...
  q2_b: {
    marks: 5,
    exemplar: 'Any five in order: O₂ diffuses across alveolus membrane → into capillary → binds haemoglobin/red blood cell → transported to heart via pulmonary vein → through left atrium/ventricle → leaves via aorta → through hepatic artery → through capillaries → diffuses into liver cell. (3 max for five points in incorrect order; ignore "vein" without "pulmonary".)',
    keyConcepts: ['oxygen transport lungs to liver alveolus haemoglobin heart aorta capillary diffusion'],
    keywords: ['alveolus', 'diffusion', 'haemoglobin', 'red blood cell', 'pulmonary vein', 'heart', 'aorta', 'hepatic artery', 'capillary', 'liver cell'],
    feedbackHit: 'Accurate route using correct anatomical terms.',
    feedbackMiss: 'Include the pathway: alveolus → capillary → red blood cell/haemoglobin → heart → aorta → hepatic artery → capillaries → liver cell.',
  },

  // ── Q3: Tilapa Fish Gill Disease ───────────────────────────────────────────
  q3_a: {
    marks: 1,
    exemplar: '0.24 cm³ h⁻¹ (accept 0.23–0.25; ignore incorrect units).',
    keyConcepts: ['read graph oxygen uptake healthy fish gill disease'],
    keywords: ['0.24', 'cm³', 'h⁻¹', 'oxygen uptake', 'healthy fish'],
    feedbackHit: 'Correct value read from graph.',
    feedbackMiss: 'Read the y-intercept (0% gill affected) from the graph — approximately 0.24 cm³ h⁻¹.',
  },
  q3_b: {
    marks: 1,
  ...
  // ── Q4: Rower Fitness & Oxygen Consumption ────────────────────────────────
  q4_a: {
    marks: 2,
    exemplar: 'Any two: duration of rowing; time of day; age; body mass; type of rowing machine. (2nd mark awarded if justification is correct even if variable incorrectly identified.)',
    ...
    feedbackMiss: 'Control variables keep conditions fair — e.g. same age, same time of day, same rowing machine.',
  },
  q4_b: {
    marks: 2,
  ...
  // ── Q5: GM Wheat Investigation ─────────────────────────────────────────────
  q5_a: {
    marks: 1,
    exemplar: 'Use of pesticide (with pesticide vs without pesticide).',
    keyConcepts: ['second independent variable pesticide GM wheat investigation'],
    keywords: ['pesticide', 'independent variable', 'with pesticide', 'without pesticide'],
    feedbackHit: 'Correctly identified use of pesticide as the second IV.',
    feedbackMiss: 'The second variable being changed is the use of pesticide (GM grown without, traditional grown with).',
  },
  q5_b: { type: 'mcq', correct: 2 },
  q5_c: {
    marks: 4,
    exemplar: 'At least five values per data set; outliers excluded (all values 0.6–1.0 m); data sets identified by headers including unit of m; data consistently to 3 or 4 significant figures.',
    keyConcepts: ['data table GM wheat plant height significant figures units'],
  ...
  q5_d: {
    marks: 2,
    exemplar: 'Mean in range 0.78–0.82 m; expressed to 3 or 4 significant figures.',
    keyConcepts: ['mean average plant height group calculation significant figures'],
    keywords: ['mean', 'average', '0.78', '0.82', 'significant figures'],
  ...
  q5_e: {
    ...
    keyConcepts: ['bar graph axes labels title height GM traditional wheat'],
  ...
  q5_f: {
    marks: 3,
    exemplar: 'Result: both groups have similar heights. Conclusion: GM wheat without pesticide has the same growth as traditional wheat with pesticide. Scientific explanation: the new gene allowed the wheat to resist pests itself, so growth was not lost to insect damage.',
    keyConcepts: ['analyse results GM wheat conclusion scientific explanation pest-resistance gene'],
    keywords: ['similar heights', 'same growth', 'no pesticide', 'GM gene', 'pest', 'conclusion'],
    feedbackHit: 'Analysis includes result, conclusion, and scientific explanation.',
    feedbackMiss: 'State the result from your data, draw a conclusion, then explain scientifically (the GM gene gives built-in pest resistance).',
  },
  q5_g: {
    marks: 5,
    exemplar: 'Strength: e.g. number of trials/controls/ignore outliers. Feature to change: e.g. two variables altered simultaneously (poor control). Extension: e.g. test GM wheat with pesticide. Justification: confirms effects are not due to pesticide use alone.',
    keyConcepts: ['evaluate method strength limitation extension justification validity GM wheat'],
    keywords: ['strength', 'limitation', 'validity', 'extension', 'justification', 'two variables', 'pesticide'],
  ...
  q5_h: {
    marks: 1,
    exemplar: 'Any reasonable answer: biomass of wheat; number/yield of grains per ear; number of tillers/leaves.',
  ...
  q6_a: {
    ...
    keyConcepts: ['Bt corn experiment design Criteria B hypothesis variables method ecosystem'],
    keywords: ['Bt corn', 'GMO', 'hypothesis', 'IV', 'DV', 'CV', 'method', 'ecosystem', 'Criteria B', 'safety'],
  ...
  // ── Q8: GM Potatoes as Edible Vaccines ────────────────────────────────────
  q8_a: {
    marks: 6,
    exemplar: 'DV: immune response/antibody level + justification (what is being measured). IV: type of vaccine (GM potato vs traditional) + justification (what is being changed). CV: any variable e.g. age, health, dosage + justification. (2 marks per pair: 1 variable + 1 justification.)',
    keyConcepts: ['variables study GM potato edible vaccine IV DV CV justify'],
  ...
  q8_b: {
    marks: 15,
    exemplar: 'Criteria D (15 marks): 1–2: comparison of GM potatoes with traditional vaccines. 3–6: advantage or disadvantage, incomplete science, effect on individual and community. 7–10: relevant advantage and disadvantage with GM potatoes, complete scientific statement, effect on individual and community, ecosystem mention. 11–15: clear statements of advantage and disadvantage, complete science linked to question, fully described effect on individual and community, correct ecosystem impact supported by science, ethical issue, economic consideration, concluding appraisal.',
    keyConcepts: ['GM potato edible vaccine advantages disadvantages ecosystem ethical economic Criteria D'],
    keywords: ['GM potato', 'edible vaccine', 'advantage', 'disadvantage', 'ethical', 'ecosystem', 'community', 'economic', 'appraisal'],
    feedbackHit: 'Evaluated GM potato vaccines covering advantages, disadvantages, ecosystem, ethics, economics, and appraisal.',

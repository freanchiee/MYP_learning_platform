...
export const questions: Question[] = [
  ...
  // ── Q2: White Light & Radiation Beyond the Red End (7 marks, Criterion A) ──
  {
    ...
    artefact: {
      ...
      data: {
        title: 'The dispersed spectrum and the region beyond the red end',
        mode: 'sources',
        bands: ['Infra-red', 'Red', 'Orange', 'Yellow', 'Green', 'Blue', 'Violet'],
        axis: 'wavelength decreases · frequency & energy increase →',
        sources: [
          { name: 'Halogen lamp (white light)', covers: ['Red', 'Orange', 'Yellow', 'Green', 'Blue', 'Violet', 'Infra-red'] },
          { name: 'Visible spectrum only', covers: ['Red', 'Orange', 'Yellow', 'Green', 'Blue', 'Violet'] },
          { name: 'Sensor "hot spot" (beyond red)', covers: ['Infra-red'] },
        ],
      },
      caption: 'White light from the halogen lamp disperses into a visible spectrum (violet → red). The infra-red region lies just beyond the red end — where the sensor records the largest temperature rise. Toggle each source to compare the bands it covers.',
    },
  ...
  // ── Q3: Southern Observatory — Telescopes & Alpha Centauri (13 marks, Criterion A) ──
  {
    ...
    artefact: {
      component: 'GenericSVG',
      data: { svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 420" font-family="Arial, Helvetica, sans-serif"> <defs> <radialGradient id="trailSky" cx="50%" cy="46%" r="72%"> <stop offset="0%" stop-color="#13203a"/> <stop offset="60%" stop-color="#0a1226"/> <stop offset="100%" stop-color="#04070f"/> </radialGradient> <radialGradient id="poleStar" cx="50%" cy="50%" r="50%"> <stop offset="0%" stop-color="#ffffff"/> <stop offset="45%" stop-color="#cfe6ff"/> <stop offset="100%" stop-color="#4a90e2" stop-opacity="0"/> </radialGradient> <linearGradient id="horizon" x1="0" y1="0" x2="0" y2="1"> <stop offset="0%" stop-color="#1a2230"/> <stop offset="100%" stop-color="#0a0d14"/> </linearGradient> </defs> <rect x="0" y="0" width="720" height="420" fill="url(#trailSky)"/> <text x="24" y="30" fill="#ffffff" font-size="16" font-weight="bold">3-hour long-exposure photograph — southern sky</text> <!-- star-trail arcs all centred on the pole star T --> <g fill="none" stroke="#d8e6ff" stroke-linecap="round" opacity="0.85"> <path d="M 250 110 A 130 130 0 0 1 360 70" stroke-width="1.6"/> <path d="M 198 150 A 192 192 0 0 1 372 64" stroke-width="1.5" opacity="0.75"/> <path d="M 150 196 A 258 258 0 0 1 388 60" stroke-width="1.4" opacity="0.7"/> <path d="M 116 250 A 320 320 0 0 1 404 58" stroke-width="1.3" opacity="0.6"/> <path d="M 470 96 A 150 150 0 0 0 540 220" stroke-width="1.5" opacity="0.75"/> <path d="M 500 78 A 210 210 0 0 0 612 250" stroke-width="1.4" opacity="0.68"/> <path d="M 524 66 A 268 268 0 0 0 668 268" stroke-width="1.3" opacity="0.6"/> <path d="M 300 300 A 230 230 0 0 1 470 360" stroke-width="1.3" opacity="0.6"/> </g> <!-- the stationary pole star T (Sigma Octantis) at the centre of rotation --> <circle cx="412" cy="190" r="22" fill="url(#poleStar)"/> <circle cx="412" cy="190" r="3.4" fill="#ffffff"/> <g stroke="#cfe6ff" stroke-width="1.4" opacity="0.8"> <line x1="412" y1="176" x2="412" y2="166"/> <line x1="412" y1="204" x2="412" y2="214"/> <line x1="398" y1="190" x2="388" y2="190"/> <line x1="426" y1="190" x2="436" y2="190"/> </g> <text x="412" y="156" text-anchor="middle" fill="#ffe066" font-size="14" font-weight="bold">T — Sigma Octantis</text> <text x="412" y="232" text-anchor="middle" fill="#bcd2f0" font-size="11" font-style="italic">appears stationary (above South Pole)</text> <!-- small centre-of-rotation crosshair --> <circle cx="412" cy="190" r="40" fill="none" stroke="#7a8aa6" stroke-width="0.8" stroke-dasharray="3 4" opacity="0.5"/> <!-- direction-of-apparent-motion arrow on one arc --> <path d="M 250 110 A 130 130 0 0 1 360 70" fill="none" stroke="#ffb84d" stroke-width="2" marker-end="url(#tArrow)"/> <defs> <marker id="tArrow" markerWidth="9" markerHeight="9" refX="6" refY="4.5" orient="auto"> <path d="M0 0 L9 4.5 L0 9 z" fill="#ffb84d"/> </marker> </defs> <!-- ground / observatory dome --> <rect x="0" y="372" width="720" height="48" fill="url(#horizon)"/> <path d="M 70 372 q 0 -46 46 -46 q 46 0 46 46 z" fill="#2a3340" stroke="#465264" stroke-width="1.4"/> <rect x="108" y="338" width="16" height="34" fill="#0a0d14"/> <text x="116" y="406" text-anchor="middle" fill="#9fb0c4" font-size="12">observatory (South Africa)</text> <text x="560" y="406" text-anchor="middle" fill="#9fb0c4" font-size="11" font-style="italic">arcs trace the Earth&#8217;s rotation</text> </svg>' },
      caption: 'In a 3-hour long-exposure photo the stars trace circular arcs about the south celestial pole. Star T (Sigma Octantis) sits almost on the rotation axis, so it appears stationary while all other stars sweep arcs as the Earth turns.',
    },
  ...
  // ── Q6: Alternative Ramp Investigation — Surface Material (9 marks, Criterion B) ──
  {
    ...
    artefact: {
      ...
      data: {
        title: 'Planning a new investigation — choosing the independent variable',
        headers: ['Track surface (rougher →)', 'Expected friction', 'Predicted distance travelled / m'],
        rows: [
          ['Polished glass (smoothest)', 'Very low', 'Longest'],
          ['Plastic laminate', 'Low', 'Long'],
          ['Painted wood', 'Medium', 'Medium'],
          ['Fine sandpaper', 'High', 'Short'],
          ['Coarse carpet (roughest)', 'Very high', 'Shortest'],
        ],
        caption: 'A suggested set of conditions for the independent variable "surface material of the track". Height of ramp, mass of car and ramp length are kept constant. Rougher surfaces give greater friction, so the predicted distance decreases — the relationship the new hypothesis must test.',
      },
    },
  ...
  // ── Q10: Gene Editing in Sport — Ethics Evaluation (11 marks, Criterion D — banded) ──
  {
    ...
    artefact: {
      component: 'DataTableInteractive',
      data: {
        title: 'Gene editing in sport — implications to weigh in your evaluation',
        headers: ['Dimension', 'Potential benefit', 'Concern / risk'],
        rows: [
          ['Ethical', 'Could treat genuine genetic diseases (therapeutic use)', 'Permanent, irreversible change to an athlete’s DNA; consent and "designer athlete" issues'],
          ['Safety', 'Targeted edits may avoid harmful drug side-effects', 'Unintended (off-target) mutations could harm health'],
          ['Fairness in sport', 'May level inherited differences between athletes', 'Edits are undetectable by drug tests, so cheating cannot be policed'],
          ['Social / access', 'Technology may become cheaper over time', 'Only wealthy nations or athletes could afford it → global inequality'],
          ['Pressure on athletes', '—', 'Athletes may feel forced into risky procedures to stay competitive'],
        ],
        caption: 'A balanced scaffold of ethical and social considerations for evaluating gene editing to enhance athletic performance. Use both sides of each row to build a reasoned, two-sided argument and a concluding appraisal.',
      },
    },
  ...
  // ── Q11: Rhinoceros Prosthetic Foot — Pressure (7 marks, Criterion A) ──
  {
    ...
    artefact: {
      component: 'GenericSVG',
      data: { svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 380" font-family="Arial, Helvetica, sans-serif"> <defs> <linearGradient id="rGround" x1="0" y1="0" x2="0" y2="1"> <stop offset="0%" stop-color="#e7d9bd"/> <stop offset="100%" stop-color="#cbb389"/> </linearGradient> <linearGradient id="rBody" x1="0" y1="0" x2="0" y2="1"> <stop offset="0%" stop-color="#9aa1a8"/> <stop offset="100%" stop-color="#6b7178"/> </linearGradient> <linearGradient id="prosth" x1="0" y1="0" x2="0" y2="1"> <stop offset="0%" stop-color="#3a86c8"/> <stop offset="100%" stop-color="#1f4f82"/> </linearGradient> <marker id="rArrow" markerWidth="9" markerHeight="9" refX="6" refY="4.5" orient="auto"> <path d="M0 0 L9 4.5 L0 9 z" fill="#c0392b"/> </marker> </defs> <rect x="0" y="0" width="720" height="380" fill="#ffffff"/> <text x="24" y="30" fill="#1d1d20" font-size="16" font-weight="bold">Rhinoceros with a prosthetic foot — weight spread over four feet</text> <!-- ground --> <rect x="0" y="288" width="720" height="92" fill="url(#rGround)"/> <line x1="0" y1="288" x2="720" y2="288" stroke="#a9875e" stroke-width="2"/> <!-- rhino body (schematic) --> <ellipse cx="330" cy="180" rx="180" ry="78" fill="url(#rBody)" stroke="#4a4f55" stroke-width="1.6"/> <!-- head --> <path d="M150 175 q-70 -6 -96 34 q-8 26 26 30 q40 4 70 -18 z" fill="url(#rBody)" stroke="#4a4f55" stroke-width="1.4"/> <!-- horn --> <path d="M64 196 q-20 -2 -30 14 q14 6 30 -2 z" fill="#dcd3c4" stroke="#9a8f78" stroke-width="1"/> <!-- ear + eye --> <path d="M196 116 q10 -22 30 -16 q-4 18 -18 26 z" fill="#7d848b" stroke="#4a4f55"/> <circle cx="150" cy="178" r="4" fill="#1d1d20"/> <!-- three natural legs --> <g fill="#6b7178" stroke="#4a4f55" stroke-width="1.4"> <rect x="250" y="240" width="30" height="50" rx="6"/> <rect x="380" y="240" width="30" height="50" rx="6"/> <rect x="448" y="236" width="30" height="54" rx="6"/> </g> <!-- prosthetic front leg --> <rect x="196" y="232" width="26" height="40" rx="5" fill="#5a6066" stroke="#3f4549" stroke-width="1.4"/> <rect x="184" y="270" width="50" height="22" rx="6" fill="url(#prosth)" stroke="#143a63" stroke-width="1.6"/> <text x="209" y="226" text-anchor="middle" fill="#1f4f82" font-size="11" font-weight="bold">prosthetic foot</text> <line x1="209" y1="228" x2="209" y2="270" stroke="#1f4f82" stroke-width="0.8" stroke-dasharray="3 3"/> <!-- weight arrow (down) --> <line x1="330" y1="110" x2="330" y2="60" stroke="#c0392b" stroke-width="2.4" marker-end="url(#rArrow)" transform="rotate(180 330 85)"/> <rect x="346" y="74" width="150" height="22" rx="4" fill="#2c3e50"/> <text x="421" y="89" text-anchor="middle" fill="#ffffff" font-size="12" font-weight="bold">Weight W = mg = 30 000 N</text> <!-- per-foot reaction arrows (up) --> <g stroke="#0b7285" stroke-width="2.2" marker-end="url(#rArrow)"> </g> <g> <line x1="211" y1="316" x2="211" y2="296" stroke="#0b7285" stroke-width="2.2"/> <line x1="265" y1="316" x2="265" y2="296" stroke="#0b7285" stroke-width="2.2"/> <line x1="395" y1="316" x2="395" y2="296" stroke="#0b7285" stroke-width="2.2"/> <line x1="463" y1="316" x2="463" y2="296" stroke="#0b7285" stroke-width="2.2"/> <polygon points="211,294 206,302 216,302" fill="#0b7285"/> <polygon points="265,294 260,302 270,302" fill="#0b7285"/> <polygon points="395,294 390,302 400,302" fill="#0b7285"/> <polygon points="463,294 458,302 468,302" fill="#0b7285"/> </g> <text x="338" y="338" text-anchor="middle" fill="#0b7285" font-size="12" font-weight="bold">force on each foot = 30 000 &#247; 4 = 7 500 N</text> <!-- contact-area callout for one foot --> <rect x="540" y="120" width="158" height="150" rx="8" fill="#f4f7fa" stroke="#cbd5e1" stroke-width="1.4"/> <text x="619" y="142" text-anchor="middle" fill="#1d1d20" font-size="12" font-weight="bold">One foot</text> <rect x="572" y="152" width="94" height="58" rx="4" fill="#e2c79a" stroke="#a9875e" stroke-width="1.3"/> <text x="619" y="186" text-anchor="middle" fill="#5a4a2c" font-size="11">contact area</text> <text x="619" y="202" text-anchor="middle" fill="#5a4a2c" font-size="12" font-weight="bold">A = 0.04 m&#178;</text> <text x="619" y="234" text-anchor="middle" fill="#0b7285" font-size="12" font-weight="bold">P = F / A</text> <text x="619" y="252" text-anchor="middle" fill="#64748b" font-size="11">larger A &#8594; smaller P</text> </svg>' },
      caption: 'The 30 000 N weight of the rhinoceros is shared over four feet (7 500 N each). Pressure on the ground is P = F / A, where each foot has a contact area of 0.04 m². A larger contact area lowers the pressure, so the foot does not sink into soft ground.',
    },

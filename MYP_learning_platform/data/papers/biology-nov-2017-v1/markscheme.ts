...
export const MS: MSRecord = {
  ...
  q1_d: {
    marks: 4,
    exemplar: 'Either: the leaves are reduced to spines (or the stomata are sunken). This reduces the surface area of the plant exposed to the air OR allows transpired water to become trapped in enclosed spaces. The water vapour increases the local humidity. So evaporation or transpiration is reduced. OR: the stem has a thick waxy cuticle. The surface is impermeable to water. This prevents water escaping through the surface. So evaporation or transpiration through that surface is reduced.',
    keyConcepts: ['cactus adaptation reduce water loss', 'spines reduce surface area sunken stomata waxy cuticle humid microclimate'],
    keywords: ['spines', 'reduced leaves', 'sunken stomata', 'waxy cuticle', 'surface area', 'humid', 'trapped', 'evaporation', 'transpiration', 'impermeable'],
    feedbackHit: 'Structural adaptation named, mechanism stated, result (reduced transpiration) explained.',
    feedbackMiss: 'Name one adaptation (spines/reduced leaves/sunken stomata OR thick waxy cuticle), explain how it reduces surface area or traps moisture, state this reduces evaporation/transpiration. Four linked points needed.',
  },

  // ── Q2: Tropisms (Venus flytrap / Darwin coleoptile) ──────────────────────
  q2_a: {
    marks: 2,
  ...
  q2_c: {
    marks: 3,
    exemplar: 'Any three reasonable suggestions, for example: touch by an insect triggers the trap to snap shut; the insect is captured and digested; this supplies nitrogen/nutrients that are scarce in the poor boggy soil; (hence) improved chance of survival and growth where minerals are limited.',
    keyConcepts: ['Venus flytrap touch survival', 'trap closes captures insect supplies nutrients poor soil'],
    keywords: ['trap closes', 'insect captured', 'digested', 'nitrogen', 'nutrients', 'poor soil', 'survival', 'touch'],
    feedbackHit: 'Three valid survival reasons given.',
    feedbackMiss: 'Any 3 of: touch triggers trap to close; insect captured/digested; supplies nitrogen/nutrients lacking in poor soil; improves survival where minerals scarce.',
  },
  q2_d: {
    marks: 3,
  ...
  // ── Q3: Cells & Selective Breeding (Merino sheep) ─────────────────────────
  q3_a: {
    marks: 3,
  ...
  // ── Q4: Diffusion Investigation (potassium permanganate / agar) ───────────
  q4_a: {
    type: 'mcq',
    correct: 1,
  },
  ...
  q4_c: {
    ...
    keyConcepts: ['potassium permanganate hazard precautions', 'gloves safety glasses'],
    keywords: ['gloves', 'safety glasses', 'goggles', 'precaution', 'potassium permanganate', 'harmful'],
    feedbackHit: 'Two valid safety precautions for potassium permanganate stated.',
    feedbackMiss: 'Accept any two of: use gloves; use safety glasses/goggles.',
  },
  q4_d: {
    marks: 3,
    exemplar: '(Does the) concentration of potassium permanganate (solution affect the) time taken for it to diffuse into the agar cube. Correct use of word concentration.',
    keyConcepts: ['problem statement permanganate concentration diffusion time agar'],
    keywords: ['concentration', 'potassium permanganate', 'time', 'diffuse', 'agar', 'rate'],
    feedbackHit: 'Problem correctly identifies concentration as IV and time for diffusion as DV into the agar.',
    feedbackMiss: 'WTTE: Does the concentration of potassium permanganate solution affect the time taken for it to diffuse into the agar cube? Accept references to rate.',
  },
  q4_e: {
    marks: 1,
    exemplar: 'A correct prediction linking the two variables, for example: if the concentration of the potassium permanganate solution increases then the rate of diffusion into the agar will increase.',
    keyConcepts: ['testable prediction permanganate concentration diffusion rate'],
    ...
    feedbackMiss: 'Must link the two variables: if concentration of potassium permanganate increases, then rate of diffusion will increase.',
  },
  q4_f: {
    marks: 6,
    exemplar: 'Identification (2 max): IV: concentration of potassium permanganate solution. DV: time for the stain to diffuse (agar cube to match reference colour). CV1: temperature. CV2: volume of solution / size of agar cube / starting colour of agar. Manipulation (4 max): IV: change concentration in equal increments (e.g. 1%, 5%, 15%). DV: time how long it takes the cube to match the colour of the reference cube. CV1: use a water bath / keep at constant temperature. CV2: cut all agar cubes to the same size / use the same volume of solution in each beaker. ECF for correct description of manipulation of an incorrectly identified variable except rate of diffusion.',
    keyConcepts: ['IV concentration permanganate DV time diffusion CV temperature volume cube size'],
    ...
    feedbackMiss: 'IV = concentration of permanganate (1mk). DV = time for colour change (1mk). CV = any two of: temperature, volume of solution, size of agar cube (1mk each). Plus manipulation of each (1mk each, ECF).',
  },
  q4_g: {
    marks: 2,
  ...
  q4_i: {
    marks: 1,
    exemplar: 'Any reasonable weakness: determining when the agar cube matched the reference colour could be subjective; the concentration of the solutions was not changed in equal increments.',
  ...
  // ── Q5: Osmosis Data Analysis (sucrose concentration) ─────────────────────
  q5_a: {
    marks: 1,
    exemplar: 'Whether the external sucrose concentration affects the rate of movement (of water molecules) across a membrane (osmosis).',
    keyConcepts: ['problem statement sucrose concentration rate osmosis membrane'],
    keywords: ['sucrose concentration', 'rate', 'osmosis', 'movement', 'membrane'],
    feedbackHit: 'Problem correctly links external sucrose concentration to osmosis rate across the membrane.',
    feedbackMiss: 'State the problem as: whether the external sucrose concentration affects the rate of movement across a membrane.',
  },
  q5_b: {
    marks: 3,
  ...
  q5_c: {
    marks: 2,
    exemplar: '0.11(1) g min⁻¹. Rate = 1.11 g ÷ 10 min = 0.111 ≈ 0.11 g min⁻¹. Correctly stated as 0.11 with correct significant figures.',
    keyConcepts: ['calculation rate osmosis 4% sucrose 1.11g per 10 min = 0.11 g min⁻¹'],
    keywords: ['0.11', '0.111', 'rate', '4%', 'calculation', 'significant figures'],
    feedbackHit: 'Rate at 4% sucrose correctly calculated as 0.11 g min⁻¹.',
    feedbackMiss: 'Rate = 1.11 g / 10 min = 0.11(1) g min⁻¹. Accept incorrect precision for first mark.',
  },
  q5_d: {
    marks: 4,
    ...
    keyConcepts: ['graph plotting osmosis rate sucrose concentration evenly spaced', 'y-axis scale appropriate all points correct'],
    keywords: ['y-axis', 'evenly spaced', 'points plotted', 'scale', 'sucrose concentration', 'rate of osmosis'],
  ...
  q5_e: {
    marks: 4,
    exemplar: 'Both graphs show a similar increasing trend until 8% sucrose. Both graphs increase at a similar rate OR the rate of increase slows at a similar rate. The university graph shows a plateau or reaches a constant value above 8%. The student graph has no data above 8%.',
    keyConcepts: ['compare student vs university data osmosis sucrose', 'similar trend plateau above 8% no student data above'],
  ...
  q5_f: {
    marks: 4,
    exemplar: 'As the external sucrose concentration increases, the concentration gradient across the membrane increases. Water molecules move more quickly down the steeper gradient. So the rate of movement across the membrane increases. Term concentration gradient used correctly. OR: above 8% the gradient is large enough that the system reaches its maximum / equilibrium for this set-up. So the rate of (net) movement becomes constant because water moves in both directions at the same rate. Term equilibrium or osmotic pressure used correctly.',
    keyConcepts: ['concentration gradient sucrose osmosis rate', 'equilibrium above 8% net movement constant'],
    keywords: ['concentration gradient', 'sucrose', 'water molecules', 'move faster', 'equilibrium', 'osmotic pressure', 'rate constant'],
    feedbackHit: 'Concentration gradient / equilibrium mechanism correctly explained with scientific term.',
    feedbackMiss: '1: as sucrose concentration increases the gradient increases. 2: water moves faster. 3: rate of movement across membrane increases. 4: correct term (concentration gradient or equilibrium/osmotic pressure). OR 1-4 for equilibrium explanation.',
  },
  q5_g: {
    marks: 1,
  ...
  q5_h: {
    marks: 2,
    exemplar: 'Any reasonable extension (change to IV), for example: increase the sucrose concentration range; investigate a different solute. Any reasonable improvement, for example: fill in the missing concentration increments; increase the duration of each trial to check if equilibrium is reached after 10 minutes.',
  ...
  // ── Q6: Investigation Design — Osmosis Carrot ─────────────────────────────
  q6_a: {
    marks: 2,
    exemplar: 'Necessary equipment: balance or ruler, carrot, beaker, thermometer, flask of distilled water, cork borer or knife, ice, kettle, paper towels, goggles. Award 1 mark for three items including carrot and thermometer, and water. Award 2 marks for a further three items from the necessary equipment list.',
    keyConcepts: ['osmosis carrot investigation equipment', 'balance thermometer beaker cork borer carrot water'],
    keywords: ['balance', 'thermometer', 'carrot', 'beaker', 'distilled water', 'cork borer', 'knife', 'ice', 'kettle', 'goggles', 'paper towels'],
    feedbackHit: 'Correct set of equipment for osmosis carrot investigation selected.',
    feedbackMiss: 'Must include: carrot, thermometer, distilled water. Plus any three from: balance/ruler, beaker, cork borer/knife, ice, kettle, paper towels, goggles.',
  },
  q6_b: {
    marks: 15,
    exemplar: 'Criteria B rubric (0–15 marks): Variables: IV = temperature, DV = change in mass of carrot cores, CV = volume of solution and size/mass of carrot cores. Hypothesis: testable, linked to variables, with correct scientific explanation (e.g. as temperature increases, rate of osmosis increases because kinetic energy of water molecules increases; above optimal temperature, equilibrium is reached). Manipulation: at least five stated values of IV (temperatures). Method: clearly described, connected to IV, with equipment detail, measurements and units, could be followed by another student. Data: at least three trials. Safety: relevant safety comment (careful with cork borer/knife/hot water/goggles).',
    keyConcepts: ['Criteria B osmosis carrot design variables hypothesis method data safety'],
    keywords: ['temperature', 'mass change', 'carrot', 'control', 'hypothesis', 'kinetic energy', 'equilibrium', 'trials', 'safety', 'cork borer', 'goggles'],
  ...
  // ── Q7: Balanced Diet & Nutrients (soybeans) ──────────────────────────────
  q7_a: {
    marks: 3,
  ...
  q7_b: {
    marks: 1,
    exemplar: 'Soybeans.',
    keyConcepts: ['highest protein percentage soybeans from bar chart'],
    keywords: ['soybeans', 'soybean', 'highest', 'protein', 'percentage'],
    feedbackHit: 'Soybeans correctly identified as highest protein food from bar chart.',
    feedbackMiss: 'The food with the highest percentage of protein from the graph is soybeans (36%).',
  },

  // ── Q8: Cultured Seafood Production ───────────────────────────────────────
  q8_: {
    marks: 16,
    exemplar: 'Criteria D rubric (0–16 marks): Impacts: impacts of industrial fishing and intensive fish farming (overfishing/depleted stocks, bycatch, habitat/seabed damage, ocean pollution and disease from fish farms). Strengths and limitations: strengths (no overfishing, no bycatch, same protein, controlled conditions) and limitations of cultured seafood (expensive, energy-intensive, unnatural, cultural acceptance). Environmental: industrial fishing vs cultured environmental impact (ocean stocks/seabed/pollution vs energy use). Ethical: animal welfare and overexploitation in fishing; ethical issues for cultured seafood (natural vs artificial). Appraisal: concluding appraisal linking impacts/environment/ethics.',
    keyConcepts: ['cultured seafood vs industrial fishing impacts environment ethical appraisal', 'strengths limitations cultured production sustainability'],
    keywords: ['industrial fishing', 'overfishing', 'cultured seafood', 'bycatch', 'habitat', 'ocean pollution', 'fish stocks', 'strengths', 'limitations', 'environmental', 'ethical', 'appraisal'],
    feedbackHit: 'Full Criteria D: impacts + strengths/limitations + environmental + ethical + appraisal, all with scientific reasoning.',
    feedbackMiss: 'Level 4 (13-16): states more than one impact of industrial fishing with effects; strength and limitation of cultured seafood with scientific explanation; environmental + ethical considerations; concluding appraisal linking all factors.',
  },

  // ── Q9: Lab-Grown Organs from Stem Cells ──────────────────────────────────
  q9_: {
    marks: 9,
    exemplar: 'Criteria D rubric (0–9 marks): Advantages: no matching donor needed, grown from patient\'s own stem cells so greatly reduced rejection risk, no transplant waiting list, can be made on demand. Disadvantages: expensive, only some simple tissues can be grown so far, not fully tested/approved, slow to grow a whole organ. Evaluative statement: justified with scientific reasoning. Appraisal: concluding statement linking all factors discussed.',
    keyConcepts: ['lab-grown organs stem cells transplants advantages disadvantages appraisal', 'replacing traditional transplantation scientific implications'],
    keywords: ['lab-grown organs', 'stem cells', 'transplant', 'donor', 'rejection', 'advantages', 'disadvantages', 'expensive', 'waiting list', 'appraisal'],
    feedbackHit: 'Advantages and disadvantages of lab-grown organs stated with scientific reasoning, plus concluding appraisal.',
    feedbackMiss: 'Level 4 (max): more than one advantage and disadvantage correctly linked to lab-grown organs; evaluative statement justified scientifically; concluding appraisal linking all discussed factors.',
  },
}

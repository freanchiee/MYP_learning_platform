    ...
    tasks: [
      ...
      },
      {
        ...
        artefact: {
          ...
          data: {
            mode: 'match',
            title: 'Candidate waveforms A–D',
            windowSeconds: 4,
            amplitudeGridUnits: 1,
            target: { label: 'Part (a) wave', period_s: 2.0, amplitude_cm: 1 },
            options: [
              { id: 'A', period_s: 1.0, amplitude_cm: 1 },
              { id: 'B', period_s: 4.0, amplitude_cm: 1 },
              { id: 'C', period_s: 2.0, amplitude_cm: 1 },
              { id: 'D', period_s: 0.8, amplitude_cm: 1 },
            ],
            correct: 'C',
            concept: 'Same frequency ⇒ same period. The part (a) wave has T = 2.0 s (f = 0.50 Hz), so the matching waveform completes one cycle every 2.0 s — two whole cycles across this 4.0 s window.',
          },
          caption: 'Four candidate waveforms A–D plotted over the same 4.0 s time window. Pick the one with the same period (frequency) as the wave in part (a).',
        },
        widget: 'radio_select',
        widgetOptions: ['A', 'B', 'C', 'D'],
        ph: 'C',

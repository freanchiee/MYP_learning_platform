...
export const questions: Question[] = [
  // ─── Q1: Copper / metals / history (9m, Crit A) ───────────────────────────
  {
    ...
    figImages: ['chemistry-nov-2022/page-02.png', 'chemistry-nov-2022/page-03.png'],
    tasks: [
      {
        label: 'a',
  ...
  // ─── Q2: Reactive metals in paint / iron chemistry (17m, Crit A) ──────────
  {
    ...
    figImages: ['chemistry-nov-2022/page-04.png', 'chemistry-nov-2022/page-05.png', 'chemistry-nov-2022/page-06.png', 'chemistry-nov-2022/page-07.png', 'chemistry-nov-2022/page-08.png'],
    tasks: [
      {
        label: 'a',
      ...
      },
      {
        ...
        figImages: ['chemistry-nov-2022/page-05.png'],
      },
      {
        label: 'c',
      ...
      },
      {
        ...
        figImages: ['chemistry-nov-2022/page-08.png'],
      },
    ],
  },
  ...
  // ─── Q3: Acid rain / marble erosion investigation (26m, Crit B/C) ─────────
  {
    ...
    figImages: ['chemistry-nov-2022/page-09.png', 'chemistry-nov-2022/page-10.png'],
    tasks: [
      {
        label: 'a',
      ...
      },
      {
        ...
        figImages: ['chemistry-nov-2022/page-12.png'],
      },
      {
        label: 'd',
        ...
        figImages: ['chemistry-nov-2022/page-12.png', 'chemistry-nov-2022/page-13.png'],
      },
      {
        label: 'e',
  ...
  // ─── Q4: Home-made CO₂ fire extinguisher investigation (17m, Crit B/C) ──────
  {
    ...
    figImages: ['chemistry-nov-2022/page-13.png', 'chemistry-nov-2022/page-14.png'],
    tasks: [
      {
        label: 'a',
      ...
      },
      {
        ...
        figImages: ['chemistry-nov-2022/page-16.png'],
      },
      {
        label: 'f',
  ...
  // ─── Q5: Fire extinguisher types comparison (7m, Crit C/A) ────────────────
  {
    ...
    figImages: ['chemistry-nov-2022/page-17.png', 'chemistry-nov-2022/page-18.png'],
    tasks: [
      {
        label: 'a',
  ...
  // ─── Q6: Sleep quality / sleep sprays / caffeine (15m, Crit A/D) ──────────
  {
    ...
    figImages: ['chemistry-nov-2022/page-19.png', 'chemistry-nov-2022/page-20.png', 'chemistry-nov-2022/page-21.png', 'chemistry-nov-2022/page-22.png'],
    tasks: [
      {
        label: 'a',
        ...
        figImages: ['chemistry-nov-2022/page-20.png'],
      },
      {
        label: 'b',
  ...
  // ─── Q7: Frankincense vs lavender for sleep spray industry (9m, Crit D) ────
  {
    ...
    figImages: ['chemistry-nov-2022/page-23.png', 'chemistry-nov-2022/page-24.png'],
    tasks: [
      {
        label: '',

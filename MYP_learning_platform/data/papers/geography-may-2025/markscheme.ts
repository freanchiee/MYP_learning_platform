...
/**
 * MYP Geography — May 2025 mark scheme (rubric-banded, "best fit").
 *
...
export const MS: MSRecord = {
  q1_a: {
    marks: 2,
    exemplar: 'Increased tourism; access to the internet.',
    keyConcepts: ['globalization', 'global interactions'],
    keywords: ['tourism', 'internet', 'cultures', 'languages', 'cheaper goods', 'positive impact'],
    feedbackHit: 'Correct — two valid positive impacts of globalization.',
    feedbackMiss: 'Identify two positive impacts (e.g. increased tourism, access to the internet, appreciating other cultures, learning other languages, cheaper goods). Single words that do not signify an impact score 0.',
    ...
    blankAnswers: ['Increased tourism', 'Access to the internet', 'Appreciating other cultures', 'Learning other languages', 'Cheaper goods'],
  },

  q1_b: {
    marks: 4,
    exemplar:
      'Increased tourism causes more pollution from planes and other transport. These modes of transport rely on fossil fuels that contribute to increased greenhouse gases. Because transport has become cheaper, tourism’s carbon footprint has increased.',
    keyConcepts: ['causality', 'globalization', 'sustainability'],
    keywords: ['negative consequence', 'pollution', 'fossil fuels', 'greenhouse gases', 'carbon footprint', 'tourism'],
    ...
    rubricBands: [
      ...
      { marks: '1', descriptor: 'States one negative consequence of globalisation.', exemplar: 'Increased tourism causes more pollution.' },
      { marks: '2', descriptor: 'Outlines one negative consequence (a single elaborated sentence; brief detail).', exemplar: 'Increased tourism causes more pollution. Many modes of transport rely on fossil fuels.' },
      { marks: '3', descriptor: 'Describes one negative consequence in detail, without comprehensive reasons.', exemplar: 'Increased tourism causes more pollution from planes and other transport. These modes of transport rely on fossil fuels and tourism’s carbon footprint has increased.' },
      { marks: '4', descriptor: 'Explains one negative consequence in detail, with reasons.', exemplar: '…rely on fossil fuels that contribute to increased greenhouse gases. Because transport has become cheaper, tourism’s carbon footprint has increased.' },
    ],
  },
  ...
  q2_: {
    marks: 8,
    exemplar:
      'The research consultant is using reliable primary and secondary data; the different sources will support the investigation and help them investigate ways to increase food security. However, only five farmers are interviewed in a population where 60% are employed as farmers, so the sample size will not represent the problems and the consultant will not gain sufficient information. Although multiple data sets were collected, the lack of research into new farming practices means the research question can’t be fully answered, therefore overall the investigation was only partly successful.',
    ...
    rubricBands: [
      ...
      { marks: 'Strengths 3', descriptor: 'Explains a strength with reasoning.', exemplar: '…The different sources of data will support the investigation and help the research consultant investigate ways to increase food security.' },
      { marks: 'Limitations 1', descriptor: 'States a limitation.', exemplar: 'Only five farmers are interviewed.' },
      { marks: 'Limitations 2', descriptor: 'Outlines a limitation (elaborated).', exemplar: 'Only five farmers are interviewed of a population where 60% are employed as farmers.' },
      ...
      { marks: 'Appraisal 2', descriptor: 'Outlines an appraisal — weighs positives and negatives into one overall judgement (anywhere in the response).', exemplar: 'Although multiple data sets were collected, the lack of research into new farming practices means the RQ can’t be answered, therefore overall, the investigation was unsuccessful.' },
    ],
  },

  q3_a: {
    marks: 2,
    exemplar: 'How has increased trade changed the lives of factory workers in Myanmar?',
    ...
    rubricBands: [
      ...
      { marks: '1', descriptor: 'RQ is either clear OR focused, and connected to the SoI.', exemplar: 'How has increased trade changed the lives of factory workers? (lacks focus — no location/stakeholder)' },
      { marks: '2', descriptor: 'RQ is both clear AND focused and connected to the SoI.', exemplar: 'How has increased trade changed the lives of factory workers in Myanmar?' },
    ],
  },
  ...
  q3_b: {
    marks: 4,
    exemplar:
      'More trade has led to more people being employed by clothing factories. The minimum wage has been put in place to ensure workers are not exploited. With people able to make money from increased trade, they can invest in their health or children’s education. The government will understand the social impact of globalisation.',
    ...
    rubricBands: [
      { marks: '1', descriptor: 'States how the RQ will allow the government to achieve their goal.', exemplar: 'More trade has led to more people being employed by clothing factories.' },
      ...
      { marks: '3', descriptor: 'Describes how the RQ is worthy of investigating (a factor in detail, no full reasoning).', exemplar: '…The minimum wage has been put in place to ensure workers are not exploited.' },
      { marks: '4', descriptor: 'Justifies how the RQ is worthy of investigating (a factor in detail, with reasoning).', exemplar: '…With people able to make money from increased trade, they can invest in their health or children’s education.' },
    ],
  },

  q3_c: {
    marks: 2,
    exemplar: 'Data from the World Bank on poverty levels in Myanmar; statistics from NGOs working in Myanmar.',
    keyConcepts: ['sources', 'reliability'],
    keywords: ['World Bank', 'NGO statistics', 'poverty data', 'reliable source', 'specific'],
    feedbackHit: 'Well done — two specific, reliable sources for the investigation.',
    feedbackMiss: 'Name two specific reliable sources (e.g. World Bank poverty data for Myanmar; NGO statistics). Vague responses that only state a source type score 0.',
    commandTerm: 'Identify',
    commandTermDefinition: 'Provide an answer from a number of possibilities. Recognize and state briefly a distinguishing fact or feature.',
    blankAnswers: ['Data from the World Bank on poverty levels in Myanmar', 'Statistics from NGOs working in Myanmar'],
  },

  q3_d: {
    marks: 4,
    exemplar:
      'The poverty levels will help me to see the impact of more trade in the country on people who are employed by factories. This will help me understand the social benefits and limitations of increased trade in Myanmar on people. By basing my research on reliable statistics I can make an informed conclusion to my research question.',
    keyConcepts: ['sources', 'usefulness', 'reasoning'],
    keywords: ['poverty levels', 'social benefits', 'reliable statistics', 'informed conclusion', 'wages'],
    ...
    commandTermDefinition: 'Give a detailed account including reasons or causes.',
    rubricBands: [
      { marks: '1', descriptor: 'States how the source will help investigate the RQ.', exemplar: 'The poverty levels will help me to see whether there is an impact of more trade in the country.' },
      ...
      { marks: '3', descriptor: 'Describes how the source helps, in detail.', exemplar: '…This will help me understand the social benefits and limitations of increased trade in Myanmar on people.' },
  ...
  q4_: {
    marks: 18,
    exemplar:
      'TITLE: “Tech for the Wild — Saving Biomes One Innovation at a Time”. Welcome back, listeners! Today we’re asking how human innovation can both harm and protect biomes. Take the rainforest biome: heli-logging uses GIS to locate only suitable trees, so fewer trees are cut down, natural habitats are not destroyed, and extinction rates fall because the food chain stays intact. But innovation cuts both ways. In the aquatic biome, overfishing — taking an unsustainable number of fish — has been made worse by trawler nets towed through the water, which cause bycatch and waste, and if too many fish are removed there aren’t enough left to reproduce. So before you switch off: the same technologies that threaten our biomes can also protect them — it all depends on how we choose to use them. Thanks for tuning in, and see you next episode!',
    keyConcepts: ['systems', 'sustainability', 'management & intervention', 'communication'],
    keywords: ['biome', 'rainforest', 'aquatic', 'heli-logging', 'GIS', 'overfishing', 'trawler nets', 'bycatch', 'innovation', 'podcast', 'title', 'closing statement'],
    feedbackHit: 'Well done — a podcast-style script explaining innovation’s impact on ≥2 biomes, with a title and closing statement.',
    feedbackMiss: 'Marked across four strands: Knowledge (Crit A /6), Format /2, Communicating /6, Organization /4. Reference ≥2 biomes, add a title and a closing statement, and write in podcast style (address listeners, rhetorical questions).',
    commandTerm: 'Explain',
    commandTermDefinition: 'Give a detailed account including reasons or causes.',
    rubricBands: [
      ...
      { marks: 'Communicating 1–2', descriptor: 'Style/language rarely appropriate to a school podcast (reads like an essay); basic, not engaging.' },
      { marks: 'Communicating 3–4', descriptor: 'Style occasionally appropriate; some podcast features (rhetorical questions, analogies, concise sentences).' },
      { marks: 'Communicating 5–6', descriptor: 'Style consistently appropriate to a school podcast throughout (addresses listeners, clarifications, references to other episodes); engaging.' },
  ...
  q5_a: {
    marks: 3,
    exemplar:
      'The colour-coded map shows damaged vs undamaged buildings. It gives them an overview of the extent of the damage. This allows the NGO to prioritise areas where assistance is needed.',
    keyConcepts: ['source evaluation', 'value', 'management & intervention'],
    keywords: ['colour-coded', 'damaged', 'undamaged', 'extent of damage', 'prioritise', 'overview'],
    feedbackHit: 'Well done — you explained one value of the map for the NGO, with reasoning.',
    feedbackMiss: 'Build from stating a value (1) → outlining (2) → explaining with reasoning (3), e.g. the map shows damage so the NGO can prioritise where aid is needed.',
    commandTerm: 'Explain',
    commandTermDefinition: 'Give a detailed account including reasons or causes.',
    rubricBands: [
      { marks: '1', descriptor: 'States one value of Source B to the NGO’s project.', exemplar: 'It gives them an overview of the extent of the damage.' },
      { marks: '2', descriptor: 'Outlines one value of Source B to the NGO’s project.', exemplar: 'The colour-coded map shows the damaged vs undamaged buildings. It gives them an overview of the extent of the damage.' },
      { marks: '3', descriptor: 'Explains one value of Source B to the NGO’s project, with reasoning.', exemplar: '…This allows the NGO to prioritise areas where assistance is needed.' },
    ],
  },
  ...
  q5_b: {
    marks: 3,
    exemplar:
      'The map lacks detailed information about the town, such as street names. This can make it challenging for the NGO to identify damaged properties and deliver food.',
    keyConcepts: ['source evaluation', 'limitation', 'scale'],
    keywords: ['limitation', 'street names', 'detail', 'identify properties', 'deliver food'],
    feedbackHit: 'Well done — you explained one limitation of the map for the NGO, with reasoning.',
    feedbackMiss: 'Build from stating a limitation (1) → outlining (2) → explaining with reasoning (3), e.g. no street names → hard to locate damaged properties.',
    commandTerm: 'Explain',
    commandTermDefinition: 'Give a detailed account including reasons or causes.',
    rubricBands: [
      { marks: '1', descriptor: 'States one limitation of Source B to the NGO’s project.', exemplar: 'The map lacks information about the town.' },
      { marks: '2', descriptor: 'Outlines one limitation of Source B to the NGO’s project.', exemplar: 'The map lacks detailed information about the town, such as street names.' },
      { marks: '3', descriptor: 'Explains one limitation of Source B to the NGO’s project, with reasoning.', exemplar: '…This can make it challenging for the NGO to identify damaged properties and deliver food.' },
    ],
  },
  ...
  q6_: {
    marks: 6,
    exemplar:
      'An 80-year-old person may have difficulty accessing real-time information. They might not be as familiar with social media. Therefore, they may not receive the evacuation message in time to evacuate. The evacuation drills will help people know where to go when evacuating and keep more people safe. If the 80-year-old has difficulty with moving, such as bad knees, they may not be able to practise the drills all the time. Overall, the evacuation drills and real-time alerts will not be very effective for this resident, especially from the 80-year-old’s perspective.',
    keyConcepts: ['analysis', 'perspectives', 'management & intervention', 'disparity & equity'],
    keywords: ['real-time alerts', 'social media', 'evacuation drills', 'mobility', '80-year-old', 'effectiveness', 'conclusion'],
    feedbackHit: 'Well done — you analysed both strategies for the 80-year-old in detail and reached a conclusion on their effectiveness.',
    feedbackMiss: 'Analyse BOTH strategies (real-time alerts; evacuation drills) from the 80-year-old’s perspective and conclude on effectiveness. Analysing only one strategy caps at 3 marks; with no conclusion, max 5.',
    commandTerm: 'Analyse',
    ...
    rubricBands: [
      { marks: '0', descriptor: 'No standard reached.' },
      { marks: '1', descriptor: 'States the effectiveness of at least one strategy from the 80-year-old’s perspective.', exemplar: 'An 80-year-old person may have difficulty accessing real-time information.' },
      { marks: '2–3', descriptor: 'Outlines the effectiveness of the two strategies (limited supporting detail). One strategy only → max 3.', exemplar: '…They might not be as familiar with social media. The evacuation drills will help people know where to go, but with bad knees they may not be able to practise the drills.' },
      { marks: '4–5', descriptor: 'Describes the effectiveness of the two strategies in detail (detailed analysis). No conclusion → max 5.', exemplar: '…Therefore they may not receive the evacuation message in time to evacuate. The drills help people know where to go and keep more people safe, but mobility issues limit participation.' },
      { marks: '6', descriptor: 'Analyses in detail the effectiveness of both strategies and reaches a relevant conclusion.', exemplar: '…Overall, the evacuation drills and real-time alerts will not be very effective for this resident, especially from the 80-year-old’s perspective.' },
    ],
  },

  ...
  // ── Q2: Raindrops — Forces & Momentum (12 marks, Criterion A/C) ──
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        marks: 2,
        figImages: ['/images/papers/physics-nov-2017/q2f-terminal-vel-graph.svg'],
      ...
      },
      {
        ...
        marks: 2,
        figImages: ['/images/papers/physics-nov-2017/q2g-hailstones-graph.svg'],
  ...
  // ── Q3: Electricity & Light Bulbs (14 marks, Criterion A/D) ──
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        marks: 4,
        figImages: ['/images/papers/physics-nov-2017/q3e-bulb-cost-graph.svg'],
  ...
  // ── Q4: Evaporation Investigation — Surface Area (21 marks, B/A/C/D) ──
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        marks: 2,
        figImages: ['/images/papers/physics-nov-2017/q4f-evap-graph.svg'],
  ...
  // ── Q6: Kilimanjaro — Boiling Point vs Altitude (10 marks, Criterion C) ──
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        marks: 2,
        figImages: ['/images/papers/physics-nov-2017/q6c-anomalous-graph.svg'],

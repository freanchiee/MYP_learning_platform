      ...
      },
      {
        ...
        artefact: {
          ...
          data: {
            ...
            target: { label: 'Part (a) wave', period_s: 1.6, amplitude_cm: 1 },
            options: [
              { id: 'A', period_s: 0.8, amplitude_cm: 1 },
              { id: 'B', period_s: 3.2, amplitude_cm: 1 },
              { id: 'C', period_s: 1.6, amplitude_cm: 1 },
              { id: 'D', period_s: 2.4, amplitude_cm: 1 },
            ],
            correct: 'C',
            concept: 'Same frequency ⇒ same period. The part (a) wave has T = 1.6 s (f = 0.63 Hz), so the matching waveform completes one cycle every 1.6 s — two whole cycles across this 3.2 s window.',
          },
          caption: 'Four candidate waveforms A–D plotted over the same 3.2 s time window. Pick the one with the same period (frequency) as the wave in part (a).',
        },
        widget: 'radio_select',
        widgetOptions: ['A', 'B', 'C', 'D'],
        ph: 'C',

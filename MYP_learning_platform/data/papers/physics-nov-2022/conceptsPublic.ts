...
export const CONCEPTS_PUBLIC_NOV2022: Record<string, ConceptEntry> = {

  // ── Q1: Nuclear Fission & Radioactive Decay ──────────────────
  q1_a: {
  ...
  q1_d: {
    ...
    keywords: ['energy calculation', 'unit conversion', 'fission', 'mass of uranium', 'MJ to J'],
  },
  q1_e: {
    keyConcepts: ['collaboration in science combines different expertise', 'interdisciplinary science solves complex problems'],
    keywords: ['collaboration', 'different skills', 'teamwork', 'physics', 'chemistry'],
  },
  ...
  q3_c: {
    ...
    keywords: ['liquid water', 'life', 'habitability', 'astrobiology', 'Europa'],
  },
  q3_d: {
  ...
  // ── Q4: Motor Investigation Planning ────────────────────────
  q4_a: {
  ...
  q6_a: {
    ...
    keywords: ['ΔEp', 'mgh', '9.81', 'unit conversion', 'kg', 'metres', 'gravitational potential energy'],
  },
  q6_b: {
  ...
  q6_d: {
    ...
    keywords: ['VIt', 'total energy', 'efficiency', 'calculation', 'gravitational potential energy', 'percentage'],
  },
  ...
  q7_h: {
    ...
    keywords: ['time of flight', 'horizontal range', 'dependent variable', 'control variable', 'launch speed', 'mass'],
  },
  ...
  q8_a: {
    ...
    keywords: ['d = vt', 'echo', 'ultrasound', 'one-way distance', 'reflection', 'kidney stone'],
  },
  q8_b: {

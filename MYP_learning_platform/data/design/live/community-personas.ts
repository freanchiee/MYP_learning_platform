...
export const COMMUNITY_PERSONAS: Persona[] = [
  {
    id: 'c-priya', direction: 'community', group: 'government', represents: 'City environment committee', icon: '🏛️', name: 'Councillor Priya Nair', age: 52,
  ...
  {
    id: 'c-tomasz', direction: 'community', group: 'government', represents: 'National industry ministry', icon: '📜', name: 'Tomasz Kowal', age: 47,
  ...
  {
    id: 'c-dana', direction: 'community', group: 'corporation', represents: 'A packaging manufacturer', icon: '🏭', name: 'Dana Whitfield', age: 44,
  ...
  {
    id: 'c-rahul', direction: 'community', group: 'corporation', represents: 'A small electronics maker', icon: '🔧', name: 'Rahul Mehta', age: 58,
  ...
  {
    id: 'c-luis', direction: 'community', group: 'worker', represents: 'Assembly-line supervisors', icon: '👷', name: 'Luis Ortega', age: 39,
  ...
  {
    id: 'c-amina', direction: 'community', group: 'worker', represents: 'Contract and shift workers', icon: '🧵', name: 'Amina Yusuf', age: 29,
  ...
  {
    id: 'c-mei', direction: 'community', group: 'consumer', represents: 'Household shoppers', icon: '🛍️', name: 'Mei Tanaka', age: 41,
  ...
  {
    id: 'c-jayden', direction: 'community', group: 'consumer', represents: 'Young fast-fashion shoppers', icon: '👟', name: 'Jayden Brooks', age: 17,
  ...
  {
    id: 'c-kaleo', direction: 'community', group: 'community', represents: 'A forest-edge community', icon: '🌳', name: 'Elder Kaleo Nakoa', age: 66,
  ...
  {
    id: 'c-sofia', direction: 'community', group: 'community', represents: 'A river-town residents group', icon: '🌊', name: 'Sofia Andrade', age: 34,

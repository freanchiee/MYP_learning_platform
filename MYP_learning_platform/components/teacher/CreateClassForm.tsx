...
export default function CreateClassForm() {
  ...
  return (
    <form onSubmit={submit} className="flex flex-wrap gap-2">
      ...
      />
      <button disabled={busy || !name.trim()} className="rounded-lg px-5 py-2.5 text-sm font-bold disabled:opacity-50" style={{ background: 'var(--gradient-cta)', color: 'var(--text-on-accent)' }}>

  ...
  return (
    <form onSubmit={submit} className="flex flex-wrap gap-2">
      <input
        ...
        className="min-w-[220px] flex-1 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2"
      ...
      />
      <button disabled={busy || !name.trim()} className="rounded-lg px-5 py-2.5 text-sm font-bold disabled:opacity-50" style={dark ? { background: '#fff', color: '#160f2a' } : { background: 'var(--gradient-cta)', color: 'var(--text-on-accent)' }}>
